...
ES(SYNTAX_ERROR_NUMBER, SYNTAX_ERROR_CLASS, "syntax_error_on_number")
ES(SYNTAX_ERROR_ENCODING, SYNTAX_ERROR_CLASS, "syntax_error_in_encoding UTF-8")
ES(SYNTAX_ERROR_NL, SYNTAX_ERROR_CLASS, "syntax_error: newline in quoted text")
