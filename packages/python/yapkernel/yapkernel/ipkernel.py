"""The IPython kernel implementation, adapted to YAP"""
...
# there can only be one comm manager in a yapk<ernel process
...
class YAPKernel(KernelBase):
    ...
    language_info = {
        ...
        "codemirror_mode": {"name": "prolog", "version": sys.version_info[0]},
...
class Kernel(YAPKernel):
    ...
    def __init__(self, *args, **kwargs):  # pragma: no cover
        ...
        warnings.warn(
            "Kernel is a deprecated alias of yapkernel.ipkernel.YAPKernel",
            DeprecationWarning,
            stacklevel=2,
        )
