...
github_project_url = "https://github.com/ipython/yapkernel"
...
version_py = os.path.join(here, os.pardir, 'yapkernel', '_version.py')
...
htmlhelp_basename = 'yapkerneldoc'
...
latex_documents = [
  (master_doc, 'yapkernel.tex', 'IPython Kernel Documentation',
...
man_pages = [
    (master_doc, 'yapkernel', 'IPython Kernel Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'yapkernel', 'IPython Kernel Documentation',
   author, 'yapkernel', 'One line description of project.',
   'Miscellaneous'),
]
