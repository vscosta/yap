...
.. inheritance-diagram:: yap_ipython.core.ultratb
   :parts: 3
"""
...
from yap_ipython.utils import path as util_path
from yap_ipython.utils import py3compat
from yap_ipython.utils.data import uniq_stable
from yap_ipython.utils.terminal import get_terminal_size
from logging import info, error, debug

import yap_ipython.utils.colorable as colorable
...
# formatter.  When running in an actual yap_ipython instance, the user's rc.colors
...
# test case (yap_ipython.core.tests.test_ultratb.ChangedPyFileTest) that fails if
...
def is_recursion_error(etype, value, records):
    ...
    # by stack frames in yap_ipython itself. >500 frames probably indicates
    # a recursion error.
...
class TBTools(colorable.Colorable):
    ...
    def _get_ostream(self):
        ...
        - None: the default, which means that yap_ipython will dynamically resolve
...
class VerboseTB(TBTools):
    ...
    def __init__(self, color_scheme='Linux', call_pdb=False, ostream=None,
        ...
        # different check_cache implementation.  This is used by the yap_ipython
