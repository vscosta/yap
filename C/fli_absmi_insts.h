...
#endif /* FROZEN_STACKS */
      {
        /* make sure that we can still have access to our old PREG afte
        ...
        SREG = (CELL *)YAP_Execute(pt0, pt0->cs.f_code);
...
/*This is a phantom instruction. This is not executed by the WAM*/
    ...
    store_yaam_regs(NEXTOP(PREG, OtapFs),
...
/*This is a phantom instruction. This is not executed by the WAM*/
    ...
    undef_goal(PredFromDefCode(PREG)
