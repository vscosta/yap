...
def unquote_filename(name, win32=(sys.platform=='win32')):
    ...
    unquoting is now taken care of by :func:`yap_ipython.utils.process.arg_split`.
    """
    warn("'unquote_filename' is deprecated since yap_ipython 5.0 and should not "
...
def get_py_filename(name, force_win32=None):
    ...
    if force_win32 is not None:
        warn("The 'force_win32' argument to 'get_py_filename' is deprecated "
             "since yap_ipython 5.0 and should not be used anymore",
...
@undoc
def get_ipython_dir():
    warn("get_ipython_dir has moved to the yap_ipython.paths module since yap_ipython 4.0.", stacklevel=2)
    from yap_ipython.paths import get_ipython_dir
    return get_ipython_dir()

@undoc
def get_ipython_cache_dir():
    warn("get_ipython_cache_dir has moved to the yap_ipython.paths module since yap_ipython 4.0.", stacklevel=2)
    from yap_ipython.paths import get_ipython_cache_dir
    return get_ipython_cache_dir()

@undoc
def get_ipython_package_dir():
    warn("get_ipython_package_dir has moved to the yap_ipython.paths module since yap_ipython 4.0.", stacklevel=2)
    from yap_ipython.paths import get_ipython_package_dir
    return get_ipython_package_dir()

@undoc
def get_ipython_module_path(module_str):
    warn("get_ipython_module_path has moved to the yap_ipython.paths module since yap_ipython 4.0.", stacklevel=2)
    from yap_ipython.paths import get_ipython_module_path
    return get_ipython_module_path(module_str)

@undoc
def locate_profile(profile='default'):
    warn("locate_profile has moved to the yap_ipython.paths module since yap_ipython 4.0.", stacklevel=2)
    from yap_ipython.paths import locate_profile
