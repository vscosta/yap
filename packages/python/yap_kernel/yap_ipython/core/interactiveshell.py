...
from yap_ipython.core.alias import Alias, AliasManager
from yap_ipython.core.autocall import ExitAutocall
from yap_ipython.core.builtin_trap import BuiltinTrap
from yap_ipython.core.events import EventManager, available_events
from yap_ipython.core.compilerop import CachingCompiler, check_linecache_ipython
from yap_ipython.core.debugger import Pdb
from yap_ipython.core.display_trap import DisplayTrap
from yap_ipython.core.displayhook import DisplayHook
from yap_ipython.core.displaypub import DisplayPublisher
from yap_ipython.core.error import InputRejected, UsageError
from yap_ipython.core.extensions import ExtensionManager
from yap_ipython.core.formatters import DisplayFormatter
from yap_ipython.core.history import HistoryManager
from yap_ipython.core.inputsplitter import ESC_MAGIC, ESC_MAGIC2
from yap_ipython.core.logger import Logger
from yap_ipython.core.macro import Macro
from yap_ipython.core.payload import PayloadManager
from yap_ipython.core.prefilter import PrefilterManager
...
from yap_ipython.utils.path import get_home_dir, get_py_filename, ensure_dir_exists
from yap_ipython.utils.process import system, getoutput
from yap_ipython.utils.strdispatch import StrDispatch
from yap_ipython.utils.syspathcontext import prepended_to_syspath
from yap_ipython.utils.text import format_screen, LSString, SList, DollarFormatter
...
# NoOpContext is deprecated, but yap_kernel imports it from here.
# See https://github.com/ipython/yap_kernel/issues/157
from yap_ipython.utils.contexts import NoOpContext
...
def get_default_colors():
    "DEPRECATED"
    warn('get_default_color is deprecated since yap_ipython 5.0, and returns `Neutral` on all platforms.',
...
class DummyMod(object):
    """A dummy module used for yap_ipython's interactive module when
...
class InteractiveShell(SingletonConfigurable):
    ...
    autocall = Enum((0,1,2), default_value=0, help=
        """
        Make yap_ipython automatically call any callable object even if you didn't
    ...
    autoindent = Bool(True, help=
        """
        Autoindent yap_ipython code entered interactively.
        """
    ).tag(config=True)
    ...
    def _sphinxify_docstring_changed(self, change):
        if change['new']:
            warn("`sphinxify_docstring` is provisional since yap_ipython 5.0 and might change in future versions." , ProvisionalWarning)
    ...
    def _enable_html_pager_changed(self, change):
        if change['new']:
            warn("`enable_html_pager` is provisional since yap_ipython 5.0 and might change in future versions.", ProvisionalWarning)
    ...
    prompt_in1 = Unicode('In [\\#]: ',
        help="Deprecated since yap_ipython 4.0 and ignored since 5.0, set TerminalInteractiveShell.prompts object directly."
    ).tag(config=True)
    ...
    def _prompt_trait_changed(self, change):
        name = change['name']
        warn("InteractiveShell.{name} is deprecated since yap_ipython 4.0"
    ...
    xmode = CaselessStrEnum(('Context','Plain', 'Verbose'),
                            ...
                            help="Switch modes for the yap_ipython exception handlers."
                            ).tag(config=True)

    # Subcomponents of InteractiveShell
    alias_manager = Instance('yap_ipython.core.alias.AliasManager', allow_none=True)
    prefilter_manager = Instance('yap_ipython.core.prefilter.PrefilterManager', allow_none=True)
    builtin_trap = Instance('yap_ipython.core.builtin_trap.BuiltinTrap', allow_none=True)
    display_trap = Instance('yap_ipython.core.display_trap.DisplayTrap', allow_none=True)
    extension_manager = Instance('yap_ipython.core.extensions.ExtensionManager', allow_none=True)
    payload_manager = Instance('yap_ipython.core.payload.PayloadManager', allow_none=True)
    history_manager = Instance('yap_ipython.core.history.HistoryAccessorBase', allow_none=True)
    magics_manager = Instance('yap_ipython.core.magic.MagicsManager', allow_none=True)

    profile_dir = Instance('yap_ipython.core.application.ProfileDir', allow_none=True)
    ...
    last_execution_result = Instance('yap_ipython.core.interactiveshell.ExecutionResult', help='Result of executing the last command', allow_none=True)
    ...
    def init_builtins(self):
        ...
        # that an yap_ipython shell has been created, and we make no attempts at
        # removing on exit or representing the existence of more than one
        # yap_ipython at a time.
    ...
    def init_virtualenv(self):
        ...
        warning will appear suggesting the user installs yap_ipython in the
        ...
        warn("Attempting to work in a virtualenv. If you encounter problems, please "
             "install yap_ipython inside the virtualenv.")
    ...
    def init_hooks(self):
        ...
        # Set all default hooks, defined in the yap_ipython.hooks module.
        hooks = yap_ipython.core.hooks
    ...
    def set_hook(self,name,hook, priority=50, str_key=None, re_key=None,
        ...
        """set_hook(name,hook) -> sets an internal yap_ipython hook.

        yap_ipython exposes some of its internal API as user-modifiable hooks.  By
        adding your function to one of these hooks, you can modify yap_ipython's
        ...
        if name not in yap_ipython.core.hooks.__all__:
            print("Warning! Hook '%s' is not one of %s" % \
                  (name, yap_ipython.core.hooks.__all__ ))

        if _warn_deprecated and (name in yap_ipython.core.hooks.deprecated):
            alternative = yap_ipython.core.hooks.deprecated[name]
            warn("Hook {} is deprecated. Use {} instead.".format(name, alternative), stacklevel=2)

        if not dp:
            dp = yap_ipython.core.hooks.CommandChainDispatcher()
    ...
    def new_main_mod(self, filename, modname):
        ...
        try:
            ...
            main_mod = self._main_mod_cache[filename] = types.ModuleType(
                        modname,
                        doc="Module created for script run in yap_ipython")
        else:
    ...
    def clear_main_mod_cache(self):
        ...
        In [15]: import yap_ipython

        In [16]: m = _ip.new_main_mod(yap_ipython.__file__, 'yap_ipython')
    ...
    #-------------------------------------------------------------------------
    # Things related to yap_ipython's various namespaces
    #-------------------------------------------------------------------------
    ...
    def init_create_namespaces(self, user_module=None, user_ns=None):
        ...
        # A table holding all the namespaces yap_ipython deals with, so that
    ...
    def prepare_user_module(self, user_module=None, user_ns=None):
        ...
        When yap_ipython is started normally, both parameters are None: a new module
        ...
        user_module : module, optional
            The current user module in which yap_ipython is being run. If None,
        ...
        if user_module is None:
            user_module = types.ModuleType("__main__",
                doc="Automatically created module for yap_ipython interactive environment")
    ...
    def init_sys_modules(self):
        ...
        # module but which accesses the yap_ipython namespace, for shelve and
        # pickle to work interactively. Normally they rely on getting
        # everything out of __main__, but for embedding purposes each yap_ipython
    ...
    def all_ns_refs(self):
        ...
        yap_ipython might store a user-created object.
    ...
    def push(self, variables, interactive=True):
        """Inject a group of variables into the yap_ipython user namespace.
            ...
            try:
                ...
                for idx, part in enumerate(oname_rest):
                    try:
                        ...
                        # AttributeError, which then crashes yap_ipython.
                        break
                else:
    ...
    def set_custom_exc(self, exc_tuple, handler):
        ...
        handler : callable
            ...
            of yap_ipython itself, and it will be called if any of the exceptions
            listed in the exc_tuple are caught. If the handler is None, an
            internal basic one is used, which just prints basic info.

            To protect yap_ipython from crashes, if your handler ever raises an
            exception or returns an invalid result, it will be immediately
            disabled.

        WARNING: by putting in your own exception handler into yap_ipython's main
        ...
        if handler is None:
            ...
            def wrapped(self,etype,value,tb,tb_offset=None):
                """wrap CustomTB handler, to protect yap_ipython from user code

                This makes it harder (but not impossible) for custom exception
                handlers to crash yap_ipython.
                """
                try:
    ...
    def excepthook(self, etype, value, tb):
        ...
        otherwise kill their mainloop. This is a bother for yap_ipython
        which excepts to catch all of the program exceptions with a try:
        except: statement.

        Normally, yap_ipython sets sys.excepthook to a CrashHandler instance, so if
        any app directly invokes sys.excepthook, it will look to the user like
        yap_ipython crashed.  In order to work around this, we can disable the
        CrashHandler and replace it with this excepthook instead, which prints a
        regular traceback using our InteractiveTB.  In this fashion, apps which
        call sys.excepthook will generate a regular-looking exception from
        yap_ipython, and the CrashHandler will only be triggered by real yap_ipython
        crashes.

        This hook should be used sparingly, only in places which are not likely
        to be true yap_ipython errors.
        """
            ...
            if issubclass(etype, SyntaxError):
                ...
                if exception_only:
                    ...
                    try:
                        ...
                        # use this in yap_ipython.parallel for exceptions occurring
    ...
    def init_readline(self):
        ...
        warnings.warn('`init_readline` is no-op since yap_ipython 5.0 and is Deprecated',
                DeprecationWarning, stacklevel=2)
    ...
    def init_completer(self):
        ...
        from yap_ipython.core.completerlib import (module_completer,
    ...
    def init_magics(self):
        from yap_ipython.core import magics as m
    ...
    def magic(self, arg_s):
        ...
        This provides a proper Python function to call yap_ipython's magics in any
    ...
    def system_raw(self, cmd):
        ...
        if sys.platform == 'win32':
            from yap_ipython.utils._process_win32 import AvoidUNCPath
    ...
    def auto_rewrite_input(self, cmd):
        ...
        input line was transformed automatically by yap_ipython.
        """
    ...
    def safe_execfile_ipy(self, fname, shell_futures=False, raise_exceptions=False):
        """Like safe_execfile, but for .ipy or .ipynb files with yap_ipython syntax.
    ...
    def run_cell(self, raw_cell, store_history=False, silent=False, shell_futures=True):
        """Run a complete yap_ipython cell.

        Parameters
        ----------
        raw_cell : str
          The code (including yap_ipython code such as %magic functions) to run.
        store_history : bool
          If True, the raw and translated cell will be stored in yap_ipython's
          history. For user code calling back into yap_ipython's machinery, this
    ...
    def _run_cell(self, raw_cell, store_history, silent, shell_futures):
        """Internal method to run a complete yap_ipython cell.
            ...
            if len(cell.splitlines()) == 1:
                ...
                with self.builtin_trap:
                    try:
                        ...
                        # don't allow prefilter errors to crash yap_ipython
                        preprocessing_exc_tuple = sys.exc_info()
    ...
    def run_code(self, code_obj, result=None):
        ...
        # directly, so that the yap_ipython crash handler doesn't get triggered
    ...
    def enable_matplotlib(self, gui=None):
        ...
        gui : optional, string
          ...
          (should be one of yap_ipython's supported backends, 'qt', 'osx', 'tk',
        ...
        """
        from yap_ipython.core import pylabtools as pt
    ...
    def enable_pylab(self, gui=None, import_all=True, welcome_message=False):
        ...
        namespace all of numpy and pylab, and configures yap_ipython to correctly
        ...
        """
        from yap_ipython.core.pylabtools import import_pylab
    ...
    def show_usage(self):
        ...
        page.page(yap_ipython.core.usage.interactive_usage)
    ...
    #-------------------------------------------------------------------------
    # Things related to yap_ipython exiting
    #-------------------------------------------------------------------------
    def atexit_operations(self):
        """This will be executed at the time of exit.

        Cleanup operations and saving of persistent data that is done
        unconditionally by yap_ipython should be performed here.
