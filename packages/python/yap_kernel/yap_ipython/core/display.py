...
class GeoJSON(JSON):
    ...
    def __init__(self, *args, **kwargs):
        ...
        interest on frontend that do support GeoJSON display.
            ...
            >>> from yap_ipython.display import GeoJSON
            ...
            ...     "maxZoom" : 18,
            ... })
            <yap_ipython.core.display.GeoJSON object>

        In the terminal yap_ipython, you will only see the text representation of
        the GeoJSON object.
    ...
    def _ipython_display_(self):
        bundle = {
            ...
            'text/plain': '<yap_ipython.display.GeoJSON object>'
        }
        metadata = {
