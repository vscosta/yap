...
if (DOXYGEN_FOUND)
   ...
   set(DOXYGEN_SHOW_NAMESPACES YES)
   set(DOXYGEN_TOC_INCLUDE_HEADINGS YE5  )
    ...
    */_CPack_Packages/*
    ...
    set(DOXYGEN_FILE_PATTERNS *.pl *.yap *.ypp *.c *.cc *.cxx *.cpp *.c++ *.java *.ii *.ixx *.ipp *.i++ *.inl *.idl *.ddl *.odl *.h *.hh *.hxx *.hpp *.h++ *.cs *.d *.php *.php4 *.php5 *.phtml *.inc *.m *.markdown *.md *.mm *.dox *.py *.pyw *.f90 *.f95 *.f03 *.f08 *.*.for *.tcl *.vhd *.vhdl *.ucf *.qsf *.ice)
...
configure_file(docs/md/yap.md.in ${CMAKE_BINARY_DIR}/mkdocs/docs/YAP/yap.md)
configure_file(docs/md/INSTALL.md.in ${CMAKE_BINARY_DIR}/mkdocs/docs/YAP/INSTALL.md)
file( COPY ${CMAKE_SOURCE_DIR}/docs/md/CALLING_YAP.md   DESTINATION ${CMAKE_BINARY_DIR}/mkdocs/docs/YAP )
