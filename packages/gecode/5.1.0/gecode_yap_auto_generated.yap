                 ...
                 -> (is_IntRelType(X2,Y2)
                     -> (is_IntVar(X3,Y3)
                         ...
                         ;  (is_int(X3,Y3)
                             ...
                             ;  throw(error(type_error(int(X3)),gecode_argument_error(nvalues(X0,X1,X2,X3,X4),arg=4)))))
                     ;  throw(error(type_error('IntRelType'(X2)),gecode_argument_error(nvalues(X0,X1,X2,X3,X4),arg=3))))
                 ;  throw(error(type_error('BoolVarArgs'(X1)),gecode_argument_error(nvalues(X0,X1,X2,X3,X4),arg=2)))))
         ...
         -> (is_IntVar(X1,Y1)
             ...
             ;  (is_IntVarArgs(X1,Y1)
                 ...
                 ;  (is_FloatVar(X1,Y1)
                     ...
                     ;  throw(error(type_error('FloatVar'(X1)),gecode_argument_error(max(X0,X1,X2,X3),arg=2))))))
                 ...
                 ;  (is_IntSet(X2,Y2)
                     -> (is_Reify(X3,Y3)
                         -> (is_IntPropLevel(X4,Y4)
                             ...
                             ;  throw(error(type_error('IntPropLevel'(X4)),gecode_argument_error(dom(X0,X1,X2,X3,X4),arg=5))))
                         ;  throw(error(type_error('Reify'(X3)),gecode_argument_error(dom(X0,X1,X2,X3,X4),arg=4))))
                     ;  throw(error(type_error('IntSet'(X2)),gecode_argument_error(dom(X0,X1,X2,X3,X4),arg=3)))))
             ;  (is_SetVarArgs(X1,Y1)
                 -> (is_SetRelType(X2,Y2)
                     -> (is_int(X3,Y3)
                         -> (is_int(X4,Y4)
                                 ...
                                 -> (is_int(X3,Y3)
                                     ...
                                     ;  (is_IntSet(X3,Y3)
                                         -> (is_Reify(X4,Y4)
                                             ...
                                             ;  throw(error(type_error('Reify'(X4)),gecode_argument_error(dom(X0,X1,X2,X3,X4),arg=5))))
                                         ;  throw(error(type_error('IntSet'(X3)),gecode_argument_error(dom(X0,X1,X2,X3,X4),arg=4)))))
                                 ;  throw(error(type_error('SetRelType'(X2)),gecode_argument_error(dom(X0,X1,X2,X3,X4),arg=3))))
        ...
        (is_Space_or_Clause(X0,Y0)
         -> (is_IntVarArgs(X1,Y1)
             ...
             ;  (is_BoolVarArgs(X1,Y1)
                 ...
                 ;  throw(error(type_error('BoolVarArgs'(X1)),gecode_argument_error(unshare(X0,X1),arg=2)))))
        ...
        (is_Space_or_Clause(X0,Y0)
         -> (is_int(X1,Y1)
             ...
             ;  (is_IntVarArgs(X1,Y1)
                 ...
                 ;  throw(error(type_error('IntVarArgs'(X1)),gecode_argument_error(path(X0,X1,X2,X3,X4),arg=2)))))
        ...
        (is_Space_or_Clause(X0,Y0)
         -> (is_IntVar(X1,Y1)
             ...
             ;  (is_FloatVar(X1,Y1)
                 ...
                 ;  throw(error(type_error('FloatVar'(X1)),gecode_argument_error(mult(X0,X1,X2,X3),arg=2)))))
        ...
        (is_Space_or_Clause(X0,Y0)
         -> (is_IntVarArgs(X1,Y1)
             ...
             ;  (is_BoolVarArgs(X1,Y1)
                 ...
                 ;  throw(error(type_error('BoolVarArgs'(X1)),gecode_argument_error(member(X0,X1,X2,X3),arg=2)))))
                     ...
                     -> (is_IntVarArgs(X3,Y3)
                         ...
                         ;  (is_BoolVarArgs(X3,Y3)
                             -> (is_IntPropLevel(X4,Y4)
                                 ...
                                 ;  throw(error(type_error('IntPropLevel'(X4)),gecode_argument_error(rel(X0,X1,X2,X3,X4),arg=5))))
                             ;  throw(error(type_error('BoolVarArgs'(X3)),gecode_argument_error(rel(X0,X1,X2,X3,X4),arg=4)))))
                                 ...
                                 ;  (is_BoolVar(X3,Y3)
                                     ...
                                     ;  (is_IntArgs(X3,Y3)
                                         -> (is_IntPropLevel(X4,Y4)
                                             ...
                                             ;  throw(error(type_error('IntPropLevel'(X4)),gecode_argument_error(rel(X0,X1,X2,X3,X4),arg=5))))
                                         ;  throw(error(type_error('IntArgs'(X3)),gecode_argument_error(rel(X0,X1,X2,X3,X4),arg=4)))))))
                         ;  throw(error(type_error('IntRelType'(X2)),gecode_argument_error(rel(X0,X1,X2,X3,X4),arg=3))))
                     ;  (is_BoolVar(X1,Y1)
                         -> (is_IntRelType(X2,Y2)
                             -> (is_int(X3,Y3)
                             ...
                             ;  (is_BoolOpType(X2,Y2)
                                 -> (is_BoolVar(X3,Y3)
                                     ...
                                     ;  throw(error(type_error('BoolVar'(X3)),gecode_argument_error(rel(X0,X1,X2,X3,X4),arg=4))))
                                 ;  throw(error(type_error('BoolOpType'(X2)),gecode_argument_error(rel(X0,X1,X2,X3,X4),arg=3)))))
                         ;  (is_IntVarArgs(X1,Y1)
                             -> (is_IntRelType(X2,Y2)
                                 -> (is_IntVar(X3,Y3)
                                     -> (is_IntPropLevel(X4,Y4)
                             ...
                             ;  (is_IntVar(X1,Y1)
                                 ...
                                 ;  (is_SetVar(X1,Y1)
                                     ...
                                     ;  (is_BoolOpType(X1,Y1)
                                         ...
                                         ;  throw(error(type_error('BoolOpType'(X1)),gecode_argument_error(rel(X0,X1,X2,X3,X4),arg=2)))))))))))
         ...
         -> (is_IntVar(X1,Y1)
             ...
             ;  (is_IntVarArgs(X1,Y1)
                 ...
                 ;  (is_FloatVar(X1,Y1)
                     ...
                     ;  throw(error(type_error('FloatVar'(X1)),gecode_argument_error(min(X0,X1,X2,X3),arg=2))))))
                     ...
                     ;  (is_IntSetArgs(X2,Y2)
                         -> (is_IntPropLevel(X3,Y3)
                             ...
                             ;  (is_IntArgs(X3,Y3)
                                 ...
                                 ;  throw(error(type_error('IntArgs'(X3)),gecode_argument_error(count(X0,X1,X2,X3),arg=4)))))
                         ;  throw(error(type_error('IntSetArgs'(X2)),gecode_argument_error(count(X0,X1,X2,X3),arg=3))))))
        ...
        (is_Space_or_Clause(X0,Y0)
         -> (is_IntVar(X1,Y1)
             ...
             ;  (is_FloatVar(X1,Y1)
                 ...
                 ;  throw(error(type_error('FloatVar'(X1)),gecode_argument_error(sqrt(X0,X1,X2),arg=2)))))
                 ...
                 -> (is_IntRelType(X2,Y2)
                     -> (is_IntVar(X3,Y3)
                         ...
                         ;  (is_int(X3,Y3)
                             ...
                             ;  throw(error(type_error(int(X3)),gecode_argument_error(nvalues(X0,X1,X2,X3),arg=4)))))
                     ;  throw(error(type_error('IntRelType'(X2)),gecode_argument_error(nvalues(X0,X1,X2,X3),arg=3))))
                 ;  throw(error(type_error('BoolVarArgs'(X1)),gecode_argument_error(nvalues(X0,X1,X2,X3),arg=2)))))
                     ...
                     -> (is_IntRelType(X3,Y3)
                         -> (is_IntVar(X4,Y4)
                             ...
                             ;  (is_int(X4,Y4)
                                 ...
                                 ;  throw(error(type_error(int(X4)),gecode_argument_error(linear(X0,X1,X2,X3,X4,X5,X6),arg=5)))))
                         ;  throw(error(type_error('IntRelType'(X3)),gecode_argument_error(linear(X0,X1,X2,X3,X4,X5,X6),arg=4))))
                     ;  throw(error(type_error('BoolVarArgs'(X2)),gecode_argument_error(linear(X0,X1,X2,X3,X4,X5,X6),arg=3)))))
        ...
        (is_Space_or_Clause(X0,Y0)
         -> (is_IntVar(X1,Y1)
             ...
             ;  (is_FloatVar(X1,Y1)
                 ...
                 ;  throw(error(type_error('FloatVar'(X1)),gecode_argument_error(div(X0,X1,X2,X3),arg=2)))))
                 ...
                 -> (is_IntRelType(X2,Y2)
                     ...
                     ;  (is_BoolOpType(X2,Y2)
                         -> (is_BoolVar(X3,Y3)
                             ...
                             ;  throw(error(type_error('BoolVar'(X3)),gecode_argument_error(rel(X0,X1,X2,X3,X4,X5),arg=4))))
                         ;  throw(error(type_error('BoolOpType'(X2)),gecode_argument_error(rel(X0,X1,X2,X3,X4,X5),arg=3)))))
         ...
         -> (is_IntVar(X1,Y1)
             ...
             ;  (is_FloatVar(X1,Y1)
                 -> (is_int(X2,Y2)
                     ...
                     ;  throw(error(type_error(int(X2)),gecode_argument_error(nroot(X0,X1,X2,X3),arg=3))))
                 ;  throw(error(type_error('FloatVar'(X1)),gecode_argument_error(nroot(X0,X1,X2,X3),arg=2)))))
                     ...
                     -> (is_IntVar(X3,Y3)
                         ...
                         ;  (is_IntVarArgs(X3,Y3)
                             -> (is_IntVar(X4,Y4)
                                 ...
                                 ;  throw(error(type_error('IntVar'(X4)),gecode_argument_error(circuit(X0,X1,X2,X3,X4),arg=5))))
                             ;  throw(error(type_error('IntVarArgs'(X3)),gecode_argument_error(circuit(X0,X1,X2,X3,X4),arg=4)))))
                     ;  throw(error(type_error('IntVarArgs'(X2)),gecode_argument_error(circuit(X0,X1,X2,X3,X4),arg=3)))))
                                 ...
                                 ;  (is_IntVarArgs(X2,Y2)
                                     ...
                                     ;  (is_IntSet(X2,Y2)
                                         -> (is_IntPropLevel(X3,Y3)
                                             ...
                                             ;  throw(error(type_error('IntPropLevel'(X3)),gecode_argument_error(dom(X0,X1,X2,X3),arg=4))))
                                         ;  throw(error(type_error('IntSet'(X2)),gecode_argument_error(dom(X0,X1,X2,X3),arg=3))))))
                             ;  (is_IntVar(X1,Y1)
                                 -> (is_IntVar(X2,Y2)
                                     -> (is_IntPropLevel(X3,Y3)
                                     ...
                                     -> (is_SetRelType(X2,Y2)
                                         -> (is_int(X3,Y3)
                                             ...
                                             ;  (is_IntSet(X3,Y3)
                                                 ...
                                                 ;  throw(error(type_error('IntSet'(X3)),gecode_argument_error(dom(X0,X1,X2,X3),arg=4)))))
        ...
        (is_Space_or_Clause(X0,Y0)
         -> (is_IntVar(X1,Y1)
             ...
             ;  (is_FloatVar(X1,Y1)
                 ...
                 ;  throw(error(type_error('FloatVar'(X1)),gecode_argument_error(abs(X0,X1,X2),arg=2)))))
        ...
        (is_Space_or_Clause(X0,Y0)
         -> (is_IntVarArgs(X1,Y1)
             ...
             ;  (is_BoolVarArgs(X1,Y1)
                 ...
                 ;  throw(error(type_error('BoolVarArgs'(X1)),gecode_argument_error(channel(X0,X1,X2,X3,X4),arg=2)))))
         ...
         -> (is_IntVarArgs(X1,Y1)
             ...
             ;  (is_BoolVarArgs(X1,Y1)
                 -> (is_IntRelType(X2,Y2)
                     ...
                     ;  throw(error(type_error('IntRelType'(X2)),gecode_argument_error(rel(X0,X1,X2),arg=3))))
                 ;  throw(error(type_error('BoolVarArgs'(X1)),gecode_argument_error(rel(X0,X1,X2),arg=2)))))
             ...
             -> (is_int(X2,Y2)
                 ...
                 ;  (is_IntVarArgs(X2,Y2)
                     -> (is_IntVarArgs(X3,Y3)
                         ...
                         ;  throw(error(type_error('IntVarArgs'(X3)),gecode_argument_error(circuit(X0,X1,X2,X3,X4,X5),arg=4))))
                     ;  throw(error(type_error('IntVarArgs'(X2)),gecode_argument_error(circuit(X0,X1,X2,X3,X4,X5),arg=3)))))
        ...
        (is_Space_or_Clause(X0,Y0)
         -> (is_IntVarArgs(X1,Y1)
             ...
             ;  (is_BoolVarArgs(X1,Y1)
                 ...
                 ;  throw(error(type_error('BoolVarArgs'(X1)),gecode_argument_error(member(X0,X1,X2,X3,X4),arg=2)))))
        ...
        (is_Space_or_Clause(X0,Y0)
         -> (is_IntVar(X1,Y1)
             ...
             ;  (is_FloatVar(X1,Y1)
                 ...
                 ;  throw(error(type_error('FloatVar'(X1)),gecode_argument_error(sqr(X0,X1,X2),arg=2)))))
             ...
             ;  (is_BoolVarArgs(X1,Y1)
                 -> (is_IntSet(X2,Y2)
                     -> (is_int(X3,Y3)
                         ...
                         ;  throw(error(type_error(int(X3)),gecode_argument_error(sequence(X0,X1,X2,X3,X4,X5,X6),arg=4))))
                     ;  throw(error(type_error('IntSet'(X2)),gecode_argument_error(sequence(X0,X1,X2,X3,X4,X5,X6),arg=3))))
                 ;  throw(error(type_error('BoolVarArgs'(X1)),gecode_argument_error(sequence(X0,X1,X2,X3,X4,X5,X6),arg=2)))))
         ...
         -> (is_IntArgs(X1,Y1)
             -> (is_int(X2,Y2)
                 ...
                 ;  (is_IntVarArgs(X2,Y2)
                     ...
                     ;  throw(error(type_error('IntVarArgs'(X2)),gecode_argument_error(path(X0,X1,X2,X3,X4,X5,X6),arg=3)))))
                 ...
                 -> (is_TupleSet(X2,Y2)
                     ...
                     ;  (is_DFA(X2,Y2)
                         -> (is_IntPropLevel(X3,Y3)
                             ...
                             ;  throw(error(type_error('IntPropLevel'(X3)),gecode_argument_error(extensional(X0,X1,X2,X3),arg=4))))
                         ;  throw(error(type_error('DFA'(X2)),gecode_argument_error(extensional(X0,X1,X2,X3),arg=3)))))
                 ;  throw(error(type_error('BoolVarArgs'(X1)),gecode_argument_error(extensional(X0,X1,X2,X3),arg=2)))))
        ...
        (is_Space_or_Clause(X0,Y0)
         -> (is_int(X1,Y1)
             ...
             ;  (is_IntVarArgs(X1,Y1)
                 ...
                 ;  throw(error(type_error('IntVarArgs'(X1)),gecode_argument_error(circuit(X0,X1,X2),arg=2)))))
             ...
             ;  (is_BoolVarArgs(X1,Y1)
                 -> (is_TupleSet(X2,Y2)
                     ...
                     ;  (is_DFA(X2,Y2)
                         ...
                         ;  throw(error(type_error('DFA'(X2)),gecode_argument_error(extensional(X0,X1,X2),arg=3)))))
                 ;  throw(error(type_error('BoolVarArgs'(X1)),gecode_argument_error(extensional(X0,X1,X2),arg=2)))))
                                 ...
                                 -> (is_IntRelType(X3,Y3)
                                     -> (is_IntVar(X4,Y4)
                                         ...
                                         ;  (is_int(X4,Y4)
                                             ...
                                             ;  throw(error(type_error(int(X4)),gecode_argument_error(linear(X0,X1,X2,X3,X4,X5),arg=5)))))
                                     ;  throw(error(type_error('IntRelType'(X3)),gecode_argument_error(linear(X0,X1,X2,X3,X4,X5),arg=4))))
                                 ;  throw(error(type_error('BoolVarArgs'(X2)),gecode_argument_error(linear(X0,X1,X2,X3,X4,X5),arg=3)))))
         ...
         -> (is_IntArgs(X1,Y1)
             -> (is_int(X2,Y2)
                 ...
                 ;  (is_IntVarArgs(X2,Y2)
                     ...
                     ;  throw(error(type_error('IntVarArgs'(X2)),gecode_argument_error(path(X0,X1,X2,X3,X4,X5,X6,X7),arg=3)))))
                     ...
                     -> (is_BoolValBranch(X3,Y3)
                         -> (is_Symmetries(X4,Y4)
                             ...
                             ;  (is_BoolBranchFilter(X4,Y4)
                                 ...
                                 ;  throw(error(type_error('BoolBranchFilter'(X4)),gecode_argument_error(branch(X0,X1,X2,X3,X4),arg=5)))))
         ...
         -> (is_IntVar(X1,Y1)
             ...
             ;  (is_FloatVar(X1,Y1)
                 -> (is_int(X2,Y2)
                     ...
                     ;  throw(error(type_error(int(X2)),gecode_argument_error(pow(X0,X1,X2,X3),arg=3))))
                 ;  throw(error(type_error('FloatVar'(X1)),gecode_argument_error(pow(X0,X1,X2,X3),arg=2)))))
             ...
             ;  (is_BoolVarArgs(X1,Y1)
                 -> (is_IntSet(X2,Y2)
                     -> (is_int(X3,Y3)
                         ...
                         ;  throw(error(type_error(int(X3)),gecode_argument_error(sequence(X0,X1,X2,X3,X4,X5),arg=4))))
                     ;  throw(error(type_error('IntSet'(X2)),gecode_argument_error(sequence(X0,X1,X2,X3,X4,X5),arg=3))))
                 ;  throw(error(type_error('BoolVarArgs'(X1)),gecode_argument_error(sequence(X0,X1,X2,X3,X4,X5),arg=2)))))
         ...
         -> (is_IntVarArgs(X1,Y1)
             ...
             ;  (is_BoolVarArgs(X1,Y1)
                 -> (is_IntPropLevel(X2,Y2)
                     ...
                     ;  throw(error(type_error('IntPropLevel'(X2)),gecode_argument_error(unshare(X0,X1,X2),arg=3))))
                 ;  throw(error(type_error('BoolVarArgs'(X1)),gecode_argument_error(unshare(X0,X1,X2),arg=2)))))
                     ...
                     -> (is_BoolValBranch(X3,Y3)
                         -> (is_Symmetries(X4,Y4)
                             ...
                             ;  (is_BoolBranchFilter(X4,Y4)
                                 ...
                                 ;  throw(error(type_error('BoolBranchFilter'(X4)),gecode_argument_error(branch(X0,X1,X2,X3,X4,X5),arg=5)))))
        ...
        (is_Space_or_Clause(X0,Y0)
         -> (is_IntVarArgs(X1,Y1)
             ...
             ;  (is_BoolVarArgs(X1,Y1)
                 ...
                 ;  throw(error(type_error('BoolVarArgs'(X1)),gecode_argument_error(member(X0,X1,X2),arg=2)))))
                             ...
                             -> (is_IntRelType(X3,Y3)
                                 -> (is_IntVar(X4,Y4)
                                     ...
                                     ;  (is_int(X4,Y4)
                                         ...
                                         ;  throw(error(type_error(int(X4)),gecode_argument_error(count(X0,X1,X2,X3,X4,X5),arg=5)))))
                                 ;  throw(error(type_error('IntRelType'(X3)),gecode_argument_error(count(X0,X1,X2,X3,X4,X5),arg=4))))
                             ;  throw(error(type_error('IntArgs'(X2)),gecode_argument_error(count(X0,X1,X2,X3,X4,X5),arg=3)))))))
                             ...
                             -> (is_int(X2,Y2)
                                 ...
                                 ;  (is_IntVarArgs(X2,Y2)
                                     ...
                                     ;  (is_IntSet(X2,Y2)
                                         ...
                                         ;  throw(error(type_error('IntSet'(X2)),gecode_argument_error(dom(X0,X1,X2),arg=3))))))
                             ;  (is_IntVar(X1,Y1)
                                 -> (is_IntVar(X2,Y2)
                                     ...
                                     -> (is_IntRelType(X3,Y3)
                                         -> (is_IntVar(X4,Y4)
                                             ...
                                             ;  (is_int(X4,Y4)
                                                 ...
                                                 ;  throw(error(type_error(int(X4)),gecode_argument_error(linear(X0,X1,X2,X3,X4),arg=5)))))
                                         ;  throw(error(type_error('IntRelType'(X3)),gecode_argument_error(linear(X0,X1,X2,X3,X4),arg=4))))
                                     ;  throw(error(type_error('BoolVarArgs'(X2)),gecode_argument_error(linear(X0,X1,X2,X3,X4),arg=3)))))
                 ...
                 -> (is_IntRelType(X2,Y2)
                     -> (is_IntVarArgs(X3,Y3)
                         ...
                         ;  (is_BoolVarArgs(X3,Y3)
                             ...
                             ;  throw(error(type_error('BoolVarArgs'(X3)),gecode_argument_error(rel(X0,X1,X2,X3),arg=4)))))
                                     ...
                                     ;  (is_BoolVarArgs(X3,Y3)
                                         ...
                                         ;  (is_BoolVar(X3,Y3)
                                             ...
                                             ;  (is_IntArgs(X3,Y3)
                                                 ...
                                                 ;  throw(error(type_error('IntArgs'(X3)),gecode_argument_error(rel(X0,X1,X2,X3),arg=4))))))))
                             ;  throw(error(type_error('IntRelType'(X2)),gecode_argument_error(rel(X0,X1,X2,X3),arg=3))))
                         ;  (is_BoolVar(X1,Y1)
                             -> (is_IntRelType(X2,Y2)
                                 -> (is_int(X3,Y3)
                                 ...
                                 ;  (is_IntVar(X1,Y1)
                                     ...
                                     ;  (is_SetVar(X1,Y1)
                                         ...
                                         ;  (is_BoolOpType(X1,Y1)
                                             ...
                                             ;  throw(error(type_error('BoolOpType'(X1)),gecode_argument_error(rel(X0,X1,X2,X3),arg=2))))))))))))
         ...
         -> (is_IntVarArgs(X1,Y1)
             -> (is_IntVarArgs(X2,Y2)
                 ...
                 ;  (is_IntSetArgs(X2,Y2)
                     ...
                     ;  throw(error(type_error('IntSetArgs'(X2)),gecode_argument_error(count(X0,X1,X2),arg=3)))))
