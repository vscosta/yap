...
from yap_ipython.core.magic import (Magics, magics_class, line_magic, cell_magic,
...
from yap_ipython.utils.module_paths import find_mod
from yap_ipython.utils.path import get_py_filename, shellglob
from yap_ipython.utils.timing import clock, clock2
...
python-profiler package from non-free.""")
    ...
    def prun(self, parameter_s='', cell=None):
        ...
        cannot be used in yap_ipython because it makes certain assumptions about
        namespaces which do not hold under yap_ipython.
    ...
    def pdb(self, parameter_s=''):
        ...
        When an exception is triggered, yap_ipython can optionally call the
    ...
    def debug(self, line='', cell=None):
        ...
        If you want yap_ipython to automatically do this on every exception, see
    ...
    def run(self, parameter_s='', runner=None,
        ...
        """Run the named file inside yap_ipython as a program.
        ...
        the program (put in sys.argv). Then, control returns to yap_ipython's
        prompt.

        This is similar to running at a system prompt ``python file args``,
        but with the advantage of giving you yap_ipython's tracebacks, and of
        ...
        modules). But after execution, the yap_ipython interactive namespace gets
        ...
        *two* back slashes (e.g. ``\\\\*``) to suppress expansions.
        ...
        -i
          run the file in yap_ipython's namespace instead of an empty one. This
          is useful if you are experimenting with code written in a text editor
          which depends on variables defined interactively.

        -e
          ignore sys.exit() calls or SystemExit exceptions in the script
          being run.  This is particularly useful if yap_ipython is being used to
          run unittests, which always exit with a sys.exit() call.  In such
          cases you are interested in the output of the test results, not in
          seeing a traceback of the unittest module.

        -t
          print timing information at the end of the run.  yap_ipython will give
        ...
        For example (testing the script uniq_stable.py)::
            ...
            yap_ipython CPU timings (estimated):
              User  :    0.19597 s.
              System:        0.0 s.
        ...
        -d
          ...
          etc.  Internally, what yap_ipython does is similar to calling::
        ...
        -p
          ...
          yap_ipython interactive namespace (because they remain in the namespace
        ...
        just as if the commands were written on yap_ipython prompt.
        ...
        try:
            ...
            if 'i' in opts:
                ...
                # update yap_ipython interactive namespace
            ...
            # %run.  As best I can see, this is NOT something yap_ipython is doing
    ...
    def macro(self, parameter_s=''):
        ...
        but yap_ipython's display system checks for macros and executes them as
    ...
    @magic_arguments.argument('--no-display', action="store_true",
        help="""Don't capture yap_ipython's rich display."""
    )
    @cell_magic
    def capture(self, line, cell):
        """run the cell, capturing stdout, stderr, and yap_ipython's rich display() calls."""
