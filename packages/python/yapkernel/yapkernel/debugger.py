...
class Debugger:
    ...
    async def stackTrace(self, message):
        ...
        # { frames from yapkernel }
        # ...
        # {'id': yyy, 'name': '<module>', ... } <= this is the first frame of yapkernel code
        # or only the frames from the notebook.
        # We want to remove all the frames from yapkernel when they are present.
        try:
