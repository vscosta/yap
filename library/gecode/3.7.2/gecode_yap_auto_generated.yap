                 ...
                 -> (is_IntArgs(X3,Y3)
                     -> (is_BoolVarArgs(X4,Y4)
                         -> (is_IntConLevel(X5,Y5)
                             ...
                             ;  throw(gecode_argument_error(unary/6,arg=6,X5)))
                         ;  throw(gecode_argument_error(unary/6,arg=5,X4)))
                     ;  throw(gecode_argument_error(unary/6,arg=4,X3)))
                 ;  throw(gecode_argument_error(unary/6,arg=3,X2)))
             ;  (is_IntVarArgs(X1,Y1)
                 -> (is_IntVarArgs(X2,Y2)
                     -> (is_IntVarArgs(X3,Y3)
                         -> (is_BoolVarArgs(X4,Y4)
                         ...
                         ;  throw(gecode_argument_error(unary/6,arg=4,X3)))
                     ;  throw(gecode_argument_error(unary/6,arg=3,X2)))
                 ;  throw(gecode_argument_error(unary/6,arg=2,X1))))
         ;  throw(gecode_argument_error(unary/6,arg=1,X0))).
             ...
             -> (is_IntRelType(X2,Y2)
                 -> (is_int(X3,Y3)
                     -> (is_IntConLevel(X4,Y4)
                         ...
                         ;  throw(gecode_argument_error(nvalues/5,arg=5,X4)))
                     ;  (is_IntVar(X3,Y3)
                         -> (is_IntConLevel(X4,Y4)
                             -> gecode_constraint_nvalues_257(Y0,Y1,Y2,Y3,Y4)
                             ;  throw(gecode_argument_error(nvalues/5,arg=5,X4)))
                         ;  throw(gecode_argument_error(nvalues/5,arg=4,X3))))
                 ;  throw(gecode_argument_error(nvalues/5,arg=3,X2)))
                 ...
                 -> (is_IntRelType(X2,Y2)
                     -> (is_int(X3,Y3)
                         ...
                         ;  (is_IntVar(X3,Y3)
                             ...
                             ;  throw(gecode_argument_error(nvalues/5,arg=4,X3))))
                     ;  throw(gecode_argument_error(nvalues/5,arg=3,X2)))
                 ;  throw(gecode_argument_error(nvalues/5,arg=2,X1))))
         ;  throw(gecode_argument_error(nvalues/5,arg=1,X0))).
         ...
         -> (is_IntVar(X1,Y1)
             -> (is_IntVar(X2,Y2)
                 -> (is_IntVar(X3,Y3)
                     ...
                     ;  throw(gecode_argument_error(max/4,arg=4,X3)))
                 ;  throw(gecode_argument_error(max/4,arg=3,X2)))
             ;  (is_IntVarArgs(X1,Y1)
                 -> (is_IntVar(X2,Y2)
                 ...
                 ;  (is_SetVar(X1,Y1)
                     -> (is_IntVar(X2,Y2)
                         -> (is_BoolVar(X3,Y3)
                             ...
                             ;  throw(gecode_argument_error(max/4,arg=4,X3)))
                         ;  throw(gecode_argument_error(max/4,arg=3,X2)))
                     ;  throw(gecode_argument_error(max/4,arg=2,X1)))))
         ;  throw(gecode_argument_error(max/4,arg=1,X0))).
                 ...
                 -> (is_int(X3,Y3)
                     -> (is_BoolVar(X4,Y4)
                         -> (is_IntConLevel(X5,Y5)
                             ...
                             ;  throw(gecode_argument_error(dom/6,arg=6,X5)))
                         ;  throw(gecode_argument_error(dom/6,arg=5,X4)))
                     ;  throw(gecode_argument_error(dom/6,arg=4,X3)))
                 ;  throw(gecode_argument_error(dom/6,arg=3,X2)))
             ;  (is_SetVar(X1,Y1)
                 -> (is_SetRelType(X2,Y2)
                     -> (is_int(X3,Y3)
                         -> (is_int(X4,Y4)
                         ...
                         ;  throw(gecode_argument_error(dom/6,arg=4,X3)))
                     ;  throw(gecode_argument_error(dom/6,arg=3,X2)))
                 ;  throw(gecode_argument_error(dom/6,arg=2,X1))))
         ;  throw(gecode_argument_error(dom/6,arg=1,X0))).
        ...
        (is_Space_or_Clause(X0,Y0)
         -> (is_SetVar(X1,Y1)
             -> (is_SetVar(X2,Y2)
                 ...
                 ;  throw(gecode_argument_error(convex/3,arg=3,X2)))
             ;  throw(gecode_argument_error(convex/3,arg=2,X1)))
         ;  throw(gecode_argument_error(convex/3,arg=1,X0))).
             ...
             -> (is_IntArgs(X2,Y2)
                 -> (is_IntVarArgs(X3,Y3)
                     -> (is_IntArgs(X4,Y4)
                         ...
                         ;  throw(gecode_argument_error(nooverlap/5,arg=5,X4)))
                     ;  throw(gecode_argument_error(nooverlap/5,arg=4,X3)))
                 ;  throw(gecode_argument_error(nooverlap/5,arg=3,X2)))
             ;  throw(gecode_argument_error(nooverlap/5,arg=2,X1)))
         ;  throw(gecode_argument_error(nooverlap/5,arg=1,X0))).
        ...
        (is_Space_or_Clause(X0,Y0)
         -> (is_BoolVarArgs(X1,Y1)
             -> (is_IntAssign(X2,Y2)
                 ...
                 ;  throw(gecode_argument_error(assign/3,arg=3,X2)))
             ;  (is_BoolVar(X1,Y1)
                 -> (is_IntAssign(X2,Y2)
                         ...
                         ;  (is_SetVarArgs(X1,Y1)
                             ...
                             ;  (is_SetVar(X1,Y1)
                                 -> (is_SetAssign(X2,Y2)
                                     ...
                                     ;  throw(gecode_argument_error(assign/3,arg=3,X2)))
                                 ;  throw(gecode_argument_error(assign/3,arg=2,X1))))))))
         ;  throw(gecode_argument_error(assign/3,arg=1,X0))).
             ...
             -> (is_IntVar(X2,Y2)
                 -> (is_int(X3,Y3)
                     ...
                     ;  (is_IntVar(X3,Y3)
                         ...
                         ;  throw(gecode_argument_error(element/4,arg=4,X3))))
                 ;  throw(gecode_argument_error(element/4,arg=3,X2)))
             ;  (is_BoolVarArgs(X1,Y1)
                 -> (is_IntVar(X2,Y2)
                     -> (is_int(X3,Y3)
                                 ...
                                 -> (is_int(X3,Y3)
                                     ...
                                     ;  (is_IntVar(X3,Y3)
                                         ...
                                         ;  (is_BoolVar(X3,Y3)
                                             ...
                                             ;  throw(gecode_argument_error(element/4,arg=4,X3)))))
                                 ;  throw(gecode_argument_error(element/4,arg=3,X2)))
                             ;  throw(gecode_argument_error(element/4,arg=2,X1)))))))
         ;  throw(gecode_argument_error(element/4,arg=1,X0))).

sequence(X0,X1) :-
        (is_Space_or_Clause(X0,Y0)
         -> (is_SetVarArgs(X1,Y1)
             -> gecode_constraint_sequence_338(Y0,Y1)
             ;  throw(gecode_argument_error(sequence/2,arg=2,X1)))
         ;  throw(gecode_argument_error(sequence/2,arg=1,X0))).
        ...
        (is_Space_or_Clause(X0,Y0)
         -> (is_SetVar(X1,Y1)
             -> (is_IntVar(X2,Y2)
                 ...
                 ;  throw(gecode_argument_error(notMax/3,arg=3,X2)))
             ;  throw(gecode_argument_error(notMax/3,arg=2,X1)))
         ;  throw(gecode_argument_error(notMax/3,arg=1,X0))).
        ...
        (is_Space_or_Clause(X0,Y0)
         -> (is_IntVarArgs(X1,Y1)
             -> (is_IntArgs(X2,Y2)
                 ...
                 ;  throw(gecode_argument_error(unary/3,arg=3,X2)))
             ;  throw(gecode_argument_error(unary/3,arg=2,X1)))
         ;  throw(gecode_argument_error(unary/3,arg=1,X0))).
         ...
         -> (is_int(X1,Y1)
             -> (is_IntVarArgs(X2,Y2)
                 -> (is_IntConLevel(X3,Y3)
                     ...
                     ;  throw(gecode_argument_error(circuit/4,arg=4,X3)))
                 ;  throw(gecode_argument_error(circuit/4,arg=3,X2)))
             ;  (is_IntArgs(X1,Y1)
                 -> (is_IntVarArgs(X2,Y2)
                     -> (is_IntVar(X3,Y3)
                         ...
                         ;  throw(gecode_argument_error(circuit/4,arg=4,X3)))
                     ;  throw(gecode_argument_error(circuit/4,arg=3,X2)))
                 ;  throw(gecode_argument_error(circuit/4,arg=2,X1))))
         ;  throw(gecode_argument_error(circuit/4,arg=1,X0))).
                 ...
                 -> (is_int(X3,Y3)
                     -> (is_BoolVar(X4,Y4)
                         ...
                         ;  (is_IntConLevel(X4,Y4)
                             ...
                             ;  throw(gecode_argument_error(dom/5,arg=5,X4))))
                     ;  (is_BoolVar(X3,Y3)
                         -> (is_IntConLevel(X4,Y4)
                             -> gecode_constraint_dom_137(Y0,Y1,Y2,Y3,Y4)
                             ;  throw(gecode_argument_error(dom/5,arg=5,X4)))
                         ;  throw(gecode_argument_error(dom/5,arg=4,X3))))
                 ;  (is_IntSet(X2,Y2)
                     -> (is_BoolVar(X3,Y3)
                         -> (is_IntConLevel(X4,Y4)
                             ...
                             ;  throw(gecode_argument_error(dom/5,arg=5,X4)))
                         ;  throw(gecode_argument_error(dom/5,arg=4,X3)))
                     ;  throw(gecode_argument_error(dom/5,arg=3,X2))))
             ;  (is_IntVarArgs(X1,Y1)
                 -> (is_int(X2,Y2)
                     -> (is_int(X3,Y3)
                         -> (is_IntConLevel(X4,Y4)
                     ...
                     -> (is_SetRelType(X2,Y2)
                         -> (is_int(X3,Y3)
                             ...
                             ;  (is_IntSet(X3,Y3)
                                 ...
                                 ;  throw(gecode_argument_error(dom/5,arg=4,X3))))
                         ;  throw(gecode_argument_error(dom/5,arg=3,X2)))
                     ;  throw(gecode_argument_error(dom/5,arg=2,X1)))))
         ;  throw(gecode_argument_error(dom/5,arg=1,X0))).
         ...
         -> (is_IntVar(X1,Y1)
             -> (is_BoolVar(X2,Y2)
                 -> (is_IntConLevel(X3,Y3)
                     ...
                     ;  throw(gecode_argument_error(channel/4,arg=4,X3)))
                 ;  throw(gecode_argument_error(channel/4,arg=3,X2)))
             ;  (is_IntVarArgs(X1,Y1)
                 -> (is_IntVarArgs(X2,Y2)
                     -> (is_IntConLevel(X3,Y3)
                     ...
                     ;  (is_BoolVar(X1,Y1)
                         -> (is_IntVar(X2,Y2)
                             -> (is_IntConLevel(X3,Y3)
                                 ...
                                 ;  throw(gecode_argument_error(channel/4,arg=4,X3)))
                             ;  throw(gecode_argument_error(channel/4,arg=3,X2)))
                         ;  throw(gecode_argument_error(channel/4,arg=2,X1))))))
         ;  throw(gecode_argument_error(channel/4,arg=1,X0))).
                             ...
                             -> (is_IntVarArgs(X6,Y6)
                                 -> (is_BoolVarArgs(X7,Y7)
                                     ...
                                     ;  (is_IntConLevel(X7,Y7)
                                         ...
                                         ;  throw(gecode_argument_error(nooverlap/8,arg=8,X7))))
                                 ;  throw(gecode_argument_error(nooverlap/8,arg=7,X6)))
                             ;  throw(gecode_argument_error(nooverlap/8,arg=6,X5)))
                         ;  throw(gecode_argument_error(nooverlap/8,arg=5,X4)))
                     ;  throw(gecode_argument_error(nooverlap/8,arg=4,X3)))
                 ;  throw(gecode_argument_error(nooverlap/8,arg=3,X2)))
             ;  throw(gecode_argument_error(nooverlap/8,arg=2,X1)))
         ;  throw(gecode_argument_error(nooverlap/8,arg=1,X0))).
                     ...
                     -> (is_IntVar(X4,Y4)
                         -> (is_int(X5,Y5)
                             -> (is_IntVar(X6,Y6)
                                 ...
                                 ;  throw(gecode_argument_error(element/7,arg=7,X6)))
                             ;  throw(gecode_argument_error(element/7,arg=6,X5)))
                         ;  throw(gecode_argument_error(element/7,arg=5,X4)))
                     ;  throw(gecode_argument_error(element/7,arg=4,X3)))
                 ;  throw(gecode_argument_error(element/7,arg=3,X2)))
             ;  (is_BoolVarArgs(X1,Y1)
                 -> (is_IntVar(X2,Y2)
                     -> (is_int(X3,Y3)
                         -> (is_IntVar(X4,Y4)
                         ...
                         ;  (is_IntArgs(X1,Y1)
                             -> (is_IntVar(X2,Y2)
                                 -> (is_int(X3,Y3)
                                     ...
                                     ;  throw(gecode_argument_error(element/7,arg=4,X3)))
                                 ;  throw(gecode_argument_error(element/7,arg=3,X2)))
                             ;  throw(gecode_argument_error(element/7,arg=2,X1)))))))
         ;  throw(gecode_argument_error(element/7,arg=1,X0))).
        ...
        (is_Space_or_Clause(X0,Y0)
         -> (is_IntVarArgs(X1,Y1)
             -> (is_IntVar(X2,Y2)
                 ...
                 ;  throw(gecode_argument_error(max/3,arg=3,X2)))
             ;  (is_SetVar(X1,Y1)
                 -> (is_IntVar(X2,Y2)
                     -> gecode_constraint_max_220(Y0,Y1,Y2)
                     ;  throw(gecode_argument_error(max/3,arg=3,X2)))
                 ;  throw(gecode_argument_error(max/3,arg=2,X1))))
         ;  throw(gecode_argument_error(max/3,arg=1,X0))).
        ...
        (is_Space_or_Clause(X0,Y0)
         -> (is_IntVarArgs(X1,Y1)
             ...
             ;  (is_BoolVarArgs(X1,Y1)
                 ...
                 ;  throw(gecode_argument_error(unshare/2,arg=2,X1))))
         ;  throw(gecode_argument_error(unshare/2,arg=1,X0))).
             ...
             -> (is_IntVarArgs(X2,Y2)
                 -> (is_IntVar(X3,Y3)
                     -> (is_IntVar(X4,Y4)
                         ...
                         ;  throw(gecode_argument_error(path/5,arg=5,X4)))
                     ;  throw(gecode_argument_error(path/5,arg=4,X3)))
                 ;  throw(gecode_argument_error(path/5,arg=3,X2)))
             ;  (is_IntVarArgs(X1,Y1)
                 -> (is_IntVar(X2,Y2)
                     -> (is_IntVar(X3,Y3)
                         -> (is_IntConLevel(X4,Y4)
                         ...
                         ;  throw(gecode_argument_error(path/5,arg=4,X3)))
                     ;  throw(gecode_argument_error(path/5,arg=3,X2)))
                 ;  throw(gecode_argument_error(path/5,arg=2,X1))))
         ;  throw(gecode_argument_error(path/5,arg=1,X0))).
         ...
         -> (is_IntVar(X1,Y1)
             -> (is_IntVar(X2,Y2)
                 -> (is_IntVar(X3,Y3)
                     ...
                     ;  throw(gecode_argument_error(mult/4,arg=4,X3)))
                 ;  throw(gecode_argument_error(mult/4,arg=3,X2)))
             ;  throw(gecode_argument_error(mult/4,arg=2,X1)))
         ;  throw(gecode_argument_error(mult/4,arg=1,X0))).
                 ...
                 -> (is_BoolVarArgs(X3,Y3)
                     -> (is_int(X4,Y4)
                         -> (is_IntConLevel(X5,Y5)
                             ...
                             ;  throw(gecode_argument_error(clause/6,arg=6,X5)))
                         ;  (is_BoolVar(X4,Y4)
                             -> (is_IntConLevel(X5,Y5)
                                 -> gecode_constraint_clause_47(Y0,Y1,Y2,Y3,Y4,Y5)
                                 ;  throw(gecode_argument_error(clause/6,arg=6,X5)))
                             ;  throw(gecode_argument_error(clause/6,arg=5,X4))))
                     ;  throw(gecode_argument_error(clause/6,arg=4,X3)))
                 ;  throw(gecode_argument_error(clause/6,arg=3,X2)))
             ;  throw(gecode_argument_error(clause/6,arg=2,X1)))
         ;  throw(gecode_argument_error(clause/6,arg=1,X0))).
             ...
             -> (is_int(X2,Y2)
                 -> (is_int(X3,Y3)
                     -> (is_IntConLevel(X4,Y4)
                         ...
                         ;  throw(gecode_argument_error(precede/5,arg=5,X4)))
                     ;  throw(gecode_argument_error(precede/5,arg=4,X3)))
                 ;  throw(gecode_argument_error(precede/5,arg=3,X2)))
             ;  throw(gecode_argument_error(precede/5,arg=2,X1)))
         ;  throw(gecode_argument_error(precede/5,arg=1,X0))).

distinct(X0,X1) :-
        (is_Space_or_Clause(X0,Y0)
         -> (is_IntVarArgs(X1,Y1)
             -> gecode_constraint_distinct_120(Y0,Y1)
             ;  throw(gecode_argument_error(distinct/2,arg=2,X1)))
         ;  throw(gecode_argument_error(distinct/2,arg=1,X0))).
             ...
             -> (is_IntVar(X2,Y2)
                 -> (is_BoolVar(X3,Y3)
                     ...
                     ;  (is_IntConLevel(X3,Y3)
                         ...
                         ;  throw(gecode_argument_error(member/4,arg=4,X3))))
                 ;  throw(gecode_argument_error(member/4,arg=3,X2)))
             ;  (is_BoolVarArgs(X1,Y1)
                 -> (is_BoolVar(X2,Y2)
                     -> (is_BoolVar(X3,Y3)
                         ...
                         ;  (is_IntConLevel(X3,Y3)
                             ...
                             ;  throw(gecode_argument_error(member/4,arg=4,X3))))
                     ;  throw(gecode_argument_error(member/4,arg=3,X2)))
                 ;  throw(gecode_argument_error(member/4,arg=2,X1))))
         ;  throw(gecode_argument_error(member/4,arg=1,X0))).
             ...
             -> (is_IntVar(X2,Y2)
                 -> (is_IntVar(X3,Y3)
                     -> (is_IntConLevel(X4,Y4)
                         ...
                         ;  throw(gecode_argument_error(mod/5,arg=5,X4)))
                     ;  throw(gecode_argument_error(mod/5,arg=4,X3)))
                 ;  throw(gecode_argument_error(mod/5,arg=3,X2)))
             ;  throw(gecode_argument_error(mod/5,arg=2,X1)))
         ;  throw(gecode_argument_error(mod/5,arg=1,X0))).
        ...
        (is_Space_or_Clause(X0,Y0)
         -> (is_SetVar(X1,Y1)
             -> (is_IntVar(X2,Y2)
                 ...
                 ;  throw(gecode_argument_error(cardinality/3,arg=3,X2)))
             ;  throw(gecode_argument_error(cardinality/3,arg=2,X1)))
         ;  throw(gecode_argument_error(cardinality/3,arg=1,X0))).
        ...
        (is_Space_or_Clause(X0,Y0)
         -> (is_SetVarArgs(X1,Y1)
             -> (is_int(X2,Y2)
                 ...
                 ;  throw(gecode_argument_error(atmostOne/3,arg=3,X2)))
             ;  throw(gecode_argument_error(atmostOne/3,arg=2,X1)))
         ;  throw(gecode_argument_error(atmostOne/3,arg=1,X0))).
        ...
        (is_Space_or_Clause(X0,Y0)
         -> (is_IntVarArgs(X1,Y1)
             -> (is_SetVar(X2,Y2)
                 ...
                 ;  throw(gecode_argument_error(channelSorted/3,arg=3,X2)))
             ;  throw(gecode_argument_error(channelSorted/3,arg=2,X1)))
         ;  throw(gecode_argument_error(channelSorted/3,arg=1,X0))).
             ...
             -> (is_IntRelType(X2,Y2)
                 -> (is_int(X3,Y3)
                     ...
                     ;  (is_IntVar(X3,Y3)
                         ...
                         ;  throw(gecode_argument_error(linear/4,arg=4,X3))))
                 ;  throw(gecode_argument_error(linear/4,arg=3,X2)))
             ;  (is_BoolVarArgs(X1,Y1)
                 -> (is_IntRelType(X2,Y2)
                     -> (is_int(X3,Y3)
                         ...
                         ;  (is_IntVar(X3,Y3)
                             ...
                             ;  throw(gecode_argument_error(linear/4,arg=4,X3))))
                     ;  throw(gecode_argument_error(linear/4,arg=3,X2)))
                 ;  throw(gecode_argument_error(linear/4,arg=2,X1))))
         ;  throw(gecode_argument_error(linear/4,arg=1,X0))).

circuit(X0,X1) :-
        (is_Space_or_Clause(X0,Y0)
         -> (is_IntVarArgs(X1,Y1)
             -> gecode_constraint_circuit_42(Y0,Y1)
             ;  throw(gecode_argument_error(circuit/2,arg=2,X1)))
         ;  throw(gecode_argument_error(circuit/2,arg=1,X0))).
                 ...
                 -> (is_int(X3,Y3)
                     -> (is_BoolVar(X4,Y4)
                         ...
                         ;  (is_IntConLevel(X4,Y4)
                             ...
                             ;  throw(gecode_argument_error(rel/5,arg=5,X4))))
                     ;  (is_BoolVar(X3,Y3)
                         -> (is_BoolVar(X4,Y4)
                             ...
                             ;  (is_IntConLevel(X4,Y4)
                                 ...
                                 ;  throw(gecode_argument_error(rel/5,arg=5,X4))))
                         ;  throw(gecode_argument_error(rel/5,arg=4,X3))))
                 ;  (is_BoolOpType(X2,Y2)
                     -> (is_BoolVar(X3,Y3)
                         -> (is_int(X4,Y4)
                             ...
                             ;  (is_BoolVar(X4,Y4)
                                 ...
                                 ;  throw(gecode_argument_error(rel/5,arg=5,X4))))
                         ;  throw(gecode_argument_error(rel/5,arg=4,X3)))
                     ;  throw(gecode_argument_error(rel/5,arg=3,X2))))
             ;  (is_BoolVarArgs(X1,Y1)
                 -> (is_IntRelType(X2,Y2)
                     -> (is_int(X3,Y3)
                         -> (is_IntConLevel(X4,Y4)
                                     ...
                                     -> (is_BoolVarArgs(X2,Y2)
                                         -> (is_int(X3,Y3)
                                             ...
                                             ;  (is_BoolVar(X3,Y3)
                                                 ...
                                                 ;  throw(gecode_argument_error(rel/5,arg=4,X3))))
                                         ;  throw(gecode_argument_error(rel/5,arg=3,X2)))
                                     ;  throw(gecode_argument_error(rel/5,arg=2,X1)))))))))
         ;  throw(gecode_argument_error(rel/5,arg=1,X0))).
         ...
         -> (is_IntVar(X1,Y1)
             -> (is_IntVar(X2,Y2)
                 -> (is_IntVar(X3,Y3)
                     ...
                     ;  throw(gecode_argument_error(min/4,arg=4,X3)))
                 ;  throw(gecode_argument_error(min/4,arg=3,X2)))
             ;  (is_IntVarArgs(X1,Y1)
                 -> (is_IntVar(X2,Y2)
                     -> (is_IntConLevel(X3,Y3)
                 ...
                 ;  (is_SetVar(X1,Y1)
                     -> (is_IntVar(X2,Y2)
                         -> (is_BoolVar(X3,Y3)
                             ...
                             ;  throw(gecode_argument_error(min/4,arg=4,X3)))
                         ;  throw(gecode_argument_error(min/4,arg=3,X2)))
                     ;  throw(gecode_argument_error(min/4,arg=2,X1)))))
         ;  throw(gecode_argument_error(min/4,arg=1,X0))).
         ...
         -> (is_SetVar(X1,Y1)
             -> (is_int(X2,Y2)
                 -> (is_int(X3,Y3)
                     ...
                     ;  throw(gecode_argument_error(cardinality/4,arg=4,X3)))
                 ;  throw(gecode_argument_error(cardinality/4,arg=3,X2)))
             ;  throw(gecode_argument_error(cardinality/4,arg=2,X1)))
         ;  throw(gecode_argument_error(cardinality/4,arg=1,X0))).
             ...
             -> (is_IntVarArgs(X2,Y2)
                 -> (is_IntConLevel(X3,Y3)
                     ...
                     ;  (is_IntArgs(X3,Y3)
                         ...
                         ;  throw(gecode_argument_error(count/4,arg=4,X3))))
                 ;  (is_IntSet(X2,Y2)
                     -> (is_IntArgs(X3,Y3)
                     ...
                     ;  (is_IntSetArgs(X2,Y2)
                         -> (is_IntConLevel(X3,Y3)
                             ...
                             ;  (is_IntArgs(X3,Y3)
                                 ...
                                 ;  throw(gecode_argument_error(count/4,arg=4,X3))))
                         ;  throw(gecode_argument_error(count/4,arg=3,X2)))))
             ;  throw(gecode_argument_error(count/4,arg=2,X1)))
         ;  throw(gecode_argument_error(count/4,arg=1,X0))).
        ...
        (is_Space_or_Clause(X0,Y0)
         -> (is_IntVar(X1,Y1)
             -> (is_IntVar(X2,Y2)
                 ...
                 ;  throw(gecode_argument_error(sqrt/3,arg=3,X2)))
             ;  throw(gecode_argument_error(sqrt/3,arg=2,X1)))
         ;  throw(gecode_argument_error(sqrt/3,arg=1,X0))).
                             ...
                             -> (is_IntArgs(X6,Y6)
                                 -> (is_bool(X7,Y7)
                                     -> (is_IntConLevel(X8,Y8)
                                         ...
                                         ;  throw(gecode_argument_error(cumulatives/9,arg=9,X8)))
                                     ;  throw(gecode_argument_error(cumulatives/9,arg=8,X7)))
                                 ;  throw(gecode_argument_error(cumulatives/9,arg=7,X6)))
                             ;  (is_IntArgs(X5,Y5)
                                 -> (is_IntArgs(X6,Y6)
                                     -> (is_bool(X7,Y7)
                                         -> (is_IntConLevel(X8,Y8)
                                         ...
                                         ;  throw(gecode_argument_error(cumulatives/9,arg=8,X7)))
                                     ;  throw(gecode_argument_error(cumulatives/9,arg=7,X6)))
                                 ;  throw(gecode_argument_error(cumulatives/9,arg=6,X5))))
                         ;  throw(gecode_argument_error(cumulatives/9,arg=5,X4)))
                     ;  (is_IntArgs(X3,Y3)
                         -> (is_IntVarArgs(X4,Y4)
                             -> (is_IntVarArgs(X5,Y5)
                                 -> (is_IntArgs(X6,Y6)
                                 ...
                                 ;  (is_IntArgs(X5,Y5)
                                     ...
                                     ;  throw(gecode_argument_error(cumulatives/9,arg=6,X5))))
                             ;  throw(gecode_argument_error(cumulatives/9,arg=5,X4)))
                         ;  throw(gecode_argument_error(cumulatives/9,arg=4,X3))))
                 ;  throw(gecode_argument_error(cumulatives/9,arg=3,X2)))
             ;  (is_IntArgs(X1,Y1)
                 -> (is_IntVarArgs(X2,Y2)
                     -> (is_IntVarArgs(X3,Y3)
                         -> (is_IntVarArgs(X4,Y4)
                         ...
                         ;  (is_IntArgs(X3,Y3)
                             ...
                             ;  throw(gecode_argument_error(cumulatives/9,arg=4,X3))))
                     ;  throw(gecode_argument_error(cumulatives/9,arg=3,X2)))
                 ;  throw(gecode_argument_error(cumulatives/9,arg=2,X1))))
         ;  throw(gecode_argument_error(cumulatives/9,arg=1,X0))).
             ...
             -> (is_IntRelType(X2,Y2)
                 -> (is_int(X3,Y3)
                     ...
                     ;  (is_IntVar(X3,Y3)
                         ...
                         ;  throw(gecode_argument_error(nvalues/4,arg=4,X3))))
                 ;  throw(gecode_argument_error(nvalues/4,arg=3,X2)))
             ;  (is_BoolVarArgs(X1,Y1)
                 -> (is_IntRelType(X2,Y2)
                     -> (is_int(X3,Y3)
                         ...
                         ;  (is_IntVar(X3,Y3)
                             ...
                             ;  throw(gecode_argument_error(nvalues/4,arg=4,X3))))
                     ;  throw(gecode_argument_error(nvalues/4,arg=3,X2)))
                 ;  throw(gecode_argument_error(nvalues/4,arg=2,X1))))
         ;  throw(gecode_argument_error(nvalues/4,arg=1,X0))).
         ...
         -> (is_IntVarArgs(X1,Y1)
             -> (is_IntVarArgs(X2,Y2)
                 -> (is_IntArgs(X3,Y3)
                     ...
                     ;  throw(gecode_argument_error(binpacking/4,arg=4,X3)))
                 ;  throw(gecode_argument_error(binpacking/4,arg=3,X2)))
             ;  throw(gecode_argument_error(binpacking/4,arg=2,X1)))
         ;  throw(gecode_argument_error(binpacking/4,arg=1,X0))).
                     ...
                     -> (is_int(X4,Y4)
                         -> (is_BoolVar(X5,Y5)
                             -> (is_IntConLevel(X6,Y6)
                                 ...
                                 ;  throw(gecode_argument_error(linear/7,arg=7,X6)))
                             ;  throw(gecode_argument_error(linear/7,arg=6,X5)))
                         ;  (is_IntVar(X4,Y4)
                             -> (is_BoolVar(X5,Y5)
                                 -> (is_IntConLevel(X6,Y6)
                                     ...
                                     ;  throw(gecode_argument_error(linear/7,arg=7,X6)))
                                 ;  throw(gecode_argument_error(linear/7,arg=6,X5)))
                             ;  throw(gecode_argument_error(linear/7,arg=5,X4))))
                     ;  throw(gecode_argument_error(linear/7,arg=4,X3)))
                 ;  (is_BoolVarArgs(X2,Y2)
                     -> (is_IntRelType(X3,Y3)
                         -> (is_int(X4,Y4)
                             -> (is_BoolVar(X5,Y5)
                             ...
                             ;  (is_IntVar(X4,Y4)
                                 ...
                                 ;  throw(gecode_argument_error(linear/7,arg=5,X4))))
                         ;  throw(gecode_argument_error(linear/7,arg=4,X3)))
                     ;  throw(gecode_argument_error(linear/7,arg=3,X2))))
             ;  throw(gecode_argument_error(linear/7,arg=2,X1)))
         ;  throw(gecode_argument_error(linear/7,arg=1,X0))).
         ...
         -> (is_IntVar(X1,Y1)
             -> (is_IntVar(X2,Y2)
                 -> (is_IntConLevel(X3,Y3)
                     ...
                     ;  throw(gecode_argument_error(abs/4,arg=4,X3)))
                 ;  throw(gecode_argument_error(abs/4,arg=3,X2)))
             ;  throw(gecode_argument_error(abs/4,arg=2,X1)))
         ;  throw(gecode_argument_error(abs/4,arg=1,X0))).

convex(X0,X1) :-
        (is_Space_or_Clause(X0,Y0)
         -> (is_SetVar(X1,Y1)
             -> gecode_constraint_convex_50(Y0,Y1)
             ;  throw(gecode_argument_error(convex/2,arg=2,X1)))
         ;  throw(gecode_argument_error(convex/2,arg=1,X0))).
         ...
         -> (is_IntVar(X1,Y1)
             -> (is_IntVar(X2,Y2)
                 -> (is_IntVar(X3,Y3)
                     ...
                     ;  throw(gecode_argument_error(div/4,arg=4,X3)))
                 ;  throw(gecode_argument_error(div/4,arg=3,X2)))
             ;  throw(gecode_argument_error(div/4,arg=2,X1)))
         ;  throw(gecode_argument_error(div/4,arg=1,X0))).
                 ...
                 -> (is_int(X3,Y3)
                     -> (is_BoolVar(X4,Y4)
                         -> (is_IntConLevel(X5,Y5)
                             ...
                             ;  throw(gecode_argument_error(rel/6,arg=6,X5)))
                         ;  throw(gecode_argument_error(rel/6,arg=5,X4)))
                     ;  (is_IntVar(X3,Y3)
                         -> (is_BoolVar(X4,Y4)
                             -> (is_IntConLevel(X5,Y5)
                                 ...
                                 ;  throw(gecode_argument_error(rel/6,arg=6,X5)))
                             ;  throw(gecode_argument_error(rel/6,arg=5,X4)))
                         ;  throw(gecode_argument_error(rel/6,arg=4,X3))))
                 ;  throw(gecode_argument_error(rel/6,arg=3,X2)))
             ;  (is_IntSet(X1,Y1)
                 -> (is_SetOpType(X2,Y2)
                     -> (is_SetVar(X3,Y3)
                         -> (is_SetRelType(X4,Y4)
                         ...
                         -> (is_SetOpType(X2,Y2)
                             -> (is_IntSet(X3,Y3)
                                 ...
                                 ;  (is_SetVar(X3,Y3)
                                     ...
                                     ;  throw(gecode_argument_error(rel/6,arg=4,X3))))
                             ;  throw(gecode_argument_error(rel/6,arg=3,X2)))
                         ;  throw(gecode_argument_error(rel/6,arg=2,X1))))))
         ;  throw(gecode_argument_error(rel/6,arg=1,X0))).
             ...
             -> (is_IntArgs(X2,Y2)
                 -> (is_SetVar(X3,Y3)
                     -> (is_IntVar(X4,Y4)
                         ...
                         ;  throw(gecode_argument_error(weights/5,arg=5,X4)))
                     ;  throw(gecode_argument_error(weights/5,arg=4,X3)))
                 ;  throw(gecode_argument_error(weights/5,arg=3,X2)))
             ;  throw(gecode_argument_error(weights/5,arg=2,X1)))
         ;  throw(gecode_argument_error(weights/5,arg=1,X0))).
             ...
             -> (is_IntVar(X2,Y2)
                 -> (is_IntVar(X3,Y3)
                     -> (is_IntConLevel(X4,Y4)
                         ...
                         ;  throw(gecode_argument_error(max/5,arg=5,X4)))
                     ;  throw(gecode_argument_error(max/5,arg=4,X3)))
                 ;  throw(gecode_argument_error(max/5,arg=3,X2)))
             ;  throw(gecode_argument_error(max/5,arg=2,X1)))
         ;  throw(gecode_argument_error(max/5,arg=1,X0))).
                             ...
                             -> (is_IntVarArgs(X6,Y6)
                                 -> (is_IntVar(X7,Y7)
                                     -> (is_IntConLevel(X8,Y8)
                                         ...
                                         ;  throw(gecode_argument_error(path/9,arg=9,X8)))
                                     ;  throw(gecode_argument_error(path/9,arg=8,X7)))
                                 ;  throw(gecode_argument_error(path/9,arg=7,X6)))
                             ;  throw(gecode_argument_error(path/9,arg=6,X5)))
                         ;  throw(gecode_argument_error(path/9,arg=5,X4)))
                     ;  throw(gecode_argument_error(path/9,arg=4,X3)))
                 ;  throw(gecode_argument_error(path/9,arg=3,X2)))
             ;  throw(gecode_argument_error(path/9,arg=2,X1)))
         ;  throw(gecode_argument_error(path/9,arg=1,X0))).
         ...
         -> (is_TaskTypeArgs(X1,Y1)
             -> (is_IntVarArgs(X2,Y2)
                 -> (is_IntArgs(X3,Y3)
                     ...
                     ;  throw(gecode_argument_error(unary/4,arg=4,X3)))
                 ;  throw(gecode_argument_error(unary/4,arg=3,X2)))
             ;  (is_IntVarArgs(X1,Y1)
                 -> (is_IntVarArgs(X2,Y2)
                     -> (is_IntVarArgs(X3,Y3)
                     ...
                     ;  (is_IntArgs(X2,Y2)
                         -> (is_BoolVarArgs(X3,Y3)
                             ...
                             ;  (is_IntConLevel(X3,Y3)
                                 ...
                                 ;  throw(gecode_argument_error(unary/4,arg=4,X3))))
                         ;  throw(gecode_argument_error(unary/4,arg=3,X2))))
                 ;  throw(gecode_argument_error(unary/4,arg=2,X1))))
         ;  throw(gecode_argument_error(unary/4,arg=1,X0))).
             ...
             -> (is_IntVarArgs(X2,Y2)
                 -> (is_IntVarArgs(X3,Y3)
                     -> (is_IntConLevel(X4,Y4)
                         ...
                         ;  throw(gecode_argument_error(sorted/5,arg=5,X4)))
                     ;  throw(gecode_argument_error(sorted/5,arg=4,X3)))
                 ;  throw(gecode_argument_error(sorted/5,arg=3,X2)))
             ;  throw(gecode_argument_error(sorted/5,arg=2,X1)))
         ;  throw(gecode_argument_error(sorted/5,arg=1,X0))).
             ...
             -> (is_int(X2,Y2)
                 -> (is_IntVarArgs(X3,Y3)
                     -> (is_IntVar(X4,Y4)
                         ...
                         ;  throw(gecode_argument_error(circuit/5,arg=5,X4)))
                     ;  throw(gecode_argument_error(circuit/5,arg=4,X3)))
                 ;  (is_IntVarArgs(X2,Y2)
                     -> (is_IntVar(X3,Y3)
                         -> (is_IntConLevel(X4,Y4)
                         ...
                         ;  (is_IntVarArgs(X3,Y3)
                             -> (is_IntVar(X4,Y4)
                                 ...
                                 ;  throw(gecode_argument_error(circuit/5,arg=5,X4)))
                             ;  throw(gecode_argument_error(circuit/5,arg=4,X3))))
                     ;  throw(gecode_argument_error(circuit/5,arg=3,X2))))
             ;  throw(gecode_argument_error(circuit/5,arg=2,X1)))
         ;  throw(gecode_argument_error(circuit/5,arg=1,X0))).
                 ...
                 -> (is_int(X3,Y3)
                     ...
                     ;  (is_BoolVar(X3,Y3)
                         ...
                         ;  (is_IntConLevel(X3,Y3)
                             ...
                             ;  throw(gecode_argument_error(dom/4,arg=4,X3)))))
                 ;  (is_IntSet(X2,Y2)
                     -> (is_BoolVar(X3,Y3)
                         ...
                         ;  (is_IntConLevel(X3,Y3)
                             ...
                             ;  throw(gecode_argument_error(dom/4,arg=4,X3))))
                     ;  throw(gecode_argument_error(dom/4,arg=3,X2))))
             ;  (is_IntVarArgs(X1,Y1)
                 -> (is_int(X2,Y2)
                     -> (is_int(X3,Y3)
                     ...
                     -> (is_SetRelType(X2,Y2)
                         -> (is_int(X3,Y3)
                             ...
                             ;  (is_IntSet(X3,Y3)
                                 ...
                                 ;  throw(gecode_argument_error(dom/4,arg=4,X3))))
                         ;  throw(gecode_argument_error(dom/4,arg=3,X2)))
                     ;  throw(gecode_argument_error(dom/4,arg=2,X1)))))
         ;  throw(gecode_argument_error(dom/4,arg=1,X0))).
        ...
        (is_Space_or_Clause(X0,Y0)
         -> (is_IntVar(X1,Y1)
             -> (is_IntVar(X2,Y2)
                 ...
                 ;  throw(gecode_argument_error(abs/3,arg=3,X2)))
             ;  throw(gecode_argument_error(abs/3,arg=2,X1)))
         ;  throw(gecode_argument_error(abs/3,arg=1,X0))).
             ...
             -> (is_int(X2,Y2)
                 -> (is_IntVarArgs(X3,Y3)
                     -> (is_int(X4,Y4)
                         ...
                         ;  throw(gecode_argument_error(channel/5,arg=5,X4)))
                     ;  throw(gecode_argument_error(channel/5,arg=4,X3)))
                 ;  throw(gecode_argument_error(channel/5,arg=3,X2)))
             ;  (is_BoolVarArgs(X1,Y1)
                 -> (is_IntVar(X2,Y2)
                     -> (is_int(X3,Y3)
                         -> (is_IntConLevel(X4,Y4)
                         ...
                         ;  throw(gecode_argument_error(channel/5,arg=4,X3)))
                     ;  throw(gecode_argument_error(channel/5,arg=3,X2)))
                 ;  throw(gecode_argument_error(channel/5,arg=2,X1))))
         ;  throw(gecode_argument_error(channel/5,arg=1,X0))).
        ...
        (is_Space_or_Clause(X0,Y0)
         -> (is_IntVarArgs(X1,Y1)
             -> (is_IntRelType(X2,Y2)
                 ...
                 ;  throw(gecode_argument_error(rel/3,arg=3,X2)))
             ;  (is_BoolVarArgs(X1,Y1)
                 -> (is_IntRelType(X2,Y2)
                     -> gecode_constraint_rel_296(Y0,Y1,Y2)
                     ;  throw(gecode_argument_error(rel/3,arg=3,X2)))
                 ;  throw(gecode_argument_error(rel/3,arg=2,X1))))
         ;  throw(gecode_argument_error(rel/3,arg=1,X0))).
         ...
         -> (is_IntVarArgs(X1,Y1)
             -> (is_IntVar(X2,Y2)
                 -> (is_IntVar(X3,Y3)
                     ...
                     ;  throw(gecode_argument_error(path/4,arg=4,X3)))
                 ;  throw(gecode_argument_error(path/4,arg=3,X2)))
             ;  throw(gecode_argument_error(path/4,arg=2,X1)))
         ;  throw(gecode_argument_error(path/4,arg=1,X0))).
         ...
         -> (is_IntVarArgs(X1,Y1)
             -> (is_IntVarBranch(X2,Y2)
                 -> (is_IntValBranch(X3,Y3)
                     ...
                     ;  throw(gecode_argument_error(branch/4,arg=4,X3)))
                 ;  throw(gecode_argument_error(branch/4,arg=3,X2)))
             ;  (is_BoolVarArgs(X1,Y1)
                 -> (is_IntVarBranch(X2,Y2)
                     -> (is_IntValBranch(X3,Y3)
                 ...
                 ;  (is_SetVarArgs(X1,Y1)
                     -> (is_SetVarBranch(X2,Y2)
                         -> (is_SetValBranch(X3,Y3)
                             ...
                             ;  throw(gecode_argument_error(branch/4,arg=4,X3)))
                         ;  throw(gecode_argument_error(branch/4,arg=3,X2)))
                     ;  throw(gecode_argument_error(branch/4,arg=2,X1)))))
         ;  throw(gecode_argument_error(branch/4,arg=1,X0))).
             ...
             -> (is_IntVar(X2,Y2)
                 -> (is_IntVar(X3,Y3)
                     -> (is_IntConLevel(X4,Y4)
                         ...
                         ;  throw(gecode_argument_error(mult/5,arg=5,X4)))
                     ;  throw(gecode_argument_error(mult/5,arg=4,X3)))
                 ;  throw(gecode_argument_error(mult/5,arg=3,X2)))
             ;  throw(gecode_argument_error(mult/5,arg=2,X1)))
         ;  throw(gecode_argument_error(mult/5,arg=1,X0))).
                 ...
                 -> (is_IntVarArgs(X3,Y3)
                     -> (is_IntVar(X4,Y4)
                         -> (is_IntConLevel(X5,Y5)
                             ...
                             ;  throw(gecode_argument_error(circuit/6,arg=6,X5)))
                         ;  (is_IntVarArgs(X4,Y4)
                             -> (is_IntVar(X5,Y5)
                                 -> gecode_constraint_circuit_38(Y0,Y1,Y2,Y3,Y4,Y5)
                                 ;  throw(gecode_argument_error(circuit/6,arg=6,X5)))
                             ;  throw(gecode_argument_error(circuit/6,arg=5,X4))))
                     ;  throw(gecode_argument_error(circuit/6,arg=4,X3)))
                 ;  (is_IntVarArgs(X2,Y2)
                     -> (is_IntVarArgs(X3,Y3)
                         -> (is_IntVar(X4,Y4)
                             -> (is_IntConLevel(X5,Y5)
                             ...
                             ;  throw(gecode_argument_error(circuit/6,arg=5,X4)))
                         ;  throw(gecode_argument_error(circuit/6,arg=4,X3)))
                     ;  throw(gecode_argument_error(circuit/6,arg=3,X2))))
             ;  throw(gecode_argument_error(circuit/6,arg=2,X1)))
         ;  throw(gecode_argument_error(circuit/6,arg=1,X0))).
                 ...
                 -> (is_BoolVarArgs(X3,Y3)
                     -> (is_int(X4,Y4)
                         ...
                         ;  (is_BoolVar(X4,Y4)
                             ...
                             ;  throw(gecode_argument_error(clause/5,arg=5,X4))))
                     ;  throw(gecode_argument_error(clause/5,arg=4,X3)))
                 ;  throw(gecode_argument_error(clause/5,arg=3,X2)))
             ;  throw(gecode_argument_error(clause/5,arg=2,X1)))
         ;  throw(gecode_argument_error(clause/5,arg=1,X0))).
         ...
         -> (is_SetVarArgs(X1,Y1)
             -> (is_int(X2,Y2)
                 -> (is_int(X3,Y3)
                     ...
                     ;  throw(gecode_argument_error(precede/4,arg=4,X3)))
                 ;  throw(gecode_argument_error(precede/4,arg=3,X2)))
             ;  (is_IntVarArgs(X1,Y1)
                 -> (is_int(X2,Y2)
                     -> (is_int(X3,Y3)
                     ...
                     ;  (is_IntArgs(X2,Y2)
                         -> (is_IntConLevel(X3,Y3)
                             ...
                             ;  throw(gecode_argument_error(precede/4,arg=4,X3)))
                         ;  throw(gecode_argument_error(precede/4,arg=3,X2))))
                 ;  throw(gecode_argument_error(precede/4,arg=2,X1))))
         ;  throw(gecode_argument_error(precede/4,arg=1,X0))).
                 ...
                 -> (is_IntVarArgs(X3,Y3)
                     -> (is_int(X4,Y4)
                         -> (is_IntConLevel(X5,Y5)
                             ...
                             ;  throw(gecode_argument_error(channel/6,arg=6,X5)))
                         ;  throw(gecode_argument_error(channel/6,arg=5,X4)))
                     ;  throw(gecode_argument_error(channel/6,arg=4,X3)))
                 ;  throw(gecode_argument_error(channel/6,arg=3,X2)))
             ;  throw(gecode_argument_error(channel/6,arg=2,X1)))
         ;  throw(gecode_argument_error(channel/6,arg=1,X0))).
                         ...
                         -> (is_IntArgs(X5,Y5)
                             -> (is_BoolVarArgs(X6,Y6)
                                 ...
                                 ;  (is_IntConLevel(X6,Y6)
                                     ...
                                     ;  throw(gecode_argument_error(cumulative/7,arg=7,X6))))
                             ;  throw(gecode_argument_error(cumulative/7,arg=6,X5)))
                         ;  throw(gecode_argument_error(cumulative/7,arg=5,X4)))
                     ;  throw(gecode_argument_error(cumulative/7,arg=4,X3)))
                 ;  (is_IntVarArgs(X2,Y2)
                     -> (is_IntVarArgs(X3,Y3)
                         -> (is_IntVarArgs(X4,Y4)
                             -> (is_IntArgs(X5,Y5)
                         ...
                         ;  (is_IntArgs(X3,Y3)
                             -> (is_IntArgs(X4,Y4)
                                 ...
                                 ;  throw(gecode_argument_error(cumulative/7,arg=5,X4)))
                             ;  throw(gecode_argument_error(cumulative/7,arg=4,X3))))
                     ;  throw(gecode_argument_error(cumulative/7,arg=3,X2))))
             ;  (is_IntVar(X1,Y1)
                 -> (is_TaskTypeArgs(X2,Y2)
                     -> (is_IntVarArgs(X3,Y3)
                         -> (is_IntArgs(X4,Y4)
                     ...
                     ;  (is_IntVarArgs(X2,Y2)
                         -> (is_IntVarArgs(X3,Y3)
                             ...
                             ;  (is_IntArgs(X3,Y3)
                                 ...
                                 ;  throw(gecode_argument_error(cumulative/7,arg=4,X3))))
                         ;  throw(gecode_argument_error(cumulative/7,arg=3,X2))))
                 ;  throw(gecode_argument_error(cumulative/7,arg=2,X1))))
         ;  throw(gecode_argument_error(cumulative/7,arg=1,X0))).
        ...
        (is_Space_or_Clause(X0,Y0)
         -> (is_IntVarArgs(X1,Y1)
             -> (is_IntConLevel(X2,Y2)
                 ...
                 ;  throw(gecode_argument_error(distinct/3,arg=3,X2)))
             ;  (is_IntArgs(X1,Y1)
                 -> (is_IntVarArgs(X2,Y2)
                     -> gecode_constraint_distinct_118(Y0,Y1,Y2)
                     ;  throw(gecode_argument_error(distinct/3,arg=3,X2)))
                 ;  throw(gecode_argument_error(distinct/3,arg=2,X1))))
         ;  throw(gecode_argument_error(distinct/3,arg=1,X0))).
             ...
             -> (is_IntVar(X2,Y2)
                 -> (is_BoolVar(X3,Y3)
                     -> (is_IntConLevel(X4,Y4)
                         ...
                         ;  throw(gecode_argument_error(member/5,arg=5,X4)))
                     ;  throw(gecode_argument_error(member/5,arg=4,X3)))
                 ;  throw(gecode_argument_error(member/5,arg=3,X2)))
             ;  (is_BoolVarArgs(X1,Y1)
                 -> (is_BoolVar(X2,Y2)
                     -> (is_BoolVar(X3,Y3)
                         -> (is_IntConLevel(X4,Y4)
                         ...
                         ;  throw(gecode_argument_error(member/5,arg=4,X3)))
                     ;  throw(gecode_argument_error(member/5,arg=3,X2)))
                 ;  throw(gecode_argument_error(member/5,arg=2,X1))))
         ;  throw(gecode_argument_error(member/5,arg=1,X0))).
         ...
         -> (is_IntVar(X1,Y1)
             -> (is_IntVar(X2,Y2)
                 -> (is_IntVar(X3,Y3)
                     ...
                     ;  throw(gecode_argument_error(mod/4,arg=4,X3)))
                 ;  throw(gecode_argument_error(mod/4,arg=3,X2)))
             ;  throw(gecode_argument_error(mod/4,arg=2,X1)))
         ;  throw(gecode_argument_error(mod/4,arg=1,X0))).
        ...
        (is_Space_or_Clause(X0,Y0)
         -> (is_IntVar(X1,Y1)
             -> (is_IntVar(X2,Y2)
                 ...
                 ;  throw(gecode_argument_error(sqr/3,arg=3,X2)))
             ;  throw(gecode_argument_error(sqr/3,arg=2,X1)))
         ;  throw(gecode_argument_error(sqr/3,arg=1,X0))).
                     ...
                     -> (is_int(X4,Y4)
                         -> (is_int(X5,Y5)
                             -> (is_IntConLevel(X6,Y6)
                                 ...
                                 ;  throw(gecode_argument_error(sequence/7,arg=7,X6)))
                             ;  throw(gecode_argument_error(sequence/7,arg=6,X5)))
                         ;  throw(gecode_argument_error(sequence/7,arg=5,X4)))
                     ;  throw(gecode_argument_error(sequence/7,arg=4,X3)))
                 ;  throw(gecode_argument_error(sequence/7,arg=3,X2)))
             ;  (is_BoolVarArgs(X1,Y1)
                 -> (is_IntSet(X2,Y2)
                     -> (is_int(X3,Y3)
                         -> (is_int(X4,Y4)
                         ...
                         ;  throw(gecode_argument_error(sequence/7,arg=4,X3)))
                     ;  throw(gecode_argument_error(sequence/7,arg=3,X2)))
                 ;  throw(gecode_argument_error(sequence/7,arg=2,X1))))
         ;  throw(gecode_argument_error(sequence/7,arg=1,X0))).
                     ...
                     -> (is_IntVar(X4,Y4)
                         -> (is_IntVar(X5,Y5)
                             -> (is_IntVar(X6,Y6)
                                 ...
                                 ;  throw(gecode_argument_error(path/7,arg=7,X6)))
                             ;  throw(gecode_argument_error(path/7,arg=6,X5)))
                         ;  throw(gecode_argument_error(path/7,arg=5,X4)))
                     ;  throw(gecode_argument_error(path/7,arg=4,X3)))
                 ;  (is_IntVarArgs(X2,Y2)
                     -> (is_IntVar(X3,Y3)
                         -> (is_IntVar(X4,Y4)
                             -> (is_IntVar(X5,Y5)
                             ...
                             ;  throw(gecode_argument_error(path/7,arg=5,X4)))
                         ;  throw(gecode_argument_error(path/7,arg=4,X3)))
                     ;  throw(gecode_argument_error(path/7,arg=3,X2))))
             ;  throw(gecode_argument_error(path/7,arg=2,X1)))
         ;  throw(gecode_argument_error(path/7,arg=1,X0))).
                 ...
                 -> (is_IntVar(X3,Y3)
                     -> (is_IntVar(X4,Y4)
                         -> (is_IntConLevel(X5,Y5)
                             ...
                             ;  throw(gecode_argument_error(divmod/6,arg=6,X5)))
                         ;  throw(gecode_argument_error(divmod/6,arg=5,X4)))
                     ;  throw(gecode_argument_error(divmod/6,arg=4,X3)))
                 ;  throw(gecode_argument_error(divmod/6,arg=3,X2)))
             ;  throw(gecode_argument_error(divmod/6,arg=2,X1)))
         ;  throw(gecode_argument_error(divmod/6,arg=1,X0))).
        ...
        (is_Space_or_Clause(X0,Y0)
         -> (is_IntVarArgs(X1,Y1)
             -> (is_IntVarArgs(X2,Y2)
                 ...
                 ;  throw(gecode_argument_error(sorted/3,arg=3,X2)))
             ;  throw(gecode_argument_error(sorted/3,arg=2,X1)))
         ;  throw(gecode_argument_error(sorted/3,arg=1,X0))).
        ...
        (is_Space_or_Clause(X0,Y0)
         -> (is_int(X1,Y1)
             -> (is_IntVarArgs(X2,Y2)
                 ...
                 ;  throw(gecode_argument_error(circuit/3,arg=3,X2)))
             ;  (is_IntVarArgs(X1,Y1)
                 -> (is_IntConLevel(X2,Y2)
                     -> gecode_constraint_circuit_43(Y0,Y1,Y2)
                     ;  throw(gecode_argument_error(circuit/3,arg=3,X2)))
                 ;  throw(gecode_argument_error(circuit/3,arg=2,X1))))
         ;  throw(gecode_argument_error(circuit/3,arg=1,X0))).
        ...
        (is_Space_or_Clause(X0,Y0)
         -> (is_IntVar(X1,Y1)
             -> (is_BoolVar(X2,Y2)
                 ...
                 ;  throw(gecode_argument_error(channel/3,arg=3,X2)))
             ;  (is_IntVarArgs(X1,Y1)
                 -> (is_SetVarArgs(X2,Y2)
                 ...
                 ;  (is_BoolVarArgs(X1,Y1)
                     ...
                     ;  (is_BoolVar(X1,Y1)
                         -> (is_IntVar(X2,Y2)
                             ...
                             ;  throw(gecode_argument_error(channel/3,arg=3,X2)))
                         ;  throw(gecode_argument_error(channel/3,arg=2,X1))))))
         ;  throw(gecode_argument_error(channel/3,arg=1,X0))).
                 ...
                 -> (is_IntRelType(X3,Y3)
                     -> (is_int(X4,Y4)
                         ...
                         ;  (is_IntVar(X4,Y4)
                             ...
                             ;  throw(gecode_argument_error(count/5,arg=5,X4))))
                     ;  throw(gecode_argument_error(count/5,arg=4,X3)))
                 ;  (is_int(X2,Y2)
                     -> (is_IntRelType(X3,Y3)
                         -> (is_int(X4,Y4)
                                     ...
                                     -> (is_IntRelType(X3,Y3)
                                         -> (is_int(X4,Y4)
                                             ...
                                             ;  (is_IntVar(X4,Y4)
                                                 ...
                                                 ;  throw(gecode_argument_error(count/5,arg=5,X4))))
                                         ;  throw(gecode_argument_error(count/5,arg=4,X3)))
                                     ;  throw(gecode_argument_error(count/5,arg=3,X2))))))))
             ;  throw(gecode_argument_error(count/5,arg=2,X1)))
         ;  throw(gecode_argument_error(count/5,arg=1,X0))).
                         ...
                         -> (is_IntVarArgs(X5,Y5)
                             -> (is_IntArgs(X6,Y6)
                                 -> (is_bool(X7,Y7)
                                     ...
                                     ;  throw(gecode_argument_error(cumulatives/8,arg=8,X7)))
                                 ;  throw(gecode_argument_error(cumulatives/8,arg=7,X6)))
                             ;  (is_IntArgs(X5,Y5)
                                 -> (is_IntArgs(X6,Y6)
                                     -> (is_bool(X7,Y7)
                                         ...
                                         ;  throw(gecode_argument_error(cumulatives/8,arg=8,X7)))
                                     ;  throw(gecode_argument_error(cumulatives/8,arg=7,X6)))
                                 ;  throw(gecode_argument_error(cumulatives/8,arg=6,X5))))
                         ;  throw(gecode_argument_error(cumulatives/8,arg=5,X4)))
                     ;  (is_IntArgs(X3,Y3)
                         -> (is_IntVarArgs(X4,Y4)
                             -> (is_IntVarArgs(X5,Y5)
                                 -> (is_IntArgs(X6,Y6)
                                 ...
                                 ;  (is_IntArgs(X5,Y5)
                                     ...
                                     ;  throw(gecode_argument_error(cumulatives/8,arg=6,X5))))
                             ;  throw(gecode_argument_error(cumulatives/8,arg=5,X4)))
                         ;  throw(gecode_argument_error(cumulatives/8,arg=4,X3))))
                 ;  throw(gecode_argument_error(cumulatives/8,arg=3,X2)))
             ;  (is_IntArgs(X1,Y1)
                 -> (is_IntVarArgs(X2,Y2)
                     -> (is_IntVarArgs(X3,Y3)
                         -> (is_IntVarArgs(X4,Y4)
                         ...
                         ;  (is_IntArgs(X3,Y3)
                             ...
                             ;  throw(gecode_argument_error(cumulatives/8,arg=4,X3))))
                     ;  throw(gecode_argument_error(cumulatives/8,arg=3,X2)))
                 ;  throw(gecode_argument_error(cumulatives/8,arg=2,X1))))
         ;  throw(gecode_argument_error(cumulatives/8,arg=1,X0))).
             ...
             -> (is_IntVarArgs(X2,Y2)
                 -> (is_IntArgs(X3,Y3)
                     -> (is_IntConLevel(X4,Y4)
                         ...
                         ;  throw(gecode_argument_error(binpacking/5,arg=5,X4)))
                     ;  throw(gecode_argument_error(binpacking/5,arg=4,X3)))
                 ;  throw(gecode_argument_error(binpacking/5,arg=3,X2)))
             ;  throw(gecode_argument_error(binpacking/5,arg=2,X1)))
         ;  throw(gecode_argument_error(binpacking/5,arg=1,X0))).
                 ...
                 -> (is_int(X3,Y3)
                     -> (is_BoolVar(X4,Y4)
                         -> (is_IntConLevel(X5,Y5)
                             ...
                             ;  throw(gecode_argument_error(linear/6,arg=6,X5)))
                         ;  throw(gecode_argument_error(linear/6,arg=5,X4)))
                     ;  (is_IntVar(X3,Y3)
                         -> (is_BoolVar(X4,Y4)
                             -> (is_IntConLevel(X5,Y5)
                                 ...
                                 ;  throw(gecode_argument_error(linear/6,arg=6,X5)))
                             ;  throw(gecode_argument_error(linear/6,arg=5,X4)))
                         ;  throw(gecode_argument_error(linear/6,arg=4,X3))))
                 ;  throw(gecode_argument_error(linear/6,arg=3,X2)))
             ;  (is_BoolVarArgs(X1,Y1)
                 -> (is_IntRelType(X2,Y2)
                     -> (is_int(X3,Y3)
                         -> (is_BoolVar(X4,Y4)
                     ...
                     -> (is_IntVarArgs(X2,Y2)
                         ...
                         ;  (is_BoolVarArgs(X2,Y2)
                             -> (is_IntRelType(X3,Y3)
                                 ...
                                 ;  throw(gecode_argument_error(linear/6,arg=4,X3)))
                             ;  throw(gecode_argument_error(linear/6,arg=3,X2))))
                     ;  throw(gecode_argument_error(linear/6,arg=2,X1)))))
         ;  throw(gecode_argument_error(linear/6,arg=1,X0))).
                     ...
                     -> (is_IntVarArgs(X4,Y4)
                         -> (is_IntVarArgs(X5,Y5)
                             -> (is_IntVarArgs(X6,Y6)
                                 ...
                                 ;  throw(gecode_argument_error(nooverlap/7,arg=7,X6)))
                             ;  throw(gecode_argument_error(nooverlap/7,arg=6,X5)))
                         ;  throw(gecode_argument_error(nooverlap/7,arg=5,X4)))
                     ;  throw(gecode_argument_error(nooverlap/7,arg=4,X3)))
                 ;  (is_IntArgs(X2,Y2)
                     -> (is_IntVarArgs(X3,Y3)
                         -> (is_IntArgs(X4,Y4)
                             -> (is_BoolVarArgs(X5,Y5)
                             ...
                             ;  throw(gecode_argument_error(nooverlap/7,arg=5,X4)))
                         ;  throw(gecode_argument_error(nooverlap/7,arg=4,X3)))
                     ;  throw(gecode_argument_error(nooverlap/7,arg=3,X2))))
             ;  throw(gecode_argument_error(nooverlap/7,arg=2,X1)))
         ;  throw(gecode_argument_error(nooverlap/7,arg=1,X0))).
             ...
             -> (is_IntVar(X2,Y2)
                 -> (is_IntVar(X3,Y3)
                     -> (is_IntConLevel(X4,Y4)
                         ...
                         ;  throw(gecode_argument_error(div/5,arg=5,X4)))
                     ;  throw(gecode_argument_error(div/5,arg=4,X3)))
                 ;  throw(gecode_argument_error(div/5,arg=3,X2)))
             ;  throw(gecode_argument_error(div/5,arg=2,X1)))
         ;  throw(gecode_argument_error(div/5,arg=1,X0))).
         ...
         -> (is_IntVar(X1,Y1)
             -> (is_IntVar(X2,Y2)
                 -> (is_IntConLevel(X3,Y3)
                     ...
                     ;  throw(gecode_argument_error(sqr/4,arg=4,X3)))
                 ;  throw(gecode_argument_error(sqr/4,arg=3,X2)))
             ;  throw(gecode_argument_error(sqr/4,arg=2,X1)))
         ;  throw(gecode_argument_error(sqr/4,arg=1,X0))).
                         ...
                         -> (is_IntVar(X5,Y5)
                             -> (is_IntVar(X6,Y6)
                                 -> (is_IntConLevel(X7,Y7)
                                     ...
                                     ;  throw(gecode_argument_error(path/8,arg=8,X7)))
                                 ;  (is_IntVarArgs(X6,Y6)
                                     -> (is_IntVar(X7,Y7)
                                         -> gecode_constraint_path_262(Y0,Y1,Y2,Y3,Y4,Y5,Y6,Y7)
                                         ;  throw(gecode_argument_error(path/8,arg=8,X7)))
                                     ;  throw(gecode_argument_error(path/8,arg=7,X6))))
                             ;  throw(gecode_argument_error(path/8,arg=6,X5)))
                         ;  throw(gecode_argument_error(path/8,arg=5,X4)))
                     ;  throw(gecode_argument_error(path/8,arg=4,X3)))
                 ;  (is_IntVarArgs(X2,Y2)
                     -> (is_IntVar(X3,Y3)
                         -> (is_IntVar(X4,Y4)
                             -> (is_IntVarArgs(X5,Y5)
                             ...
                             ;  throw(gecode_argument_error(path/8,arg=5,X4)))
                         ;  throw(gecode_argument_error(path/8,arg=4,X3)))
                     ;  throw(gecode_argument_error(path/8,arg=3,X2))))
             ;  throw(gecode_argument_error(path/8,arg=2,X1)))
         ;  throw(gecode_argument_error(path/8,arg=1,X0))).
                 ...
                 -> (is_IntArgs(X3,Y3)
                     -> (is_BoolVarArgs(X4,Y4)
                         ...
                         ;  (is_IntConLevel(X4,Y4)
                             ...
                             ;  throw(gecode_argument_error(unary/5,arg=5,X4))))
                     ;  throw(gecode_argument_error(unary/5,arg=4,X3)))
                 ;  throw(gecode_argument_error(unary/5,arg=3,X2)))
             ;  (is_IntVarArgs(X1,Y1)
                 -> (is_IntVarArgs(X2,Y2)
                     -> (is_IntVarArgs(X3,Y3)
                         -> (is_BoolVarArgs(X4,Y4)
                     ...
                     ;  (is_IntArgs(X2,Y2)
                         -> (is_BoolVarArgs(X3,Y3)
                             ...
                             ;  throw(gecode_argument_error(unary/5,arg=4,X3)))
                         ;  throw(gecode_argument_error(unary/5,arg=3,X2))))
                 ;  throw(gecode_argument_error(unary/5,arg=2,X1))))
         ;  throw(gecode_argument_error(unary/5,arg=1,X0))).
             ...
             -> (is_IntVarArgs(X2,Y2)
                 -> (is_IntVarArgs(X3,Y3)
                     ...
                     ;  (is_IntConLevel(X3,Y3)
                         ...
                         ;  throw(gecode_argument_error(sorted/4,arg=4,X3))))
                 ;  throw(gecode_argument_error(sorted/4,arg=3,X2)))
             ;  throw(gecode_argument_error(sorted/4,arg=2,X1)))
         ;  throw(gecode_argument_error(sorted/4,arg=1,X0))).
                         ...
                         -> (is_int(X5,Y5)
                             -> (is_IntVar(X6,Y6)
                                 -> (is_IntConLevel(X7,Y7)
                                     ...
                                     ;  throw(gecode_argument_error(element/8,arg=8,X7)))
                                 ;  throw(gecode_argument_error(element/8,arg=7,X6)))
                             ;  throw(gecode_argument_error(element/8,arg=6,X5)))
                         ;  throw(gecode_argument_error(element/8,arg=5,X4)))
                     ;  throw(gecode_argument_error(element/8,arg=4,X3)))
                 ;  throw(gecode_argument_error(element/8,arg=3,X2)))
             ;  (is_BoolVarArgs(X1,Y1)
                 -> (is_IntVar(X2,Y2)
                     -> (is_int(X3,Y3)
                         -> (is_IntVar(X4,Y4)
                 ...
                 ;  (is_IntArgs(X1,Y1)
                     -> (is_IntVar(X2,Y2)
                         -> (is_int(X3,Y3)
                             ...
                             ;  throw(gecode_argument_error(element/8,arg=4,X3)))
                         ;  throw(gecode_argument_error(element/8,arg=3,X2)))
                     ;  throw(gecode_argument_error(element/8,arg=2,X1)))))
         ;  throw(gecode_argument_error(element/8,arg=1,X0))).
             ...
             -> (is_IntVar(X2,Y2)
                 -> (is_int(X3,Y3)
                     -> (is_IntConLevel(X4,Y4)
                         ...
                         ;  throw(gecode_argument_error(element/5,arg=5,X4)))
                     ;  (is_IntVar(X3,Y3)
                         -> (is_IntConLevel(X4,Y4)
                             -> gecode_constraint_element_163(Y0,Y1,Y2,Y3,Y4)
                             ;  throw(gecode_argument_error(element/5,arg=5,X4)))
                         ;  throw(gecode_argument_error(element/5,arg=4,X3))))
                 ;  throw(gecode_argument_error(element/5,arg=3,X2)))
             ;  (is_BoolVarArgs(X1,Y1)
                 -> (is_IntVar(X2,Y2)
                     -> (is_int(X3,Y3)
                         -> (is_IntConLevel(X4,Y4)
                             ...
                             -> (is_int(X3,Y3)
                                 ...
                                 ;  (is_IntVar(X3,Y3)
                                     ...
                                     ;  (is_BoolVar(X3,Y3)
                                         ...
                                         ;  throw(gecode_argument_error(element/5,arg=4,X3)))))
                             ;  throw(gecode_argument_error(element/5,arg=3,X2)))
                         ;  throw(gecode_argument_error(element/5,arg=2,X1))))))
         ;  throw(gecode_argument_error(element/5,arg=1,X0))).
        ...
        (is_Space_or_Clause(X0,Y0)
         -> (is_SetVarArgs(X1,Y1)
             -> (is_SetVar(X2,Y2)
                 ...
                 ;  throw(gecode_argument_error(sequence/3,arg=3,X2)))
             ;  throw(gecode_argument_error(sequence/3,arg=2,X1)))
         ;  throw(gecode_argument_error(sequence/3,arg=1,X0))).
                     ...
                     -> (is_IntVarArgs(X4,Y4)
                         -> (is_IntVar(X5,Y5)
                             -> (is_IntConLevel(X6,Y6)
                                 ...
                                 ;  throw(gecode_argument_error(circuit/7,arg=7,X6)))
                             ;  throw(gecode_argument_error(circuit/7,arg=6,X5)))
                         ;  throw(gecode_argument_error(circuit/7,arg=5,X4)))
                     ;  throw(gecode_argument_error(circuit/7,arg=4,X3)))
                 ;  throw(gecode_argument_error(circuit/7,arg=3,X2)))
             ;  throw(gecode_argument_error(circuit/7,arg=2,X1)))
         ;  throw(gecode_argument_error(circuit/7,arg=1,X0))).
        ...
        (is_Space_or_Clause(X0,Y0)
         -> (is_SetVarArgs(X1,Y1)
             -> (is_IntArgs(X2,Y2)
                 ...
                 ;  throw(gecode_argument_error(precede/3,arg=3,X2)))
             ;  (is_IntVarArgs(X1,Y1)
                 -> (is_IntArgs(X2,Y2)
                     -> gecode_constraint_precede_270(Y0,Y1,Y2)
                     ;  throw(gecode_argument_error(precede/3,arg=3,X2)))
                 ;  throw(gecode_argument_error(precede/3,arg=2,X1))))
         ;  throw(gecode_argument_error(precede/3,arg=1,X0))).
                 ...
                 -> (is_IntVarArgs(X3,Y3)
                     -> (is_IntArgs(X4,Y4)
                         -> (is_IntArgs(X5,Y5)
                             ...
                             ;  throw(gecode_argument_error(cumulative/6,arg=6,X5)))
                         ;  throw(gecode_argument_error(cumulative/6,arg=5,X4)))
                     ;  throw(gecode_argument_error(cumulative/6,arg=4,X3)))
                 ;  (is_IntVarArgs(X2,Y2)
                     -> (is_IntVarArgs(X3,Y3)
                         -> (is_IntVarArgs(X4,Y4)
                             -> (is_IntArgs(X5,Y5)
                         ...
                         ;  (is_IntArgs(X3,Y3)
                             -> (is_IntArgs(X4,Y4)
                                 ...
                                 ;  throw(gecode_argument_error(cumulative/6,arg=5,X4)))
                             ;  throw(gecode_argument_error(cumulative/6,arg=4,X3))))
                     ;  throw(gecode_argument_error(cumulative/6,arg=3,X2))))
             ;  (is_IntVar(X1,Y1)
                 -> (is_TaskTypeArgs(X2,Y2)
                     -> (is_IntVarArgs(X3,Y3)
                         -> (is_IntArgs(X4,Y4)
                     ...
                     ;  (is_IntVarArgs(X2,Y2)
                         -> (is_IntVarArgs(X3,Y3)
                             ...
                             ;  (is_IntArgs(X3,Y3)
                                 ...
                                 ;  throw(gecode_argument_error(cumulative/6,arg=4,X3))))
                         ;  throw(gecode_argument_error(cumulative/6,arg=3,X2))))
                 ;  throw(gecode_argument_error(cumulative/6,arg=2,X1))))
         ;  throw(gecode_argument_error(cumulative/6,arg=1,X0))).
         ...
         -> (is_IntArgs(X1,Y1)
             -> (is_IntVarArgs(X2,Y2)
                 -> (is_IntConLevel(X3,Y3)
                     ...
                     ;  throw(gecode_argument_error(distinct/4,arg=4,X3)))
                 ;  throw(gecode_argument_error(distinct/4,arg=3,X2)))
             ;  throw(gecode_argument_error(distinct/4,arg=2,X1)))
         ;  throw(gecode_argument_error(distinct/4,arg=1,X0))).
        ...
        (is_Space_or_Clause(X0,Y0)
         -> (is_IntVarArgs(X1,Y1)
             -> (is_IntVar(X2,Y2)
                 ...
                 ;  throw(gecode_argument_error(min/3,arg=3,X2)))
             ;  (is_SetVar(X1,Y1)
                 -> (is_IntVar(X2,Y2)
                     -> gecode_constraint_min_234(Y0,Y1,Y2)
                     ;  throw(gecode_argument_error(min/3,arg=3,X2)))
                 ;  throw(gecode_argument_error(min/3,arg=2,X1))))
         ;  throw(gecode_argument_error(min/3,arg=1,X0))).
         ...
         -> (is_IntVar(X1,Y1)
             -> (is_IntVar(X2,Y2)
                 -> (is_IntConLevel(X3,Y3)
                     ...
                     ;  throw(gecode_argument_error(sqrt/4,arg=4,X3)))
                 ;  throw(gecode_argument_error(sqrt/4,arg=3,X2)))
             ;  throw(gecode_argument_error(sqrt/4,arg=2,X1)))
         ;  throw(gecode_argument_error(sqrt/4,arg=1,X0))).
                 ...
                 -> (is_int(X3,Y3)
                     -> (is_int(X4,Y4)
                         -> (is_int(X5,Y5)
                             ...
                             ;  throw(gecode_argument_error(sequence/6,arg=6,X5)))
                         ;  throw(gecode_argument_error(sequence/6,arg=5,X4)))
                     ;  throw(gecode_argument_error(sequence/6,arg=4,X3)))
                 ;  throw(gecode_argument_error(sequence/6,arg=3,X2)))
             ;  (is_BoolVarArgs(X1,Y1)
                 -> (is_IntSet(X2,Y2)
                     -> (is_int(X3,Y3)
                         -> (is_int(X4,Y4)
                         ...
                         ;  throw(gecode_argument_error(sequence/6,arg=4,X3)))
                     ;  throw(gecode_argument_error(sequence/6,arg=3,X2)))
                 ;  throw(gecode_argument_error(sequence/6,arg=2,X1))))
         ;  throw(gecode_argument_error(sequence/6,arg=1,X0))).
        ...
        (is_Space_or_Clause(X0,Y0)
         -> (is_IntVarArgs(X1,Y1)
             -> (is_IntConLevel(X2,Y2)
                 ...
                 ;  throw(gecode_argument_error(unshare/3,arg=3,X2)))
             ;  (is_BoolVarArgs(X1,Y1)
                 -> (is_IntConLevel(X2,Y2)
                     -> gecode_constraint_unshare_361(Y0,Y1,Y2)
                     ;  throw(gecode_argument_error(unshare/3,arg=3,X2)))
                 ;  throw(gecode_argument_error(unshare/3,arg=2,X1))))
         ;  throw(gecode_argument_error(unshare/3,arg=1,X0))).
                 ...
                 -> (is_IntVar(X3,Y3)
                     -> (is_IntVar(X4,Y4)
                         -> (is_IntConLevel(X5,Y5)
                             ...
                             ;  throw(gecode_argument_error(path/6,arg=6,X5)))
                         ;  throw(gecode_argument_error(path/6,arg=5,X4)))
                     ;  throw(gecode_argument_error(path/6,arg=4,X3)))
                 ;  throw(gecode_argument_error(path/6,arg=3,X2)))
             ;  (is_IntArgs(X1,Y1)
                 -> (is_IntVarArgs(X2,Y2)
                     -> (is_IntVar(X3,Y3)
                         -> (is_IntVar(X4,Y4)
                         ...
                         ;  throw(gecode_argument_error(path/6,arg=4,X3)))
                     ;  throw(gecode_argument_error(path/6,arg=3,X2)))
                 ;  throw(gecode_argument_error(path/6,arg=2,X1))))
         ;  throw(gecode_argument_error(path/6,arg=1,X0))).
             ...
             -> (is_IntVar(X2,Y2)
                 -> (is_IntVar(X3,Y3)
                     -> (is_IntVar(X4,Y4)
                         ...
                         ;  throw(gecode_argument_error(divmod/5,arg=5,X4)))
                     ;  throw(gecode_argument_error(divmod/5,arg=4,X3)))
                 ;  throw(gecode_argument_error(divmod/5,arg=3,X2)))
             ;  throw(gecode_argument_error(divmod/5,arg=2,X1)))
         ;  throw(gecode_argument_error(divmod/5,arg=1,X0))).
                             ...
                             -> (is_IntVarArgs(X6,Y6)
                                 -> (is_BoolVarArgs(X7,Y7)
                                     -> (is_IntConLevel(X8,Y8)
                                         ...
                                         ;  throw(gecode_argument_error(nooverlap/9,arg=9,X8)))
                                     ;  throw(gecode_argument_error(nooverlap/9,arg=8,X7)))
                                 ;  throw(gecode_argument_error(nooverlap/9,arg=7,X6)))
                             ;  throw(gecode_argument_error(nooverlap/9,arg=6,X5)))
                         ;  throw(gecode_argument_error(nooverlap/9,arg=5,X4)))
                     ;  throw(gecode_argument_error(nooverlap/9,arg=4,X3)))
                 ;  throw(gecode_argument_error(nooverlap/9,arg=3,X2)))
             ;  throw(gecode_argument_error(nooverlap/9,arg=2,X1)))
         ;  throw(gecode_argument_error(nooverlap/9,arg=1,X0))).
             ...
             -> (is_IntVarArgs(X2,Y2)
                 -> (is_IntArgs(X3,Y3)
                     -> (is_IntArgs(X4,Y4)
                         ...
                         ;  throw(gecode_argument_error(cumulative/5,arg=5,X4)))
                     ;  throw(gecode_argument_error(cumulative/5,arg=4,X3)))
                 ;  throw(gecode_argument_error(cumulative/5,arg=3,X2)))
             ;  (is_IntVar(X1,Y1)
                 -> (is_IntVarArgs(X2,Y2)
                     -> (is_IntArgs(X3,Y3)
                         -> (is_IntArgs(X4,Y4)
                         ...
                         ;  throw(gecode_argument_error(cumulative/5,arg=4,X3)))
                     ;  throw(gecode_argument_error(cumulative/5,arg=3,X2)))
                 ;  throw(gecode_argument_error(cumulative/5,arg=2,X1))))
         ;  throw(gecode_argument_error(cumulative/5,arg=1,X0))).
        ...
        (is_Space_or_Clause(X0,Y0)
         -> (is_IntVarArgs(X1,Y1)
             -> (is_IntVar(X2,Y2)
                 ...
                 ;  throw(gecode_argument_error(member/3,arg=3,X2)))
             ;  (is_BoolVarArgs(X1,Y1)
                 -> (is_BoolVar(X2,Y2)
                     -> gecode_constraint_member_224(Y0,Y1,Y2)
                     ;  throw(gecode_argument_error(member/3,arg=3,X2)))
                 ;  throw(gecode_argument_error(member/3,arg=2,X1))))
         ;  throw(gecode_argument_error(member/3,arg=1,X0))).
                 ...
                 -> (is_IntRelType(X3,Y3)
                     -> (is_int(X4,Y4)
                         -> (is_IntConLevel(X5,Y5)
                             ...
                             ;  throw(gecode_argument_error(count/6,arg=6,X5)))
                         ;  (is_IntVar(X4,Y4)
                             -> (is_IntConLevel(X5,Y5)
                                 -> gecode_constraint_count_73(Y0,Y1,Y2,Y3,Y4,Y5)
                                 ;  throw(gecode_argument_error(count/6,arg=6,X5)))
                             ;  throw(gecode_argument_error(count/6,arg=5,X4))))
                     ;  throw(gecode_argument_error(count/6,arg=4,X3)))
                 ;  (is_IntVar(X2,Y2)
                     -> (is_IntRelType(X3,Y3)
                         -> (is_int(X4,Y4)
                             -> (is_IntConLevel(X5,Y5)
                             ...
                             -> (is_IntRelType(X3,Y3)
                                 -> (is_int(X4,Y4)
                                     ...
                                     ;  (is_IntVar(X4,Y4)
                                         ...
                                         ;  throw(gecode_argument_error(count/6,arg=5,X4))))
                                 ;  throw(gecode_argument_error(count/6,arg=4,X3)))
                             ;  throw(gecode_argument_error(count/6,arg=3,X2))))))
             ;  throw(gecode_argument_error(count/6,arg=2,X1)))
         ;  throw(gecode_argument_error(count/6,arg=1,X0))).
        ...
        (is_Space_or_Clause(X0,Y0)
         -> (is_SetVar(X1,Y1)
             -> (is_IntVar(X2,Y2)
                 ...
                 ;  throw(gecode_argument_error(notMin/3,arg=3,X2)))
             ;  throw(gecode_argument_error(notMin/3,arg=2,X1)))
         ;  throw(gecode_argument_error(notMin/3,arg=1,X0))).
                         ...
                         -> (is_IntArgs(X5,Y5)
                             -> (is_BoolVarArgs(X6,Y6)
                                 -> (is_IntConLevel(X7,Y7)
                                     ...
                                     ;  throw(gecode_argument_error(cumulative/8,arg=8,X7)))
                                 ;  throw(gecode_argument_error(cumulative/8,arg=7,X6)))
                             ;  throw(gecode_argument_error(cumulative/8,arg=6,X5)))
                         ;  throw(gecode_argument_error(cumulative/8,arg=5,X4)))
                     ;  throw(gecode_argument_error(cumulative/8,arg=4,X3)))
                 ;  (is_IntVarArgs(X2,Y2)
                     -> (is_IntVarArgs(X3,Y3)
                         -> (is_IntVarArgs(X4,Y4)
                             -> (is_IntArgs(X5,Y5)
                             ...
                             ;  throw(gecode_argument_error(cumulative/8,arg=5,X4)))
                         ;  throw(gecode_argument_error(cumulative/8,arg=4,X3)))
                     ;  throw(gecode_argument_error(cumulative/8,arg=3,X2))))
             ;  (is_IntVar(X1,Y1)
                 -> (is_TaskTypeArgs(X2,Y2)
                     -> (is_IntVarArgs(X3,Y3)
                         -> (is_IntArgs(X4,Y4)
                     ...
                     ;  (is_IntVarArgs(X2,Y2)
                         -> (is_IntVarArgs(X3,Y3)
                             ...
                             ;  throw(gecode_argument_error(cumulative/8,arg=4,X3)))
                         ;  throw(gecode_argument_error(cumulative/8,arg=3,X2))))
                 ;  throw(gecode_argument_error(cumulative/8,arg=2,X1))))
         ;  throw(gecode_argument_error(cumulative/8,arg=1,X0))).
        ...
        (is_Space_or_Clause(X0,Y0)
         -> (is_IntVar(X1,Y1)
             -> (is_IntValBranch(X2,Y2)
                 ...
                 ;  throw(gecode_argument_error(branch/3,arg=3,X2)))
             ;  (is_BoolVar(X1,Y1)
                 -> (is_IntValBranch(X2,Y2)
                 ...
                 ;  (is_SetVar(X1,Y1)
                     -> (is_SetValBranch(X2,Y2)
                         ...
                         ;  throw(gecode_argument_error(branch/3,arg=3,X2)))
                     ;  throw(gecode_argument_error(branch/3,arg=2,X1)))))
         ;  throw(gecode_argument_error(branch/3,arg=1,X0))).
         ...
         -> (is_IntVar(X1,Y1)
             -> (is_int(X2,Y2)
                 ...
                 ;  (is_IntSet(X2,Y2)
                     ...
                     ;  throw(gecode_argument_error(dom/3,arg=3,X2))))
             ;  (is_IntVarArgs(X1,Y1)
                 -> (is_int(X2,Y2)
                     ...
                     ;  (is_IntSet(X2,Y2)
                         ...
                         ;  throw(gecode_argument_error(dom/3,arg=3,X2))))
                 ;  throw(gecode_argument_error(dom/3,arg=2,X1))))
         ;  throw(gecode_argument_error(dom/3,arg=1,X0))).
                 ...
                 -> (is_int(X3,Y3)
                     -> (is_BoolVar(X4,Y4)
                         ...
                         ;  (is_IntConLevel(X4,Y4)
                             ...
                             ;  throw(gecode_argument_error(linear/5,arg=5,X4))))
                     ;  (is_IntVar(X3,Y3)
                         -> (is_BoolVar(X4,Y4)
                             ...
                             ;  (is_IntConLevel(X4,Y4)
                                 ...
                                 ;  throw(gecode_argument_error(linear/5,arg=5,X4))))
                         ;  throw(gecode_argument_error(linear/5,arg=4,X3))))
                 ;  throw(gecode_argument_error(linear/5,arg=3,X2)))
             ;  (is_BoolVarArgs(X1,Y1)
                 -> (is_IntRelType(X2,Y2)
                     -> (is_int(X3,Y3)
                         -> (is_BoolVar(X4,Y4)
                     ...
                     -> (is_IntVarArgs(X2,Y2)
                         ...
                         ;  (is_BoolVarArgs(X2,Y2)
                             -> (is_IntRelType(X3,Y3)
                                 ...
                                 ;  throw(gecode_argument_error(linear/5,arg=4,X3)))
                             ;  throw(gecode_argument_error(linear/5,arg=3,X2))))
                     ;  throw(gecode_argument_error(linear/5,arg=2,X1)))))
         ;  throw(gecode_argument_error(linear/5,arg=1,X0))).
                     ...
                     -> (is_IntArgs(X4,Y4)
                         -> (is_BoolVarArgs(X5,Y5)
                             ...
                             ;  (is_IntConLevel(X5,Y5)
                                 ...
                                 ;  throw(gecode_argument_error(nooverlap/6,arg=6,X5))))
                         ;  throw(gecode_argument_error(nooverlap/6,arg=5,X4)))
                     ;  throw(gecode_argument_error(nooverlap/6,arg=4,X3)))
                 ;  throw(gecode_argument_error(nooverlap/6,arg=3,X2)))
             ;  throw(gecode_argument_error(nooverlap/6,arg=2,X1)))
         ;  throw(gecode_argument_error(nooverlap/6,arg=1,X0))).
                 ...
                 -> (is_SetVar(X3,Y3)
                     -> (is_SetVar(X4,Y4)
                         -> (is_IntSet(X5,Y5)
                             ...
                             ;  throw(gecode_argument_error(element/6,arg=6,X5)))
                         ;  throw(gecode_argument_error(element/6,arg=5,X4)))
                     ;  throw(gecode_argument_error(element/6,arg=4,X3)))
                 ;  (is_IntVarArgs(X2,Y2)
                     -> (is_SetVar(X3,Y3)
                         -> (is_SetVar(X4,Y4)
                             -> (is_IntSet(X5,Y5)
                         ...
                         ;  (is_IntArgs(X2,Y2)
                             -> (is_SetVar(X3,Y3)
                                 -> (is_SetVar(X4,Y4)
                                     ...
                                     ;  throw(gecode_argument_error(element/6,arg=5,X4)))
                                 ;  throw(gecode_argument_error(element/6,arg=4,X3)))
                             ;  throw(gecode_argument_error(element/6,arg=3,X2))))))
             ;  throw(gecode_argument_error(element/6,arg=2,X1)))
         ;  throw(gecode_argument_error(element/6,arg=1,X0))).
             ...
             -> (is_IntRelType(X2,Y2)
                 -> (is_int(X3,Y3)
                     ...
                     ;  (is_BoolVar(X3,Y3)
                         ...
                         ;  throw(gecode_argument_error(rel/4,arg=4,X3))))
                 ;  throw(gecode_argument_error(rel/4,arg=3,X2)))
             ;  (is_BoolVarArgs(X1,Y1)
                 -> (is_IntRelType(X2,Y2)
                     -> (is_int(X3,Y3)
                                     ...
                                     -> (is_BoolVarArgs(X2,Y2)
                                         -> (is_int(X3,Y3)
                                             ...
                                             ;  (is_BoolVar(X3,Y3)
                                                 ...
                                                 ;  throw(gecode_argument_error(rel/4,arg=4,X3))))
                                         ;  throw(gecode_argument_error(rel/4,arg=3,X2)))
                                     ;  throw(gecode_argument_error(rel/4,arg=2,X1)))))))))
         ;  throw(gecode_argument_error(rel/4,arg=1,X0))).
             ...
             -> (is_IntVar(X2,Y2)
                 -> (is_IntVar(X3,Y3)
                     -> (is_IntConLevel(X4,Y4)
                         ...
                         ;  throw(gecode_argument_error(min/5,arg=5,X4)))
                     ;  throw(gecode_argument_error(min/5,arg=4,X3)))
                 ;  throw(gecode_argument_error(min/5,arg=3,X2)))
             ;  throw(gecode_argument_error(min/5,arg=2,X1)))
         ;  throw(gecode_argument_error(min/5,arg=1,X0))).
         ...
         -> (is_IntVarArgs(X1,Y1)
             -> (is_IntVarArgs(X2,Y2)
                 ...
                 ;  (is_IntSetArgs(X2,Y2)
                     ...
                     ;  throw(gecode_argument_error(count/3,arg=3,X2))))
             ;  throw(gecode_argument_error(count/3,arg=2,X1)))
         ;  throw(gecode_argument_error(count/3,arg=1,X0))).
