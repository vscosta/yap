...
def system(cmd):
    ...
    Note that this implementation returns None, as meant for use in yap_ipython.
    ...
    utility is meant to be used extensively in yap_ipython, where any return value
