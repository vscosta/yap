...
E1(EVALUATION_ERROR_USER_DEFINED, EVALUATION_ERROR,"usee_defined")
...
E1(REPRESENTATION_ERROR_IN_CHARACTER_CODE, REPRESENTATION_ERROR,
   "in_character_code")
E1(REPRESENTATION_ERROR_INT,REPRESENTATION_ERROR, "int")
E1(REPRESENTATION_ERROR_VARIABLE, REPRESENTATION_ERROR, "variable")
E1(REPRESENTATION_ERROR_USER_DEFINED, REPRESENTATION_ERROR, "user_defined")
