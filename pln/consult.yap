...
%% reexport(Fs) :-
%% 	load_files(Fs, [if(not_loaded), silent(true), reexport(true),must_be_module(true)]).

%% reexport(Fs, Spec) :-
%% 	load_files(Fs, [if(changed), silent(true), imports(Spec), reexport(true),must_be_module(true)]).
