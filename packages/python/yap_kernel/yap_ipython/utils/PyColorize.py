...
from yap_ipython.utils.coloransi import TermColors, InputTermColors ,ColorScheme, ColorSchemeTable
...
class Parser(Colorable):
    ...
    def format(self, raw, out=None, scheme=Undefined):
        ...
        if scheme is not Undefined:
            warnings.warn('The `scheme` argument of yap_ipython.utils.PyColorize:Parser.format is deprecated since yap_ipython 6.0.'
