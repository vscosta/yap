        ...
        (is_Space_or_Clause(X0,Y0)
         -> (is_BoolVarArgs(X1,Y1)
             -> (is_DFA(X2,Y2)
                 ...
                 ;  (is_TupleSet(X2,Y2)
                     -> (is_bool(X3,Y3)
                         -> gecode_constraint_extensional_268(Y0,Y1,Y2,Y3)
             ...
             ;  (is_IntVarArgs(X1,Y1)
                 -> (is_DFA(X2,Y2)
                     ...
                     ;  (is_TupleSet(X2,Y2)
                         -> (is_bool(X3,Y3)
                             -> gecode_constraint_extensional_274(Y0,Y1,Y2,Y3)
                             ;  throw(error(type_error(bool(X3)),gecode_argument_error(extensional(X0,X1,X2,X3),arg=4))))
                         ;  throw(error(type_error('TupleSet'(X2)),gecode_argument_error(extensional(X0,X1,X2,X3),arg=3)))))
        ...
        (is_Space_or_Clause(X0,Y0)
         -> (is_BoolVarArgs(X1,Y1)
             -> (is_TupleSet(X2,Y2)
                 -> (is_bool(X3,Y3)
                     -> (is_IntPropLevel(X4,Y4)
                         -> gecode_constraint_extensional_269(Y0,Y1,Y2,Y3,Y4)
                         ;  (is_Reify(X4,Y4)
                             -> gecode_constraint_extensional_270(Y0,Y1,Y2,Y3,Y4)
             ...
             ;  (is_IntVarArgs(X1,Y1)
                 -> (is_TupleSet(X2,Y2)
                     -> (is_bool(X3,Y3)
                         -> (is_IntPropLevel(X4,Y4)
                             -> gecode_constraint_extensional_275(Y0,Y1,Y2,Y3,Y4)
                             ;  (is_Reify(X4,Y4)
                                 -> gecode_constraint_extensional_276(Y0,Y1,Y2,Y3,Y4)
                                 ;  throw(error(type_error('Reify'(X4)),gecode_argument_error(extensional(X0,X1,X2,X3,X4),arg=5)))))
                         ;  throw(error(type_error(bool(X3)),gecode_argument_error(extensional(X0,X1,X2,X3,X4),arg=4))))
                     ;  throw(error(type_error('TupleSet'(X2)),gecode_argument_error(extensional(X0,X1,X2,X3,X4),arg=3))))
         ...
         -> (is_BoolVarArgs(X1,Y1)
             -> (is_TupleSet(X2,Y2)
                 -> (is_bool(X3,Y3)
                     -> (is_Reify(X4,Y4)
                         -> (is_IntPropLevel(X5,Y5)
                             -> gecode_constraint_extensional_271(Y0,Y1,Y2,Y3,Y4,Y5)
             ...
             ;  (is_IntVarArgs(X1,Y1)
                 -> (is_TupleSet(X2,Y2)
                     -> (is_bool(X3,Y3)
                         -> (is_Reify(X4,Y4)
                             -> (is_IntPropLevel(X5,Y5)
                                 -> gecode_constraint_extensional_277(Y0,Y1,Y2,Y3,Y4,Y5)
                                 ;  throw(error(type_error('IntPropLevel'(X5)),gecode_argument_error(extensional(X0,X1,X2,X3,X4,X5),arg=6))))
                             ;  throw(error(type_error('Reify'(X4)),gecode_argument_error(extensional(X0,X1,X2,X3,X4,X5),arg=5))))
                         ;  throw(error(type_error(bool(X3)),gecode_argument_error(extensional(X0,X1,X2,X3,X4,X5),arg=4))))
                     ;  throw(error(type_error('TupleSet'(X2)),gecode_argument_error(extensional(X0,X1,X2,X3,X4,X5),arg=3))))
         ...
         -> (is_FloatVar(X1,Y1)
             ...
             ;  (is_IntVar(X1,Y1)
                 ...
                 ;  (is_IntVarArgs(X1,Y1)
                     -> (is_IntVar(X2,Y2)
                         -> (is_IntPropLevel(X3,Y3)
                             -> gecode_constraint_max_329(Y0,Y1,Y2,Y3)
        ...
        (is_Space_or_Clause(X0,Y0)
         -> (is_IntVar(X1,Y1)
             -> (is_IntVar(X2,Y2)
                 -> (is_IntVar(X3,Y3)
                     -> (is_IntPropLevel(X4,Y4)
                         -> gecode_constraint_max_326(Y0,Y1,Y2,Y3,Y4)
         ...
         -> (is_FloatVar(X1,Y1)
             ...
             ;  (is_IntVar(X1,Y1)
                 ...
                 ;  (is_IntVarArgs(X1,Y1)
                     -> (is_IntVar(X2,Y2)
                         -> (is_IntPropLevel(X3,Y3)
                             -> gecode_constraint_min_343(Y0,Y1,Y2,Y3)
        ...
        (is_Space_or_Clause(X0,Y0)
         -> (is_IntVar(X1,Y1)
             -> (is_IntVar(X2,Y2)
                 -> (is_IntVar(X3,Y3)
                     -> (is_IntPropLevel(X4,Y4)
                         -> gecode_constraint_min_340(Y0,Y1,Y2,Y3,Y4)
        ...
        (is_Space_or_Clause(X0,Y0)
         -> (is_IntVarArgs(X1,Y1)
             -> (is_IntArgs(X2,Y2)
                 -> (is_IntVarArgs(X3,Y3)
                     -> (is_IntArgs(X4,Y4)
                         -> gecode_constraint_nooverlap_349(Y0,Y1,Y2,Y3,Y4)
         ...
         -> (is_IntVarArgs(X1,Y1)
             -> (is_IntArgs(X2,Y2)
                 -> (is_IntVarArgs(X3,Y3)
                     -> (is_IntArgs(X4,Y4)
                         -> (is_IntPropLevel(X5,Y5)
                             -> gecode_constraint_nooverlap_350(Y0,Y1,Y2,Y3,Y4,Y5)
                             ;  (is_BoolVarArgs(X5,Y5)
                                 -> gecode_constraint_nooverlap_351(Y0,Y1,Y2,Y3,Y4,Y5)
             ...
             -> (is_IntArgs(X2,Y2)
                 -> (is_IntVarArgs(X3,Y3)
                     -> (is_IntArgs(X4,Y4)
                         -> (is_BoolVarArgs(X5,Y5)
                             -> (is_IntPropLevel(X6,Y6)
                                 -> gecode_constraint_nooverlap_352(Y0,Y1,Y2,Y3,Y4,Y5,Y6)
                 ...
                 ;  (is_IntVarArgs(X2,Y2)
                     -> (is_IntVarArgs(X3,Y3)
                         -> (is_IntVarArgs(X4,Y4)
                             -> (is_IntVarArgs(X5,Y5)
                                 -> (is_IntVarArgs(X6,Y6)
                                     -> gecode_constraint_nooverlap_353(Y0,Y1,Y2,Y3,Y4,Y5,Y6)
                 ...
                 -> (is_IntVarArgs(X3,Y3)
                     -> (is_IntVarArgs(X4,Y4)
                         -> (is_IntVarArgs(X5,Y5)
                             -> (is_IntVarArgs(X6,Y6)
                                 -> (is_IntPropLevel(X7,Y7)
                                     -> gecode_constraint_nooverlap_354(Y0,Y1,Y2,Y3,Y4,Y5,Y6,Y7)
                                     ;  (is_BoolVarArgs(X7,Y7)
                                         -> gecode_constraint_nooverlap_355(Y0,Y1,Y2,Y3,Y4,Y5,Y6,Y7)
                     ...
                     -> (is_IntVarArgs(X4,Y4)
                         -> (is_IntVarArgs(X5,Y5)
                             -> (is_IntVarArgs(X6,Y6)
                                 -> (is_BoolVarArgs(X7,Y7)
                                     -> (is_IntPropLevel(X8,Y8)
                                         -> gecode_constraint_nooverlap_356(Y0,Y1,Y2,Y3,Y4,Y5,Y6,Y7,Y8)
         ...
         -> (is_IntArgs(X1,Y1)
             -> (is_IntVarArgs(X2,Y2)
                 -> (is_IntVar(X3,Y3)
                     -> (is_IntVar(X4,Y4)
                         -> (is_IntVar(X5,Y5)
                             -> gecode_constraint_path_368(Y0,Y1,Y2,Y3,Y4,Y5)
             ...
             -> (is_IntVarArgs(X2,Y2)
                 -> (is_IntVar(X3,Y3)
                     -> (is_IntVar(X4,Y4)
                         -> (is_IntVar(X5,Y5)
                             -> (is_IntPropLevel(X6,Y6)
                                 -> gecode_constraint_path_369(Y0,Y1,Y2,Y3,Y4,Y5,Y6)
                 ...
                 ;  (is_int(X2,Y2)
                     -> (is_IntVarArgs(X3,Y3)
                         -> (is_IntVar(X4,Y4)
                             -> (is_IntVar(X5,Y5)
                                 -> (is_IntVar(X6,Y6)
                                     -> gecode_constraint_path_372(Y0,Y1,Y2,Y3,Y4,Y5,Y6)
                                     ;  throw(error(type_error('IntVar'(X6)),gecode_argument_error(path(X0,X1,X2,X3,X4,X5,X6),arg=7))))
                     ...
                     -> (is_IntVarArgs(X3,Y3)
                         -> (is_IntVar(X4,Y4)
                             -> (is_IntVar(X5,Y5)
                                 -> (is_IntVar(X6,Y6)
                                     -> (is_IntPropLevel(X7,Y7)
                                         -> gecode_constraint_path_373(Y0,Y1,Y2,Y3,Y4,Y5,Y6,Y7)
                                         ;  throw(error(type_error('IntPropLevel'(X7)),gecode_argument_error(path(X0,X1,X2,X3,X4,X5,X6,X7),arg=8))))
                                     ;  (is_IntVarArgs(X6,Y6)
                                         -> (is_IntVar(X7,Y7)
                                             -> gecode_constraint_path_374(Y0,Y1,Y2,Y3,Y4,Y5,Y6,Y7)
                     ...
                     -> (is_IntVar(X4,Y4)
                         -> (is_IntVar(X5,Y5)
                             -> (is_IntVarArgs(X6,Y6)
                                 -> (is_IntVar(X7,Y7)
                                     -> (is_IntPropLevel(X8,Y8)
                                         -> gecode_constraint_path_375(Y0,Y1,Y2,Y3,Y4,Y5,Y6,Y7,Y8)
         ...
         -> (is_BoolOpType(X1,Y1)
             -> (is_BoolVarArgs(X2,Y2)
                 -> (is_BoolVar(X3,Y3)
                     ...
                     ;  (is_int(X3,Y3)
                         -> gecode_constraint_rel_389(Y0,Y1,Y2,Y3)
                 ...
                 -> (is_IntRelType(X2,Y2)
                     -> (is_IntVar(X3,Y3)
                         ...
                         ;  (is_int(X3,Y3)
                             -> (is_Reify(X4,Y4)
                                 -> (is_IntPropLevel(X5,Y5)
                                     -> gecode_constraint_rel_414(Y0,Y1,Y2,Y3,Y4,Y5)
                                     ;  throw(error(type_error('IntPropLevel'(X5)),gecode_argument_error(rel(X0,X1,X2,X3,X4,X5),arg=6))))
                                 ;  throw(error(type_error('Reify'(X4)),gecode_argument_error(rel(X0,X1,X2,X3,X4,X5),arg=5))))
                             ;  throw(error(type_error(int(X3)),gecode_argument_error(rel(X0,X1,X2,X3,X4,X5),arg=4)))))
                     ;  throw(error(type_error('IntRelType'(X2)),gecode_argument_error(rel(X0,X1,X2,X3,X4,X5),arg=3))))
...
rel(X0,X1,X2) :-
        (is_Space_or_Clause(X0,Y0)
         -> (is_BoolVarArgs(X1,Y1)
             -> (is_IntRelType(X2,Y2)
                 -> gecode_constraint_rel_425(Y0,Y1,Y2)
        ...
        (is_Space_or_Clause(X0,Y0)
         -> (is_SetVarArgs(X1,Y1)
             -> (is_SetVarArgs(X2,Y2)
                 -> (is_Rnd(X3,Y3)
                     -> (is_double(X4,Y4)
                         -> gecode_constraint_relax_449(Y0,Y1,Y2,Y3,Y4)
...
sorted(X0,X1,X2) :-
        (is_Space_or_Clause(X0,Y0)
         -> (is_IntVarArgs(X1,Y1)
             -> (is_IntVarArgs(X2,Y2)
                 -> gecode_constraint_sorted_454(Y0,Y1,Y2)
...
sorted(X0,X1,X2,X3) :-
        (is_Space_or_Clause(X0,Y0)
         -> (is_IntVarArgs(X1,Y1)
             -> (is_IntVarArgs(X2,Y2)
                 -> (is_IntPropLevel(X3,Y3)
                     -> gecode_constraint_sorted_455(Y0,Y1,Y2,Y3)
                     ;  (is_IntVarArgs(X3,Y3)
        ...
        (is_Space_or_Clause(X0,Y0)
         -> (is_IntVarArgs(X1,Y1)
             -> (is_IntVarArgs(X2,Y2)
                 -> (is_IntVarArgs(X3,Y3)
                     -> (is_IntPropLevel(X4,Y4)
                         -> gecode_constraint_sorted_457(Y0,Y1,Y2,Y3,Y4)
...
unary(X0,X1,X2) :-
        (is_Space_or_Clause(X0,Y0)
         -> (is_IntVarArgs(X1,Y1)
             -> (is_IntArgs(X2,Y2)
                 -> gecode_constraint_unary_464(Y0,Y1,Y2)
        ...
        (is_Space_or_Clause(X0,Y0)
         -> (is_IntVarArgs(X1,Y1)
             ...
             ;  (is_TaskTypeArgs(X1,Y1)
                 -> (is_IntVarArgs(X2,Y2)
                     -> (is_IntArgs(X3,Y3)
                         -> gecode_constraint_unary_472(Y0,Y1,Y2,Y3)
         ...
         -> (is_IntVarArgs(X1,Y1)
             ...
             ;  (is_TaskTypeArgs(X1,Y1)
                 -> (is_IntVarArgs(X2,Y2)
                     -> (is_IntArgs(X3,Y3)
                         -> (is_IntPropLevel(X4,Y4)
                             -> gecode_constraint_unary_473(Y0,Y1,Y2,Y3,Y4)
                             ;  (is_BoolVarArgs(X4,Y4)
             ...
             ;  (is_TaskTypeArgs(X1,Y1)
                 -> (is_IntVarArgs(X2,Y2)
                     -> (is_IntArgs(X3,Y3)
                         -> (is_BoolVarArgs(X4,Y4)
                             -> (is_IntPropLevel(X5,Y5)
                                 -> gecode_constraint_unary_475(Y0,Y1,Y2,Y3,Y4,Y5)
                                 ;  throw(error(type_error('IntPropLevel'(X5)),gecode_argument_error(unary(X0,X1,X2,X3,X4,X5),arg=6))))
                             ;  throw(error(type_error('BoolVarArgs'(X4)),gecode_argument_error(unary(X0,X1,X2,X3,X4,X5),arg=5))))
