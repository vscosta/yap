...
def make_yapkernel_cmd(mod="yapkernel_launcher", executable=None, extra_arguments=None):
    ...
    Parameters
    ----------
    mod : str, optional (default 'yapkernel')
        A string of an YAP module whose __main__ starts an YAP kernel
...
def install(kernel_spec_manager=None, user=False, kernel_name=KERNEL_NAME, display_name=None,
    ...
    kernel_name : str, optional
        ...
        This is needed for having multiple YAP kernels for different environments.
