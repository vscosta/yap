...
#define __PYX_HAVE___yap____init__
#define __PYX_HAVE_API___yap____init__
#ifdef _OPENMP
#include <omp.h>
#endif /* _OPENMP */
...
/* Module declarations from '_yap.__init__' */
#define __Pyx_MODULE_NAME "_yap.__init__"
int __pyx_module_is_main__yap____init__ = 0;

/* Implementation of '_yap.__init__' */
static const char __pyx_k_yap[] = "_yap";
static const char __pyx_k_main[] = "__main__";
static const char __pyx_k_test[] = "__test__";
static PyObject *__pyx_n_s_main;
static PyObject *__pyx_n_s_test;
static PyObject *__pyx_n_u_yap;
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_u_yap, __pyx_k_yap, sizeof(__pyx_k_yap), 0, 1, 0, 1},
  {0, 0, 0, 0, 0, 0, 0}
};
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC init_yap(void); /*proto*/
PyMODINIT_FUNC init_yap(void)
#else
PyMODINIT_FUNC PyInit__yap(void); /*proto*/
PyMODINIT_FUNC PyInit__yap(void)
#endif
{
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit__yap(void)", 0);
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("_yap", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main__yap____init__) {
    if (PyObject_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  if (unlikely(__Pyx_SetPackagePathFromImportLib(NULL, __pyx_n_u_yap) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "_yap")) {
      if (unlikely(PyDict_SetItemString(modules, "_yap", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init _yap.__init__", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init _yap.__init__");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
