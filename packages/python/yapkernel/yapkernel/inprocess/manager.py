...
class InProcessKernelManager(KernelManager):
    ...
    kernel = Instance("yapkernel.inprocess.ipkernel.InProcessKernel", allow_none=True)
    # the client class for KM.client() shortcut
    client_class = DottedObjectName("yapkernel.inprocess.BlockingInProcessKernelClient")
