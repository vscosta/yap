...
class YAPKernel(KernelBase):
    ...
    use_experimental_completions = Bool(False,
        help="Unset this flag to False to deactivate the use of experimental IPython completion APIs and use Prolog completion.",
    ).tag(config=True)
