...
import warnings
warnings.warn("yapkernel.datapub is deprecated. It has moved to ipyparallel.datapub",
    DeprecationWarning,
    stacklevel=2
)
...
try:
    ...
    # Deprecated since yapkernel 4.3.0
    from yapkernel.serialize import serialize_object
