             ...
             -> (is_TupleSet(X2,Y2)
                 -> (is_bool(X3,Y3)
                     -> (is_IntPropLevel(X4,Y4)
                         ...
                         ;  (is_Reify(X4,Y4)
                             -> gecode_constraint_extensional_249(Y0,Y1,Y2,Y3,Y4)
                 ...
                 -> (is_TupleSet(X2,Y2)
                     -> (is_bool(X3,Y3)
                         -> (is_IntPropLevel(X4,Y4)
                             ...
                             ;  (is_Reify(X4,Y4)
                                 -> gecode_constraint_extensional_255(Y0,Y1,Y2,Y3,Y4)
                                 ;  throw(error(type_error('Reify'(X4)),gecode_argument_error(extensional(X0,X1,X2,X3,X4),arg=5)))))
                         ;  throw(error(type_error(bool(X3)),gecode_argument_error(extensional(X0,X1,X2,X3,X4),arg=4))))
                     ;  throw(error(type_error('TupleSet'(X2)),gecode_argument_error(extensional(X0,X1,X2,X3,X4),arg=3))))
         ...
         -> (is_BoolVarArgs(X1,Y1)
             -> (is_TupleSet(X2,Y2)
                 -> (is_bool(X3,Y3)
                     -> (is_Reify(X4,Y4)
                         -> (is_IntPropLevel(X5,Y5)
                             -> gecode_constraint_extensional_250(Y0,Y1,Y2,Y3,Y4,Y5)
             ...
             ;  (is_IntVarArgs(X1,Y1)
                 -> (is_TupleSet(X2,Y2)
                     -> (is_bool(X3,Y3)
                         -> (is_Reify(X4,Y4)
                             -> (is_IntPropLevel(X5,Y5)
                                 -> gecode_constraint_extensional_256(Y0,Y1,Y2,Y3,Y4,Y5)
                                 ;  throw(error(type_error('IntPropLevel'(X5)),gecode_argument_error(extensional(X0,X1,X2,X3,X4,X5),arg=6))))
                             ;  throw(error(type_error('Reify'(X4)),gecode_argument_error(extensional(X0,X1,X2,X3,X4,X5),arg=5))))
                         ;  throw(error(type_error(bool(X3)),gecode_argument_error(extensional(X0,X1,X2,X3,X4,X5),arg=4))))
                     ;  throw(error(type_error('TupleSet'(X2)),gecode_argument_error(extensional(X0,X1,X2,X3,X4,X5),arg=3))))
        ...
        (is_Space_or_Clause(X0,Y0)
         -> (is_BoolVar(X1,Y1)
             -> (is_BoolVar(X2,Y2)
                 -> (is_BoolVar(X3,Y3)
                     -> (is_BoolVar(X4,Y4)
                         -> gecode_constraint_ite_257(Y0,Y1,Y2,Y3,Y4)
                 ...
                 ;  (is_FloatVar(X2,Y2)
                     -> (is_FloatVar(X3,Y3)
                         -> (is_FloatVar(X4,Y4)
                             -> gecode_constraint_ite_259(Y0,Y1,Y2,Y3,Y4)
                     ...
                     ;  (is_IntVar(X2,Y2)
                         -> (is_IntVar(X3,Y3)
                             -> (is_IntVar(X4,Y4)
                                 -> gecode_constraint_ite_260(Y0,Y1,Y2,Y3,Y4)
         ...
         -> (is_BoolVar(X1,Y1)
             -> (is_BoolVar(X2,Y2)
                 -> (is_BoolVar(X3,Y3)
                     -> (is_BoolVar(X4,Y4)
                         -> (is_IntPropLevel(X5,Y5)
                             -> gecode_constraint_ite_258(Y0,Y1,Y2,Y3,Y4,Y5)
                 ...
                 ;  (is_IntVar(X2,Y2)
                     -> (is_IntVar(X3,Y3)
                         -> (is_IntVar(X4,Y4)
                             -> (is_IntPropLevel(X5,Y5)
                                 -> gecode_constraint_ite_261(Y0,Y1,Y2,Y3,Y4,Y5)
                                 ;  throw(error(type_error('IntPropLevel'(X5)),gecode_argument_error(ite(X0,X1,X2,X3,X4,X5),arg=6))))
         ...
         -> (is_BoolVarArgs(X1,Y1)
             -> (is_IntRelType(X2,Y2)
                 -> (is_IntVar(X3,Y3)
                     ...
                     ;  (is_int(X3,Y3)
                         -> gecode_constraint_linear_267(Y0,Y1,Y2,Y3)
             ...
             ;  (is_FloatVarArgs(X1,Y1)
                 -> (is_FloatRelType(X2,Y2)
                     -> (is_FloatVal(X3,Y3)
                         -> gecode_constraint_linear_275(Y0,Y1,Y2,Y3)
                         ;  (is_FloatVar(X3,Y3)
                             -> gecode_constraint_linear_277(Y0,Y1,Y2,Y3)
                 ...
                 ;  (is_IntVarArgs(X1,Y1)
                     -> (is_IntRelType(X2,Y2)
                         -> (is_IntVar(X3,Y3)
                             ...
                             ;  (is_int(X3,Y3)
                                 -> gecode_constraint_linear_299(Y0,Y1,Y2,Y3)
                                 ;  throw(error(type_error(int(X3)),gecode_argument_error(linear(X0,X1,X2,X3),arg=4)))))
                         ;  throw(error(type_error('IntRelType'(X2)),gecode_argument_error(linear(X0,X1,X2,X3),arg=3))))
             ...
             ;  (is_FloatValArgs(X1,Y1)
                 -> (is_FloatVarArgs(X2,Y2)
                     -> (is_FloatRelType(X3,Y3)
                         -> (is_FloatVal(X4,Y4)
                             -> (is_Reify(X5,Y5)
                                 -> gecode_constraint_linear_272(Y0,Y1,Y2,Y3,Y4,Y5)
                                 ;  throw(error(type_error('Reify'(X5)),gecode_argument_error(linear(X0,X1,X2,X3,X4,X5),arg=6))))
                             ;  (is_FloatVar(X4,Y4)
                                 -> (is_Reify(X5,Y5)
                                     -> gecode_constraint_linear_274(Y0,Y1,Y2,Y3,Y4,Y5)
                                     ;  throw(error(type_error('Reify'(X5)),gecode_argument_error(linear(X0,X1,X2,X3,X4,X5),arg=6))))
                     ...
                     -> (is_IntRelType(X3,Y3)
                         -> (is_IntVar(X4,Y4)
                             ...
                             ;  (is_int(X4,Y4)
                                 -> (is_Reify(X5,Y5)
                                     -> (is_IntPropLevel(X6,Y6)
                                         -> gecode_constraint_linear_294(Y0,Y1,Y2,Y3,Y4,Y5,Y6)
                                         ;  throw(error(type_error('IntPropLevel'(X6)),gecode_argument_error(linear(X0,X1,X2,X3,X4,X5,X6),arg=7))))
                                     ;  throw(error(type_error('Reify'(X5)),gecode_argument_error(linear(X0,X1,X2,X3,X4,X5,X6),arg=6))))
                                 ;  throw(error(type_error(int(X4)),gecode_argument_error(linear(X0,X1,X2,X3,X4,X5,X6),arg=5)))))
                         ;  throw(error(type_error('IntRelType'(X3)),gecode_argument_error(linear(X0,X1,X2,X3,X4,X5,X6),arg=4))))
...
max(X0,X1,X2,X3) :-
        (is_Space_or_Clause(X0,Y0)
         -> (is_FloatVar(X1,Y1)
             -> (is_FloatVar(X2,Y2)
                 -> (is_FloatVar(X3,Y3)
                     -> gecode_constraint_max_303(Y0,Y1,Y2,Y3)
        ...
        (is_Space_or_Clause(X0,Y0)
         -> (is_IntVar(X1,Y1)
             -> (is_IntVar(X2,Y2)
                 -> (is_IntVar(X3,Y3)
                     -> (is_IntPropLevel(X4,Y4)
                         -> gecode_constraint_max_305(Y0,Y1,Y2,Y3,Y4)
...
member(X0,X1,X2) :-
        (is_Space_or_Clause(X0,Y0)
         -> (is_BoolVarArgs(X1,Y1)
             ...
             ;  (is_IntVarArgs(X1,Y1)
                 -> (is_IntVar(X2,Y2)
                     -> gecode_constraint_member_313(Y0,Y1,Y2)
             ...
             ;  (is_IntVarArgs(X1,Y1)
                 -> (is_IntVar(X2,Y2)
                     -> (is_IntPropLevel(X3,Y3)
                         ...
                         ;  (is_Reify(X3,Y3)
                             -> gecode_constraint_member_315(Y0,Y1,Y2,Y3)
                             ;  throw(error(type_error('Reify'(X3)),gecode_argument_error(member(X0,X1,X2,X3),arg=4)))))
         ...
         -> (is_BoolVarArgs(X1,Y1)
             ...
             ;  (is_IntVarArgs(X1,Y1)
                 -> (is_IntVar(X2,Y2)
                     -> (is_Reify(X3,Y3)
                         -> (is_IntPropLevel(X4,Y4)
                             -> gecode_constraint_member_316(Y0,Y1,Y2,Y3,Y4)
                             ;  throw(error(type_error('IntPropLevel'(X4)),gecode_argument_error(member(X0,X1,X2,X3,X4),arg=5))))
                         ;  throw(error(type_error('Reify'(X3)),gecode_argument_error(member(X0,X1,X2,X3,X4),arg=4))))
...
mod(X0,X1,X2,X3) :-
        (is_Space_or_Clause(X0,Y0)
         -> (is_IntVar(X1,Y1)
             -> (is_IntVar(X2,Y2)
                 -> (is_IntVar(X3,Y3)
                     -> gecode_constraint_mod_323(Y0,Y1,Y2,Y3)
        ...
        (is_Space_or_Clause(X0,Y0)
         -> (is_IntVar(X1,Y1)
             -> (is_IntVar(X2,Y2)
                 -> (is_IntVar(X3,Y3)
                     -> (is_IntPropLevel(X4,Y4)
                         -> gecode_constraint_mod_324(Y0,Y1,Y2,Y3,Y4)
        ...
        (is_Space_or_Clause(X0,Y0)
         -> (is_FloatVar(X1,Y1)
             ...
             ;  (is_IntVar(X1,Y1)
                 -> (is_IntVar(X2,Y2)
                     -> (is_IntVar(X3,Y3)
                         -> gecode_constraint_mult_326(Y0,Y1,Y2,Y3)
        ...
        (is_Space_or_Clause(X0,Y0)
         -> (is_IntVar(X1,Y1)
             -> (is_IntVar(X2,Y2)
                 -> (is_IntVar(X3,Y3)
                     -> (is_IntPropLevel(X4,Y4)
                         -> gecode_constraint_mult_327(Y0,Y1,Y2,Y3,Y4)
        ...
        (is_Space_or_Clause(X0,Y0)
         -> (is_IntVarArgs(X1,Y1)
             -> (is_IntArgs(X2,Y2)
                 -> (is_IntVarArgs(X3,Y3)
                     -> (is_IntArgs(X4,Y4)
                         -> gecode_constraint_nooverlap_328(Y0,Y1,Y2,Y3,Y4)
         ...
         -> (is_IntVarArgs(X1,Y1)
             -> (is_IntArgs(X2,Y2)
                 -> (is_IntVarArgs(X3,Y3)
                     -> (is_IntArgs(X4,Y4)
                         -> (is_IntPropLevel(X5,Y5)
                             -> gecode_constraint_nooverlap_329(Y0,Y1,Y2,Y3,Y4,Y5)
                             ;  (is_BoolVarArgs(X5,Y5)
             ...
             -> (is_IntArgs(X2,Y2)
                 -> (is_IntVarArgs(X3,Y3)
                     -> (is_IntArgs(X4,Y4)
                         -> (is_BoolVarArgs(X5,Y5)
                             -> (is_IntPropLevel(X6,Y6)
                                 -> gecode_constraint_nooverlap_331(Y0,Y1,Y2,Y3,Y4,Y5,Y6)
                 ...
                 ;  (is_IntVarArgs(X2,Y2)
                     -> (is_IntVarArgs(X3,Y3)
                         -> (is_IntVarArgs(X4,Y4)
                             -> (is_IntVarArgs(X5,Y5)
                                 -> (is_IntVarArgs(X6,Y6)
                                     -> gecode_constraint_nooverlap_332(Y0,Y1,Y2,Y3,Y4,Y5,Y6)
                 ...
                 -> (is_IntVarArgs(X3,Y3)
                     -> (is_IntVarArgs(X4,Y4)
                         -> (is_IntVarArgs(X5,Y5)
                             -> (is_IntVarArgs(X6,Y6)
                                 -> (is_IntPropLevel(X7,Y7)
                                     -> gecode_constraint_nooverlap_333(Y0,Y1,Y2,Y3,Y4,Y5,Y6,Y7)
                     ...
                     -> (is_IntVarArgs(X4,Y4)
                         -> (is_IntVarArgs(X5,Y5)
                             -> (is_IntVarArgs(X6,Y6)
                                 -> (is_BoolVarArgs(X7,Y7)
                                     -> (is_IntPropLevel(X8,Y8)
                                         -> gecode_constraint_nooverlap_335(Y0,Y1,Y2,Y3,Y4,Y5,Y6,Y7,Y8)
...
nroot(X0,X1,X2,X3) :-
        (is_Space_or_Clause(X0,Y0)
         -> (is_FloatVar(X1,Y1)
             -> (is_int(X2,Y2)
                 -> (is_FloatVar(X3,Y3)
                     -> gecode_constraint_nroot_336(Y0,Y1,Y2,Y3)
        ...
        (is_Space_or_Clause(X0,Y0)
         -> (is_IntVar(X1,Y1)
             -> (is_int(X2,Y2)
                 -> (is_IntVar(X3,Y3)
                     -> (is_IntPropLevel(X4,Y4)
                         -> gecode_constraint_nroot_338(Y0,Y1,Y2,Y3,Y4)
        ...
        (is_Space_or_Clause(X0,Y0)
         -> (is_BoolVarArgs(X1,Y1)
             ...
             ;  (is_IntVarArgs(X1,Y1)
                 -> (is_IntRelType(X2,Y2)
                     -> (is_IntVar(X3,Y3)
                         -> gecode_constraint_nvalues_343(Y0,Y1,Y2,Y3)
                         ;  (is_int(X3,Y3)
                             -> gecode_constraint_nvalues_345(Y0,Y1,Y2,Y3)
                             ;  throw(error(type_error(int(X3)),gecode_argument_error(nvalues(X0,X1,X2,X3),arg=4)))))
                     ;  throw(error(type_error('IntRelType'(X2)),gecode_argument_error(nvalues(X0,X1,X2,X3),arg=3))))
         ...
         -> (is_BoolVarArgs(X1,Y1)
             ...
             ;  (is_IntVarArgs(X1,Y1)
                 -> (is_IntRelType(X2,Y2)
                     -> (is_IntVar(X3,Y3)
                         -> (is_IntPropLevel(X4,Y4)
                             -> gecode_constraint_nvalues_344(Y0,Y1,Y2,Y3,Y4)
                             ;  throw(error(type_error('IntPropLevel'(X4)),gecode_argument_error(nvalues(X0,X1,X2,X3,X4),arg=5))))
                         ;  (is_int(X3,Y3)
                             -> (is_IntPropLevel(X4,Y4)
                                 -> gecode_constraint_nvalues_346(Y0,Y1,Y2,Y3,Y4)
                                 ;  throw(error(type_error('IntPropLevel'(X4)),gecode_argument_error(nvalues(X0,X1,X2,X3,X4),arg=5))))
                             ;  throw(error(type_error(int(X3)),gecode_argument_error(nvalues(X0,X1,X2,X3,X4),arg=4)))))
                     ;  throw(error(type_error('IntRelType'(X2)),gecode_argument_error(nvalues(X0,X1,X2,X3,X4),arg=3))))
         ...
         -> (is_IntArgs(X1,Y1)
             -> (is_IntVarArgs(X2,Y2)
                 -> (is_IntVar(X3,Y3)
                     -> (is_IntVar(X4,Y4)
                         -> (is_IntVar(X5,Y5)
                             -> gecode_constraint_path_347(Y0,Y1,Y2,Y3,Y4,Y5)
             ...
             ;  (is_int(X1,Y1)
                 -> (is_IntVarArgs(X2,Y2)
                     -> (is_IntVar(X3,Y3)
                         -> (is_IntVar(X4,Y4)
                             -> (is_IntPropLevel(X5,Y5)
                                 -> gecode_constraint_path_358(Y0,Y1,Y2,Y3,Y4,Y5)
                 ...
                 -> (is_IntVar(X3,Y3)
                     -> (is_IntVar(X4,Y4)
                         -> (is_IntVar(X5,Y5)
                             ...
                             ;  (is_IntVarArgs(X5,Y5)
                                 -> (is_IntVar(X6,Y6)
                                     -> gecode_constraint_path_349(Y0,Y1,Y2,Y3,Y4,Y5,Y6)
                 ...
                 -> (is_IntVar(X3,Y3)
                     -> (is_IntVar(X4,Y4)
                         -> (is_IntVarArgs(X5,Y5)
                             -> (is_IntVar(X6,Y6)
                                 -> (is_IntPropLevel(X7,Y7)
                                     -> gecode_constraint_path_350(Y0,Y1,Y2,Y3,Y4,Y5,Y6,Y7)
                         ...
                         -> (is_IntVar(X4,Y4)
                             -> (is_IntVar(X5,Y5)
                                 -> (is_IntVar(X6,Y6)
                                     ...
                                     ;  (is_IntVarArgs(X6,Y6)
                                         -> (is_IntVar(X7,Y7)
                                             -> gecode_constraint_path_353(Y0,Y1,Y2,Y3,Y4,Y5,Y6,Y7)
                     ...
                     -> (is_IntVar(X4,Y4)
                         -> (is_IntVar(X5,Y5)
                             -> (is_IntVarArgs(X6,Y6)
                                 -> (is_IntVar(X7,Y7)
                                     -> (is_IntPropLevel(X8,Y8)
                                         -> gecode_constraint_path_354(Y0,Y1,Y2,Y3,Y4,Y5,Y6,Y7,Y8)
...
path(X0,X1,X2,X3) :-
        (is_Space_or_Clause(X0,Y0)
         -> (is_IntVarArgs(X1,Y1)
             -> (is_IntVar(X2,Y2)
                 -> (is_IntVar(X3,Y3)
                     -> gecode_constraint_path_355(Y0,Y1,Y2,Y3)
        ...
        (is_Space_or_Clause(X0,Y0)
         -> (is_IntVarArgs(X1,Y1)
             -> (is_IntVar(X2,Y2)
                 -> (is_IntVar(X3,Y3)
                     -> (is_IntPropLevel(X4,Y4)
                         -> gecode_constraint_path_356(Y0,Y1,Y2,Y3,Y4)
...
pow(X0,X1,X2,X3) :-
        (is_Space_or_Clause(X0,Y0)
         -> (is_FloatVar(X1,Y1)
             -> (is_int(X2,Y2)
                 -> (is_FloatVar(X3,Y3)
                     -> gecode_constraint_pow_359(Y0,Y1,Y2,Y3)
        ...
        (is_Space_or_Clause(X0,Y0)
         -> (is_IntVar(X1,Y1)
             -> (is_int(X2,Y2)
                 -> (is_IntVar(X3,Y3)
                     -> (is_IntPropLevel(X4,Y4)
                         -> gecode_constraint_pow_361(Y0,Y1,Y2,Y3,Y4)
...
precede(X0,X1,X2) :-
        (is_Space_or_Clause(X0,Y0)
         -> (is_IntVarArgs(X1,Y1)
             -> (is_IntArgs(X2,Y2)
                 -> gecode_constraint_precede_362(Y0,Y1,Y2)
...
precede(X0,X1,X2,X3) :-
        (is_Space_or_Clause(X0,Y0)
         -> (is_IntVarArgs(X1,Y1)
             -> (is_IntArgs(X2,Y2)
                 -> (is_IntPropLevel(X3,Y3)
                     -> gecode_constraint_precede_363(Y0,Y1,Y2,Y3)
        ...
        (is_Space_or_Clause(X0,Y0)
         -> (is_IntVarArgs(X1,Y1)
             -> (is_int(X2,Y2)
                 -> (is_int(X3,Y3)
                     -> (is_IntPropLevel(X4,Y4)
                         -> gecode_constraint_precede_365(Y0,Y1,Y2,Y3,Y4)
...
rel(X0,X1,X2,X3) :-
        (is_Space_or_Clause(X0,Y0)
         -> (is_BoolOpType(X1,Y1)
             -> (is_BoolVarArgs(X2,Y2)
                 -> (is_BoolVar(X3,Y3)
                     -> gecode_constraint_rel_366(Y0,Y1,Y2,Y3)
                     ;  (is_int(X3,Y3)
                         -> gecode_constraint_rel_368(Y0,Y1,Y2,Y3)
                 ...
                 ;  (is_FloatVar(X1,Y1)
                     -> (is_FloatRelType(X2,Y2)
                         -> (is_FloatVal(X3,Y3)
                             ...
                             ;  (is_FloatVar(X3,Y3)
                                 -> gecode_constraint_rel_384(Y0,Y1,Y2,Y3)
                                                     ...
                                                     ;  (is_IntVar(X3,Y3)
                                                         ...
                                                         ;  (is_IntArgs(X3,Y3)
                                                             ...
                                                             ;  (is_IntVarArgs(X3,Y3)
                                                                 ...
                                                                 ;  (is_int(X3,Y3)
                                                                     -> gecode_constraint_rel_426(Y0,Y1,Y2,Y3)
                                                                     ;  throw(error(type_error(int(X3)),gecode_argument_error(rel(X0,X1,X2,X3),arg=4))))))))
                                                 ;  throw(error(type_error('IntRelType'(X2)),gecode_argument_error(rel(X0,X1,X2,X3),arg=3))))
                         ...
                         -> (is_BoolVar(X3,Y3)
                             ...
                             ;  (is_int(X3,Y3)
                                 -> (is_IntPropLevel(X4,Y4)
                                     ...
                                     ;  (is_Reify(X4,Y4)
                                         -> gecode_constraint_rel_380(Y0,Y1,Y2,Y3,Y4)
                                         ;  throw(error(type_error('Reify'(X4)),gecode_argument_error(rel(X0,X1,X2,X3,X4),arg=5)))))
                                 ;  throw(error(type_error(int(X3)),gecode_argument_error(rel(X0,X1,X2,X3,X4),arg=4)))))
                                             ...
                                             -> (is_IntVar(X3,Y3)
                                                 ...
                                                 ;  (is_IntArgs(X3,Y3)
                                                     ...
                                                     ;  (is_IntVarArgs(X3,Y3)
                                                         ...
                                                         ;  (is_int(X3,Y3)
                                                             -> (is_IntPropLevel(X4,Y4)
                                                                 -> gecode_constraint_rel_427(Y0,Y1,Y2,Y3,Y4)
                                                                 ;  throw(error(type_error('IntPropLevel'(X4)),gecode_argument_error(rel(X0,X1,X2,X3,X4),arg=5))))
                                                             ;  throw(error(type_error(int(X3)),gecode_argument_error(rel(X0,X1,X2,X3,X4),arg=4)))))))
                                             ;  throw(error(type_error('IntRelType'(X2)),gecode_argument_error(rel(X0,X1,X2,X3,X4),arg=3))))
         ...
         -> (is_BoolVar(X1,Y1)
             -> (is_BoolOpType(X2,Y2)
                 -> (is_BoolVar(X3,Y3)
                     -> (is_BoolVar(X4,Y4)
                         -> (is_IntPropLevel(X5,Y5)
                             -> gecode_constraint_rel_371(Y0,Y1,Y2,Y3,Y4,Y5)
                 ...
                 ;  (is_IntRelType(X2,Y2)
                     -> (is_BoolVar(X3,Y3)
                         ...
                         ;  (is_int(X3,Y3)
                             -> (is_Reify(X4,Y4)
                                 -> (is_IntPropLevel(X5,Y5)
                                     -> gecode_constraint_rel_381(Y0,Y1,Y2,Y3,Y4,Y5)
                                     ;  throw(error(type_error('IntPropLevel'(X5)),gecode_argument_error(rel(X0,X1,X2,X3,X4,X5),arg=6))))
                                 ;  throw(error(type_error('Reify'(X4)),gecode_argument_error(rel(X0,X1,X2,X3,X4,X5),arg=5))))
        ...
        (is_Space_or_Clause(X0,Y0)
         -> (is_SetVarArgs(X1,Y1)
             -> (is_SetVarArgs(X2,Y2)
                 -> (is_Rnd(X3,Y3)
                     -> (is_double(X4,Y4)
                         -> gecode_constraint_relax_428(Y0,Y1,Y2,Y3,Y4)
         ...
         -> (is_BoolVarArgs(X1,Y1)
             -> (is_IntSet(X2,Y2)
                 -> (is_int(X3,Y3)
                     -> (is_int(X4,Y4)
                         -> (is_int(X5,Y5)
                             -> gecode_constraint_sequence_429(Y0,Y1,Y2,Y3,Y4,Y5)
             ...
             ;  (is_IntVarArgs(X1,Y1)
                 -> (is_IntSet(X2,Y2)
                     -> (is_int(X3,Y3)
                         -> (is_int(X4,Y4)
                             -> (is_int(X5,Y5)
                                 -> gecode_constraint_sequence_431(Y0,Y1,Y2,Y3,Y4,Y5)
                                 ;  throw(error(type_error(int(X5)),gecode_argument_error(sequence(X0,X1,X2,X3,X4,X5),arg=6))))
                             ;  throw(error(type_error(int(X4)),gecode_argument_error(sequence(X0,X1,X2,X3,X4,X5),arg=5))))
                         ;  throw(error(type_error(int(X3)),gecode_argument_error(sequence(X0,X1,X2,X3,X4,X5),arg=4))))
                     ;  throw(error(type_error('IntSet'(X2)),gecode_argument_error(sequence(X0,X1,X2,X3,X4,X5),arg=3))))
             ...
             -> (is_IntSet(X2,Y2)
                 -> (is_int(X3,Y3)
                     -> (is_int(X4,Y4)
                         -> (is_int(X5,Y5)
                             -> (is_IntPropLevel(X6,Y6)
                                 -> gecode_constraint_sequence_430(Y0,Y1,Y2,Y3,Y4,Y5,Y6)
                 ...
                 -> (is_IntSet(X2,Y2)
                     -> (is_int(X3,Y3)
                         -> (is_int(X4,Y4)
                             -> (is_int(X5,Y5)
                                 -> (is_IntPropLevel(X6,Y6)
                                     -> gecode_constraint_sequence_432(Y0,Y1,Y2,Y3,Y4,Y5,Y6)
                                     ;  throw(error(type_error('IntPropLevel'(X6)),gecode_argument_error(sequence(X0,X1,X2,X3,X4,X5,X6),arg=7))))
                                 ;  throw(error(type_error(int(X5)),gecode_argument_error(sequence(X0,X1,X2,X3,X4,X5,X6),arg=6))))
                             ;  throw(error(type_error(int(X4)),gecode_argument_error(sequence(X0,X1,X2,X3,X4,X5,X6),arg=5))))
                         ;  throw(error(type_error(int(X3)),gecode_argument_error(sequence(X0,X1,X2,X3,X4,X5,X6),arg=4))))
...
sorted(X0,X1,X2) :-
        (is_Space_or_Clause(X0,Y0)
         -> (is_IntVarArgs(X1,Y1)
             -> (is_IntVarArgs(X2,Y2)
                 -> gecode_constraint_sorted_433(Y0,Y1,Y2)
...
sorted(X0,X1,X2,X3) :-
        (is_Space_or_Clause(X0,Y0)
         -> (is_IntVarArgs(X1,Y1)
             -> (is_IntVarArgs(X2,Y2)
                 -> (is_IntPropLevel(X3,Y3)
                     -> gecode_constraint_sorted_434(Y0,Y1,Y2,Y3)
                     ;  (is_IntVarArgs(X3,Y3)
                         -> gecode_constraint_sorted_435(Y0,Y1,Y2,Y3)
        ...
        (is_Space_or_Clause(X0,Y0)
         -> (is_IntVarArgs(X1,Y1)
             -> (is_IntVarArgs(X2,Y2)
                 -> (is_IntVarArgs(X3,Y3)
                     -> (is_IntPropLevel(X4,Y4)
                         -> gecode_constraint_sorted_436(Y0,Y1,Y2,Y3,Y4)
...
sqr(X0,X1,X2,X3) :-
        (is_Space_or_Clause(X0,Y0)
         -> (is_IntVar(X1,Y1)
             -> (is_IntVar(X2,Y2)
                 -> (is_IntPropLevel(X3,Y3)
                     -> gecode_constraint_sqr_439(Y0,Y1,Y2,Y3)
...
sqrt(X0,X1,X2,X3) :-
        (is_Space_or_Clause(X0,Y0)
         -> (is_IntVar(X1,Y1)
             -> (is_IntVar(X2,Y2)
                 -> (is_IntPropLevel(X3,Y3)
                     -> gecode_constraint_sqrt_442(Y0,Y1,Y2,Y3)
...
unary(X0,X1,X2) :-
        (is_Space_or_Clause(X0,Y0)
         -> (is_IntVarArgs(X1,Y1)
             -> (is_IntArgs(X2,Y2)
                 -> gecode_constraint_unary_443(Y0,Y1,Y2)
...
unary(X0,X1,X2,X3) :-
        (is_Space_or_Clause(X0,Y0)
         -> (is_IntVarArgs(X1,Y1)
             -> (is_IntArgs(X2,Y2)
                 -> (is_IntPropLevel(X3,Y3)
                     -> gecode_constraint_unary_444(Y0,Y1,Y2,Y3)
                     ;  (is_BoolVarArgs(X3,Y3)
                         -> gecode_constraint_unary_445(Y0,Y1,Y2,Y3)
             ...
             ;  (is_TaskTypeArgs(X1,Y1)
                 -> (is_IntVarArgs(X2,Y2)
                     -> (is_IntArgs(X3,Y3)
                         -> gecode_constraint_unary_451(Y0,Y1,Y2,Y3)
        ...
        (is_Space_or_Clause(X0,Y0)
         -> (is_IntVarArgs(X1,Y1)
             -> (is_IntArgs(X2,Y2)
                 -> (is_BoolVarArgs(X3,Y3)
                     -> (is_IntPropLevel(X4,Y4)
                         -> gecode_constraint_unary_446(Y0,Y1,Y2,Y3,Y4)
             ...
             ;  (is_TaskTypeArgs(X1,Y1)
                 -> (is_IntVarArgs(X2,Y2)
                     -> (is_IntArgs(X3,Y3)
                         -> (is_IntPropLevel(X4,Y4)
                             -> gecode_constraint_unary_452(Y0,Y1,Y2,Y3,Y4)
                             ;  (is_BoolVarArgs(X4,Y4)
...
unshare(X0,X1) :-
        (is_Space_or_Clause(X0,Y0)
         -> (is_BoolVarArgs(X1,Y1)
             -> gecode_constraint_unshare_455(Y0,Y1)
             ;  (is_IntVarArgs(X1,Y1)
                 -> gecode_constraint_unshare_457(Y0,Y1)
        ...
        (is_Space_or_Clause(X0,Y0)
         -> (is_BoolVar(X1,Y1)
             -> (is_std_function(X2,Y2)
                 -> gecode_constraint_when_459(Y0,Y1,Y2)
...
when(X0,X1,X2,X3) :-
        (is_Space_or_Clause(X0,Y0)
         -> (is_BoolVar(X1,Y1)
             -> (is_std_function(X2,Y2)
                 -> (is_IntPropLevel(X3,Y3)
                     -> gecode_constraint_when_460(Y0,Y1,Y2,Y3)
                     ;  (is_std_function(X3,Y3)
                         -> gecode_constraint_when_461(Y0,Y1,Y2,Y3)
        ...
        (is_Space_or_Clause(X0,Y0)
         -> (is_BoolVar(X1,Y1)
             -> (is_std_function(X2,Y2)
                 -> (is_std_function(X3,Y3)
                     -> (is_IntPropLevel(X4,Y4)
                         -> gecode_constraint_when_462(Y0,Y1,Y2,Y3,Y4)
