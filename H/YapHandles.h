...
staticvoid Yap_RebootHandles__(int wid USES_REGS) {
...
staticbool Yap_RecoverHandles__(int n, yhandle_t topHandle USES_REGS);
staticbool Yap_RecoverHandles__(int n, yhandle_t topHandle USES_REGS) {
...
staticTerm Yap_PopHandle__(yhandle_t topHandle USES_REGS);
staticTerm Yap_PopHandle__(yhandle_t topHandle USES_REGS) {
