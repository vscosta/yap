# encoding: utf-8
"""
Utilities for getting information about yap_ipython and the system it's running in.
"""
...
from yap_ipython.utils import py3compat, _sysinfo, encoding
...
def pkg_commit_hash(pkg_path):
    ...
    * yap_ipython.utils._sysinfo.commit
...
def get_sys_info():
    """Return useful information about yap_ipython and the system, as a dict."""
    p = os.path
...
def sys_info():
    """Return useful information about yap_ipython and the system, as a string.
    ...
    ::
        ...
        {'commit_hash': '144fdae',      # random
         ...
         'ipython_path': '/home/fperez/usr/lib/python2.6/site-packages/yap_ipython',
