...
class IOStream:
    ...
    def __init__(self, stream, fallback=None):
        warn('IOStream is deprecated since yap_ipython 5.0, use sys.{stdin,stdout,stderr} instead',
...
def atomic_writing(*args, **kwargs):
    ...
    warn("yap_ipython.utils.io.atomic_writing has moved to notebook.services.contents.fileio", stacklevel=2)
...
def unicode_std_stream(stream='stdout'):
    ...
    warn("yap_ipython.utils.io.unicode_std_stream has moved to nbconvert.utils.io", stacklevel=2)
