...
/// @file YapErrors.h
///
/// @newgroup YapError Internal Error Handling Codes
/// @addtogroup YapError
///
...
ECLASS(USER_DEFINED_ERROR_CLASS, "user_defined_error", 1)
...
E(DOMAIN_ERROR_USER_DEFINED, DOMAIN_ERROR, "user_defined")
...
E(EVALUATION_ERROR_R_ENVIRONMENT, EVALUATION_ERROR, "unspecified error in R environment")
E(EVALUATION_ERROR_READ_STREAM, EVALUATION_ERROR, "read_from_stream")
E(EVALUATION_ERROR_PYTHON_ENVIRONMENT, EVALUATION_ERROR, "unspecified error in Python environment")
...
E(EVALUATION_ERROR_UNDERFLOW, EVALUATION_ERROR, "underflow")
  ...
  E(EVALUATION_ERROR_USER_DEFINED, EVALUATION_ERROR, "user_defined")
...
E(EXISTENCE_ERROR_VARIABLE, EXISTENCE_ERROR, "variable")
  E(EXISTENCE_ERROR_USER_DEFINED, EXISTENCE_ERROR, "user_defined")
...
E(PERMISSION_ERROR_USER_DEFINED, PERMISSION_ERROR, "user_defined")

E(
  REPRESENTATION_ERROR_CHARACTER, REPRESENTATION_ERROR, "character")
...
E(REPRESENTATION_ERROR_USER_DEFINED, REPRESENTATION_ERROR, "user_defined")
...
E(RESOURCE_ERROR_USER_DEFINED, RESOURCE_ERROR, "user_defined")
...
E(SYSTEM_ERROR_USER_DEFINED, SYSTEM_ERROR_CLASS, "user_defined")
