         ...
         -> (is_BoolVar(X1,Y1)
             ...
             ;  (is_BoolVarArgs(X1,Y1)
                 -> (is_BoolVarBranch(X2,Y2)
                     -> (is_BoolAssign(X3,Y3)
                         -> gecode_constraint_assign_3(Y0,Y1,Y2,Y3)
                     ...
                     ;  (is_BoolVarBranch(X2,Y2)
                         -> (is_BoolAssign(X3,Y3)
                             ...
                             ;  throw(error(type_error('BoolAssign'(X3)),gecode_argument_error(assign(X0,X1,X2,X3),arg=4))))
                         ;  throw(error(type_error('TieBreak<BoolVarBranch>'(X2)),gecode_argument_error(assign(X0,X1,X2,X3),arg=3)))))
                     ...
                     -> (is_FloatVarBranch(X2,Y2)
                         ...
                         ;  (is_FloatVarBranch(X2,Y2)
                             -> (is_FloatAssign(X3,Y3)
                                 ...
                                 ;  throw(error(type_error('FloatAssign'(X3)),gecode_argument_error(assign(X0,X1,X2,X3),arg=4))))
                             ;  throw(error(type_error('TieBreak<FloatVarBranch>'(X2)),gecode_argument_error(assign(X0,X1,X2,X3),arg=3)))))
                     ;  (is_IntVarArgs(X1,Y1)
                         -> (is_IntVarBranch(X2,Y2)
                             ...
                             ;  (is_IntVarBranch(X2,Y2)
                                 -> (is_IntAssign(X3,Y3)
                                     ...
                                     ;  throw(error(type_error('IntAssign'(X3)),gecode_argument_error(assign(X0,X1,X2,X3),arg=4))))
                                 ;  throw(error(type_error('TieBreak<IntVarBranch>'(X2)),gecode_argument_error(assign(X0,X1,X2,X3),arg=3)))))
                         ;  (is_SetVarArgs(X1,Y1)
                             -> (is_SetVarBranch(X2,Y2)
                                 ...
                                 ;  (is_SetVarBranch(X2,Y2)
                                     -> (is_SetAssign(X3,Y3)
                                         ...
                                         ;  throw(error(type_error('SetAssign'(X3)),gecode_argument_error(assign(X0,X1,X2,X3),arg=4))))
                                     ;  throw(error(type_error('TieBreak<SetVarBranch>'(X2)),gecode_argument_error(assign(X0,X1,X2,X3),arg=3)))))
                             ;  (is_FloatVar(X1,Y1)
                                 -> (is_FloatAssign(X2,Y2)
                                 ...
                                 ;  (is_IntVar(X1,Y1)
                                     -> (is_IntAssign(X2,Y2)
                                         -> (is_IntVarValPrint(X3,Y3)
                                             -> gecode_constraint_assign_30(Y0,Y1,Y2,Y3)
             ...
             -> (is_BoolVarBranch(X2,Y2)
                 -> (is_BoolAssign(X3,Y3)
                     -> (is_BoolBranchFilter(X4,Y4)
                         -> gecode_constraint_assign_4(Y0,Y1,Y2,Y3,Y4)
                 ...
                 ;  (is_BoolVarBranch(X2,Y2)
                     -> (is_BoolAssign(X3,Y3)
                         -> (is_IntBranchFilter(X4,Y4)
                             -> gecode_constraint_assign_7(Y0,Y1,Y2,Y3,Y4)
                             ;  throw(error(type_error('IntBranchFilter'(X4)),gecode_argument_error(assign(X0,X1,X2,X3,X4),arg=5))))
                         ;  throw(error(type_error('BoolAssign'(X3)),gecode_argument_error(assign(X0,X1,X2,X3,X4),arg=4))))
                     ;  throw(error(type_error('TieBreak<BoolVarBranch>'(X2)),gecode_argument_error(assign(X0,X1,X2,X3,X4),arg=3)))))
             ;  (is_FloatVarArgs(X1,Y1)
                 -> (is_FloatVarBranch(X2,Y2)
                     -> (is_FloatAssign(X3,Y3)
                     ...
                     ;  (is_FloatVarBranch(X2,Y2)
                         -> (is_FloatAssign(X3,Y3)
                             -> (is_FloatBranchFilter(X4,Y4)
                                 ...
                                 ;  throw(error(type_error('FloatBranchFilter'(X4)),gecode_argument_error(assign(X0,X1,X2,X3,X4),arg=5))))
                             ;  throw(error(type_error('FloatAssign'(X3)),gecode_argument_error(assign(X0,X1,X2,X3,X4),arg=4))))
                         ;  throw(error(type_error('TieBreak<FloatVarBranch>'(X2)),gecode_argument_error(assign(X0,X1,X2,X3,X4),arg=3)))))
                 ;  (is_IntVarArgs(X1,Y1)
                     -> (is_IntVarBranch(X2,Y2)
                         -> (is_IntAssign(X3,Y3)
                             -> (is_IntBranchFilter(X4,Y4)
                         ...
                         ;  (is_IntVarBranch(X2,Y2)
                             -> (is_IntAssign(X3,Y3)
                                 -> (is_IntBranchFilter(X4,Y4)
                                     ...
                                     ;  throw(error(type_error('IntBranchFilter'(X4)),gecode_argument_error(assign(X0,X1,X2,X3,X4),arg=5))))
                                 ;  throw(error(type_error('IntAssign'(X3)),gecode_argument_error(assign(X0,X1,X2,X3,X4),arg=4))))
                             ;  throw(error(type_error('TieBreak<IntVarBranch>'(X2)),gecode_argument_error(assign(X0,X1,X2,X3,X4),arg=3)))))
                     ;  (is_SetVarArgs(X1,Y1)
                         -> (is_SetVarBranch(X2,Y2)
                             -> (is_SetAssign(X3,Y3)
                                 -> (is_SetBranchFilter(X4,Y4)
                                     -> gecode_constraint_assign_22(Y0,Y1,Y2,Y3,Y4)
                             ...
                             ;  (is_SetVarBranch(X2,Y2)
                                 -> (is_SetAssign(X3,Y3)
                                     -> (is_SetBranchFilter(X4,Y4)
                                         -> gecode_constraint_assign_25(Y0,Y1,Y2,Y3,Y4)
                                         ;  throw(error(type_error('SetBranchFilter'(X4)),gecode_argument_error(assign(X0,X1,X2,X3,X4),arg=5))))
                                     ;  throw(error(type_error('SetAssign'(X3)),gecode_argument_error(assign(X0,X1,X2,X3,X4),arg=4))))
                                 ;  throw(error(type_error('TieBreak<SetVarBranch>'(X2)),gecode_argument_error(assign(X0,X1,X2,X3,X4),arg=3)))))
                 ...
                 -> (is_BoolAssign(X3,Y3)
                     -> (is_BoolBranchFilter(X4,Y4)
                         -> (is_BoolVarValPrint(X5,Y5)
                             -> gecode_constraint_assign_5(Y0,Y1,Y2,Y3,Y4,Y5)
                     ...
                     -> (is_BoolAssign(X3,Y3)
                         -> (is_IntBranchFilter(X4,Y4)
                             -> (is_IntVarValPrint(X5,Y5)
                                 -> gecode_constraint_assign_8(Y0,Y1,Y2,Y3,Y4,Y5)
                         ...
                         ;  throw(error(type_error('BoolAssign'(X3)),gecode_argument_error(assign(X0,X1,X2,X3,X4,X5),arg=4))))
                     ;  throw(error(type_error('TieBreak<BoolVarBranch>'(X2)),gecode_argument_error(assign(X0,X1,X2,X3,X4,X5),arg=3)))))
             ;  (is_FloatVarArgs(X1,Y1)
                 -> (is_FloatVarBranch(X2,Y2)
                     -> (is_FloatAssign(X3,Y3)
                         -> (is_FloatBranchFilter(X4,Y4)
                     ...
                     ;  (is_FloatVarBranch(X2,Y2)
                         -> (is_FloatAssign(X3,Y3)
                             -> (is_FloatBranchFilter(X4,Y4)
                                 ...
                                 ;  throw(error(type_error('FloatBranchFilter'(X4)),gecode_argument_error(assign(X0,X1,X2,X3,X4,X5),arg=5))))
                             ;  throw(error(type_error('FloatAssign'(X3)),gecode_argument_error(assign(X0,X1,X2,X3,X4,X5),arg=4))))
                         ;  throw(error(type_error('TieBreak<FloatVarBranch>'(X2)),gecode_argument_error(assign(X0,X1,X2,X3,X4,X5),arg=3)))))
                 ;  (is_IntVarArgs(X1,Y1)
                     -> (is_IntVarBranch(X2,Y2)
                         -> (is_IntAssign(X3,Y3)
                             -> (is_IntBranchFilter(X4,Y4)
                         ...
                         ;  (is_IntVarBranch(X2,Y2)
                             -> (is_IntAssign(X3,Y3)
                                 -> (is_IntBranchFilter(X4,Y4)
                                     ...
                                     ;  throw(error(type_error('IntBranchFilter'(X4)),gecode_argument_error(assign(X0,X1,X2,X3,X4,X5),arg=5))))
                                 ;  throw(error(type_error('IntAssign'(X3)),gecode_argument_error(assign(X0,X1,X2,X3,X4,X5),arg=4))))
                             ;  throw(error(type_error('TieBreak<IntVarBranch>'(X2)),gecode_argument_error(assign(X0,X1,X2,X3,X4,X5),arg=3)))))
                     ;  (is_SetVarArgs(X1,Y1)
                         -> (is_SetVarBranch(X2,Y2)
                             -> (is_SetAssign(X3,Y3)
                                 -> (is_SetBranchFilter(X4,Y4)
                                     -> (is_SetVarValPrint(X5,Y5)
                                         -> gecode_constraint_assign_23(Y0,Y1,Y2,Y3,Y4,Y5)
                             ...
                             ;  (is_SetVarBranch(X2,Y2)
                                 -> (is_SetAssign(X3,Y3)
                                     -> (is_SetBranchFilter(X4,Y4)
                                         -> (is_SetVarValPrint(X5,Y5)
                                             -> gecode_constraint_assign_26(Y0,Y1,Y2,Y3,Y4,Y5)
                                             ;  throw(error(type_error('SetVarValPrint'(X5)),gecode_argument_error(assign(X0,X1,X2,X3,X4,X5),arg=6))))
                                         ;  throw(error(type_error('SetBranchFilter'(X4)),gecode_argument_error(assign(X0,X1,X2,X3,X4,X5),arg=5))))
                                     ;  throw(error(type_error('SetAssign'(X3)),gecode_argument_error(assign(X0,X1,X2,X3,X4,X5),arg=4))))
                                 ;  throw(error(type_error('TieBreak<SetVarBranch>'(X2)),gecode_argument_error(assign(X0,X1,X2,X3,X4,X5),arg=3)))))
...
binpacking(X0,X1,X2,X3) :-
        (is_Space_or_Clause(X0,Y0)
         -> (is_IntVarArgs(X1,Y1)
             -> (is_IntVarArgs(X2,Y2)
                 -> (is_IntArgs(X3,Y3)
                     -> gecode_constraint_binpacking_33(Y0,Y1,Y2,Y3)
             ...
             -> (is_IntVarArgs(X2,Y2)
                 -> (is_IntArgs(X3,Y3)
                     -> (is_IntPropLevel(X4,Y4)
                         -> gecode_constraint_binpacking_34(Y0,Y1,Y2,Y3,Y4)
...
branch(X0,X1,X2,X3) :-
        (is_Space_or_Clause(X0,Y0)
         -> (is_BoolVar(X1,Y1)
             -> (is_BoolValBranch(X2,Y2)
                 -> (is_BoolVarValPrint(X3,Y3)
                     -> gecode_constraint_branch_36(Y0,Y1,Y2,Y3)
                     ...
                     ;  (is_IntVarArgs(X1,Y1)
                         ...
                         ;  (is_SetVarArgs(X1,Y1)
                             ...
                             ;  (is_FloatVar(X1,Y1)
                                 -> (is_FloatValBranch(X2,Y2)
                                     -> (is_FloatVarValPrint(X3,Y3)
                                         -> gecode_constraint_branch_80(Y0,Y1,Y2,Y3)
                                 ...
                                 ;  (is_IntVar(X1,Y1)
                                     ...
                                     ;  (is_SetVar(X1,Y1)
                                         -> (is_SetValBranch(X2,Y2)
                                             -> (is_SetVarValPrint(X3,Y3)
                                                 -> gecode_constraint_branch_84(Y0,Y1,Y2,Y3)
             ...
             -> (is_BoolVarBranch(X2,Y2)
                 -> (is_BoolValBranch(X3,Y3)
                     -> (is_BoolBranchFilter(X4,Y4)
                         ...
                         ;  (is_Symmetries(X4,Y4)
                             -> gecode_constraint_branch_40(Y0,Y1,Y2,Y3,Y4)
             ...
             ;  (is_FloatVarArgs(X1,Y1)
                 -> (is_FloatVarBranch(X2,Y2)
                     ...
                     ;  (is_FloatVarBranch(X2,Y2)
                         -> (is_FloatValBranch(X3,Y3)
                             -> (is_FloatBranchFilter(X4,Y4)
                                 -> gecode_constraint_branch_53(Y0,Y1,Y2,Y3,Y4)
                                 ;  throw(error(type_error('FloatBranchFilter'(X4)),gecode_argument_error(branch(X0,X1,X2,X3,X4),arg=5))))
                             ;  throw(error(type_error('FloatValBranch'(X3)),gecode_argument_error(branch(X0,X1,X2,X3,X4),arg=4))))
                 ...
                 ;  (is_IntVarArgs(X1,Y1)
                     -> (is_IntVarBranch(X2,Y2)
                         -> (is_IntValBranch(X3,Y3)
                             -> (is_Symmetries(X4,Y4)
                                 -> gecode_constraint_branch_55(Y0,Y1,Y2,Y3,Y4)
                                 ;  (is_IntBranchFilter(X4,Y4)
                     ...
                     -> (is_BoolBranchFilter(X4,Y4)
                         ...
                         ;  (is_Symmetries(X4,Y4)
                             -> (is_BoolBranchFilter(X5,Y5)
                                 -> gecode_constraint_branch_41(Y0,Y1,Y2,Y3,Y4,Y5)
                 ...
                 -> (is_FloatVarBranch(X2,Y2)
                     ...
                     ;  (is_FloatVarBranch(X2,Y2)
                         -> (is_FloatValBranch(X3,Y3)
                             -> (is_FloatBranchFilter(X4,Y4)
                                 -> (is_FloatVarValPrint(X5,Y5)
                                     -> gecode_constraint_branch_54(Y0,Y1,Y2,Y3,Y4,Y5)
                                     ;  throw(error(type_error('FloatVarValPrint'(X5)),gecode_argument_error(branch(X0,X1,X2,X3,X4,X5),arg=6))))
                                 ;  throw(error(type_error('FloatBranchFilter'(X4)),gecode_argument_error(branch(X0,X1,X2,X3,X4,X5),arg=5))))
                             ;  throw(error(type_error('FloatValBranch'(X3)),gecode_argument_error(branch(X0,X1,X2,X3,X4,X5),arg=4))))
                         ...
                         -> (is_IntValBranch(X3,Y3)
                             -> (is_Symmetries(X4,Y4)
                                 -> (is_IntBranchFilter(X5,Y5)
                                     -> gecode_constraint_branch_56(Y0,Y1,Y2,Y3,Y4,Y5)
                     ...
                     -> (is_Symmetries(X4,Y4)
                         -> (is_BoolBranchFilter(X5,Y5)
                             -> (is_BoolVarValPrint(X6,Y6)
                                 -> gecode_constraint_branch_42(Y0,Y1,Y2,Y3,Y4,Y5,Y6)
                         ...
                         -> (is_Symmetries(X4,Y4)
                             -> (is_IntBranchFilter(X5,Y5)
                                 -> (is_IntVarValPrint(X6,Y6)
                                     -> gecode_constraint_branch_57(Y0,Y1,Y2,Y3,Y4,Y5,Y6)
         ...
         -> (is_BoolOpType(X1,Y1)
             -> (is_BoolVarArgs(X2,Y2)
                 -> (is_BoolVarArgs(X3,Y3)
                     -> (is_BoolVar(X4,Y4)
                         -> gecode_constraint_clause_85(Y0,Y1,Y2,Y3,Y4)
                         ;  (is_int(X4,Y4)
                             -> gecode_constraint_clause_87(Y0,Y1,Y2,Y3,Y4)
        ...
        (is_Space_or_Clause(X0,Y0)
         -> (is_BoolVarArgs(X1,Y1)
             ...
             ;  (is_IntVarArgs(X1,Y1)
                 -> (is_TupleSet(X2,Y2)
                     -> (is_bool(X3,Y3)
                         -> gecode_constraint_extensional_95(Y0,Y1,Y2,Y3)
                         ;  throw(error(type_error(bool(X3)),gecode_argument_error(extensional(X0,X1,X2,X3),arg=4))))
                     ;  (is_DFA(X2,Y2)
                         -> (is_IntPropLevel(X3,Y3)
                             -> gecode_constraint_extensional_100(Y0,Y1,Y2,Y3)
                             ;  throw(error(type_error('IntPropLevel'(X3)),gecode_argument_error(extensional(X0,X1,X2,X3),arg=4))))
                         ;  throw(error(type_error('DFA'(X2)),gecode_argument_error(extensional(X0,X1,X2,X3),arg=3)))))
        ...
        (is_Space_or_Clause(X0,Y0)
         -> (is_BoolVarArgs(X1,Y1)
             -> (is_TupleSet(X2,Y2)
                 -> (is_bool(X3,Y3)
                     -> (is_IntPropLevel(X4,Y4)
                         -> gecode_constraint_extensional_90(Y0,Y1,Y2,Y3,Y4)
                         ;  (is_Reify(X4,Y4)
                             -> gecode_constraint_extensional_91(Y0,Y1,Y2,Y3,Y4)
             ...
             ;  (is_IntVarArgs(X1,Y1)
                 -> (is_TupleSet(X2,Y2)
                     -> (is_bool(X3,Y3)
                         -> (is_IntPropLevel(X4,Y4)
                             -> gecode_constraint_extensional_96(Y0,Y1,Y2,Y3,Y4)
                             ;  (is_Reify(X4,Y4)
                                 -> gecode_constraint_extensional_97(Y0,Y1,Y2,Y3,Y4)
                                 ;  throw(error(type_error('Reify'(X4)),gecode_argument_error(extensional(X0,X1,X2,X3,X4),arg=5)))))
                         ;  throw(error(type_error(bool(X3)),gecode_argument_error(extensional(X0,X1,X2,X3,X4),arg=4))))
                     ;  throw(error(type_error('TupleSet'(X2)),gecode_argument_error(extensional(X0,X1,X2,X3,X4),arg=3))))
         ...
         -> (is_BoolVarArgs(X1,Y1)
             -> (is_TupleSet(X2,Y2)
                 -> (is_bool(X3,Y3)
                     -> (is_Reify(X4,Y4)
                         -> (is_IntPropLevel(X5,Y5)
                             -> gecode_constraint_extensional_92(Y0,Y1,Y2,Y3,Y4,Y5)
             ...
             ;  (is_IntVarArgs(X1,Y1)
                 -> (is_TupleSet(X2,Y2)
                     -> (is_bool(X3,Y3)
                         -> (is_Reify(X4,Y4)
                             -> (is_IntPropLevel(X5,Y5)
                                 -> gecode_constraint_extensional_98(Y0,Y1,Y2,Y3,Y4,Y5)
                                 ;  throw(error(type_error('IntPropLevel'(X5)),gecode_argument_error(extensional(X0,X1,X2,X3,X4,X5),arg=6))))
                             ;  throw(error(type_error('Reify'(X4)),gecode_argument_error(extensional(X0,X1,X2,X3,X4,X5),arg=5))))
                         ;  throw(error(type_error(bool(X3)),gecode_argument_error(extensional(X0,X1,X2,X3,X4,X5),arg=4))))
                     ;  throw(error(type_error('TupleSet'(X2)),gecode_argument_error(extensional(X0,X1,X2,X3,X4,X5),arg=3))))
...
extensional(X0,X1,X2) :-
        (is_Space_or_Clause(X0,Y0)
         -> (is_BoolVarArgs(X1,Y1)
             -> (is_DFA(X2,Y2)
                 -> gecode_constraint_extensional_93(Y0,Y1,Y2)
                 ;  throw(error(type_error('DFA'(X2)),gecode_argument_error(extensional(X0,X1,X2),arg=3))))
             ;  (is_IntVarArgs(X1,Y1)
                 -> (is_DFA(X2,Y2)
                     -> gecode_constraint_extensional_99(Y0,Y1,Y2)
                     ;  throw(error(type_error('DFA'(X2)),gecode_argument_error(extensional(X0,X1,X2),arg=3))))
        ...
        (is_Space_or_Clause(X0,Y0)
         -> (is_BoolVar(X1,Y1)
             -> (is_BoolVar(X2,Y2)
                 -> (is_BoolVar(X3,Y3)
                     -> (is_BoolVar(X4,Y4)
                         -> gecode_constraint_ite_101(Y0,Y1,Y2,Y3,Y4)
                 ...
                 ;  (is_FloatVar(X2,Y2)
                     -> (is_FloatVar(X3,Y3)
                         -> (is_FloatVar(X4,Y4)
                             -> gecode_constraint_ite_103(Y0,Y1,Y2,Y3,Y4)
                     ...
                     ;  (is_IntVar(X2,Y2)
                         -> (is_IntVar(X3,Y3)
                             -> (is_IntVar(X4,Y4)
                                 -> gecode_constraint_ite_104(Y0,Y1,Y2,Y3,Y4)
         ...
         -> (is_BoolVar(X1,Y1)
             -> (is_BoolVar(X2,Y2)
                 -> (is_BoolVar(X3,Y3)
                     -> (is_BoolVar(X4,Y4)
                         -> (is_IntPropLevel(X5,Y5)
                             -> gecode_constraint_ite_102(Y0,Y1,Y2,Y3,Y4,Y5)
                 ...
                 ;  (is_IntVar(X2,Y2)
                     -> (is_IntVar(X3,Y3)
                         -> (is_IntVar(X4,Y4)
                             -> (is_IntPropLevel(X5,Y5)
                                 -> gecode_constraint_ite_105(Y0,Y1,Y2,Y3,Y4,Y5)
                                 ;  throw(error(type_error('IntPropLevel'(X5)),gecode_argument_error(ite(X0,X1,X2,X3,X4,X5),arg=6))))
...
linear(X0,X1,X2,X3) :-
        (is_Space_or_Clause(X0,Y0)
         -> (is_BoolVarArgs(X1,Y1)
             -> (is_IntRelType(X2,Y2)
                 -> (is_int(X3,Y3)
                     -> gecode_constraint_linear_106(Y0,Y1,Y2,Y3)
                     ;  (is_IntVar(X3,Y3)
                         -> gecode_constraint_linear_110(Y0,Y1,Y2,Y3)
             ...
             ;  (is_FloatVarArgs(X1,Y1)
                 -> (is_FloatRelType(X2,Y2)
                     -> (is_FloatVal(X3,Y3)
                         -> gecode_constraint_linear_118(Y0,Y1,Y2,Y3)
                         ;  (is_FloatVar(X3,Y3)
                             -> gecode_constraint_linear_120(Y0,Y1,Y2,Y3)
                 ...
                 ;  (is_IntVarArgs(X1,Y1)
                     -> (is_IntRelType(X2,Y2)
                         -> (is_int(X3,Y3)
                             -> gecode_constraint_linear_138(Y0,Y1,Y2,Y3)
                             ;  (is_IntVar(X3,Y3)
                                 -> gecode_constraint_linear_142(Y0,Y1,Y2,Y3)
                                 ;  throw(error(type_error('IntVar'(X3)),gecode_argument_error(linear(X0,X1,X2,X3),arg=4)))))
                         ;  throw(error(type_error('IntRelType'(X2)),gecode_argument_error(linear(X0,X1,X2,X3),arg=3))))
             ...
             -> (is_IntRelType(X2,Y2)
                 -> (is_int(X3,Y3)
                     -> (is_IntPropLevel(X4,Y4)
                         ...
                         ;  (is_Reify(X4,Y4)
                             -> gecode_constraint_linear_108(Y0,Y1,Y2,Y3,Y4)
                     ...
                     ;  (is_IntVar(X3,Y3)
                         -> (is_IntPropLevel(X4,Y4)
                             ...
                             ;  (is_Reify(X4,Y4)
                                 -> gecode_constraint_linear_112(Y0,Y1,Y2,Y3,Y4)
                                 ;  throw(error(type_error('Reify'(X4)),gecode_argument_error(linear(X0,X1,X2,X3,X4),arg=5)))))
             ...
             ;  (is_FloatValArgs(X1,Y1)
                 -> (is_FloatVarArgs(X2,Y2)
                     -> (is_FloatRelType(X3,Y3)
                         -> (is_FloatVal(X4,Y4)
                             -> gecode_constraint_linear_114(Y0,Y1,Y2,Y3,Y4)
                             ;  (is_FloatVar(X4,Y4)
                                 -> gecode_constraint_linear_116(Y0,Y1,Y2,Y3,Y4)
                 ...
                 ;  (is_FloatVarArgs(X1,Y1)
                     -> (is_FloatRelType(X2,Y2)
                         -> (is_FloatVal(X3,Y3)
                             -> (is_Reify(X4,Y4)
                                 -> gecode_constraint_linear_119(Y0,Y1,Y2,Y3,Y4)
                                 ;  throw(error(type_error('Reify'(X4)),gecode_argument_error(linear(X0,X1,X2,X3,X4),arg=5))))
                             ;  (is_FloatVar(X3,Y3)
                                 -> (is_Reify(X4,Y4)
                                     -> gecode_constraint_linear_121(Y0,Y1,Y2,Y3,Y4)
                                     ;  throw(error(type_error('Reify'(X4)),gecode_argument_error(linear(X0,X1,X2,X3,X4),arg=5))))
                     ...
                     ;  (is_IntArgs(X1,Y1)
                         -> (is_BoolVarArgs(X2,Y2)
                             -> (is_IntRelType(X3,Y3)
                                 -> (is_int(X4,Y4)
                                     -> gecode_constraint_linear_122(Y0,Y1,Y2,Y3,Y4)
                                     ;  (is_IntVar(X4,Y4)
                                         -> gecode_constraint_linear_126(Y0,Y1,Y2,Y3,Y4)
                             ...
                             ;  (is_IntVarArgs(X2,Y2)
                                 -> (is_IntRelType(X3,Y3)
                                     -> (is_int(X4,Y4)
                                         -> gecode_constraint_linear_130(Y0,Y1,Y2,Y3,Y4)
                                         ;  (is_IntVar(X4,Y4)
                                             -> gecode_constraint_linear_134(Y0,Y1,Y2,Y3,Y4)
                                             ;  throw(error(type_error('IntVar'(X4)),gecode_argument_error(linear(X0,X1,X2,X3,X4),arg=5)))))
                                     ;  throw(error(type_error('IntRelType'(X3)),gecode_argument_error(linear(X0,X1,X2,X3,X4),arg=4))))
                         ...
                         ;  (is_IntVarArgs(X1,Y1)
                             -> (is_IntRelType(X2,Y2)
                                 -> (is_int(X3,Y3)
                                     -> (is_IntPropLevel(X4,Y4)
                                         -> gecode_constraint_linear_139(Y0,Y1,Y2,Y3,Y4)
                                         ;  (is_Reify(X4,Y4)
                                             -> gecode_constraint_linear_140(Y0,Y1,Y2,Y3,Y4)
                                             ;  throw(error(type_error('Reify'(X4)),gecode_argument_error(linear(X0,X1,X2,X3,X4),arg=5)))))
                                     ;  (is_IntVar(X3,Y3)
                                         -> (is_IntPropLevel(X4,Y4)
                                             -> gecode_constraint_linear_143(Y0,Y1,Y2,Y3,Y4)
                                             ;  (is_Reify(X4,Y4)
                                                 -> gecode_constraint_linear_144(Y0,Y1,Y2,Y3,Y4)
                                                 ;  throw(error(type_error('Reify'(X4)),gecode_argument_error(linear(X0,X1,X2,X3,X4),arg=5)))))
                                         ;  throw(error(type_error('IntVar'(X3)),gecode_argument_error(linear(X0,X1,X2,X3,X4),arg=4)))))
                                 ;  throw(error(type_error('IntRelType'(X2)),gecode_argument_error(linear(X0,X1,X2,X3,X4),arg=3))))
         ...
         -> (is_BoolVarArgs(X1,Y1)
             -> (is_IntRelType(X2,Y2)
                 -> (is_int(X3,Y3)
                     -> (is_Reify(X4,Y4)
                         -> (is_IntPropLevel(X5,Y5)
                             -> gecode_constraint_linear_109(Y0,Y1,Y2,Y3,Y4,Y5)
                     ...
                     ;  (is_IntVar(X3,Y3)
                         -> (is_Reify(X4,Y4)
                             -> (is_IntPropLevel(X5,Y5)
                                 -> gecode_constraint_linear_113(Y0,Y1,Y2,Y3,Y4,Y5)
                                 ;  throw(error(type_error('IntPropLevel'(X5)),gecode_argument_error(linear(X0,X1,X2,X3,X4,X5),arg=6))))
                             ;  throw(error(type_error('Reify'(X4)),gecode_argument_error(linear(X0,X1,X2,X3,X4,X5),arg=5))))
             ...
             ;  (is_FloatValArgs(X1,Y1)
                 -> (is_FloatVarArgs(X2,Y2)
                     -> (is_FloatRelType(X3,Y3)
                         -> (is_FloatVal(X4,Y4)
                             -> (is_Reify(X5,Y5)
                                 -> gecode_constraint_linear_115(Y0,Y1,Y2,Y3,Y4,Y5)
                                 ;  throw(error(type_error('Reify'(X5)),gecode_argument_error(linear(X0,X1,X2,X3,X4,X5),arg=6))))
                             ;  (is_FloatVar(X4,Y4)
                                 -> (is_Reify(X5,Y5)
                                     -> gecode_constraint_linear_117(Y0,Y1,Y2,Y3,Y4,Y5)
                                     ;  throw(error(type_error('Reify'(X5)),gecode_argument_error(linear(X0,X1,X2,X3,X4,X5),arg=6))))
                 ...
                 ;  (is_IntArgs(X1,Y1)
                     -> (is_BoolVarArgs(X2,Y2)
                         -> (is_IntRelType(X3,Y3)
                             -> (is_int(X4,Y4)
                                 -> (is_IntPropLevel(X5,Y5)
                                     -> gecode_constraint_linear_123(Y0,Y1,Y2,Y3,Y4,Y5)
                                     ;  (is_Reify(X5,Y5)
                                         -> gecode_constraint_linear_124(Y0,Y1,Y2,Y3,Y4,Y5)
                                         ;  throw(error(type_error('Reify'(X5)),gecode_argument_error(linear(X0,X1,X2,X3,X4,X5),arg=6)))))
                                 ;  (is_IntVar(X4,Y4)
                                     -> (is_IntPropLevel(X5,Y5)
                                         -> gecode_constraint_linear_127(Y0,Y1,Y2,Y3,Y4,Y5)
                                         ;  (is_Reify(X5,Y5)
                                             -> gecode_constraint_linear_128(Y0,Y1,Y2,Y3,Y4,Y5)
                                             ;  throw(error(type_error('Reify'(X5)),gecode_argument_error(linear(X0,X1,X2,X3,X4,X5),arg=6)))))
                         ...
                         ;  (is_IntVarArgs(X2,Y2)
                             -> (is_IntRelType(X3,Y3)
                                 -> (is_int(X4,Y4)
                                     -> (is_IntPropLevel(X5,Y5)
                                         -> gecode_constraint_linear_131(Y0,Y1,Y2,Y3,Y4,Y5)
                                         ;  (is_Reify(X5,Y5)
                                             -> gecode_constraint_linear_132(Y0,Y1,Y2,Y3,Y4,Y5)
                                             ;  throw(error(type_error('Reify'(X5)),gecode_argument_error(linear(X0,X1,X2,X3,X4,X5),arg=6)))))
                                     ;  (is_IntVar(X4,Y4)
                                         -> (is_IntPropLevel(X5,Y5)
                                             -> gecode_constraint_linear_135(Y0,Y1,Y2,Y3,Y4,Y5)
                                             ;  (is_Reify(X5,Y5)
                                                 -> gecode_constraint_linear_136(Y0,Y1,Y2,Y3,Y4,Y5)
                                                 ;  throw(error(type_error('Reify'(X5)),gecode_argument_error(linear(X0,X1,X2,X3,X4,X5),arg=6)))))
                                         ;  throw(error(type_error('IntVar'(X4)),gecode_argument_error(linear(X0,X1,X2,X3,X4,X5),arg=5)))))
                                 ;  throw(error(type_error('IntRelType'(X3)),gecode_argument_error(linear(X0,X1,X2,X3,X4,X5),arg=4))))
                     ...
                     ;  (is_IntVarArgs(X1,Y1)
                         -> (is_IntRelType(X2,Y2)
                             -> (is_int(X3,Y3)
                                 -> (is_Reify(X4,Y4)
                                     -> (is_IntPropLevel(X5,Y5)
                                         -> gecode_constraint_linear_141(Y0,Y1,Y2,Y3,Y4,Y5)
                                         ;  throw(error(type_error('IntPropLevel'(X5)),gecode_argument_error(linear(X0,X1,X2,X3,X4,X5),arg=6))))
                                     ;  throw(error(type_error('Reify'(X4)),gecode_argument_error(linear(X0,X1,X2,X3,X4,X5),arg=5))))
                                 ;  (is_IntVar(X3,Y3)
                                     -> (is_Reify(X4,Y4)
                                         -> (is_IntPropLevel(X5,Y5)
                                             -> gecode_constraint_linear_145(Y0,Y1,Y2,Y3,Y4,Y5)
                                             ;  throw(error(type_error('IntPropLevel'(X5)),gecode_argument_error(linear(X0,X1,X2,X3,X4,X5),arg=6))))
                                         ;  throw(error(type_error('Reify'(X4)),gecode_argument_error(linear(X0,X1,X2,X3,X4,X5),arg=5))))
                                     ;  throw(error(type_error('IntVar'(X3)),gecode_argument_error(linear(X0,X1,X2,X3,X4,X5),arg=4)))))
                             ;  throw(error(type_error('IntRelType'(X2)),gecode_argument_error(linear(X0,X1,X2,X3,X4,X5),arg=3))))
                     ...
                     -> (is_int(X4,Y4)
                         -> (is_Reify(X5,Y5)
                             -> (is_IntPropLevel(X6,Y6)
                                 -> gecode_constraint_linear_125(Y0,Y1,Y2,Y3,Y4,Y5,Y6)
                         ...
                         ;  (is_IntVar(X4,Y4)
                             -> (is_Reify(X5,Y5)
                                 -> (is_IntPropLevel(X6,Y6)
                                     -> gecode_constraint_linear_129(Y0,Y1,Y2,Y3,Y4,Y5,Y6)
                                     ;  throw(error(type_error('IntPropLevel'(X6)),gecode_argument_error(linear(X0,X1,X2,X3,X4,X5,X6),arg=7))))
                                 ;  throw(error(type_error('Reify'(X5)),gecode_argument_error(linear(X0,X1,X2,X3,X4,X5,X6),arg=6))))
                 ...
                 ;  (is_IntVarArgs(X2,Y2)
                     -> (is_IntRelType(X3,Y3)
                         -> (is_int(X4,Y4)
                             -> (is_Reify(X5,Y5)
                                 -> (is_IntPropLevel(X6,Y6)
                                     -> gecode_constraint_linear_133(Y0,Y1,Y2,Y3,Y4,Y5,Y6)
                                     ;  throw(error(type_error('IntPropLevel'(X6)),gecode_argument_error(linear(X0,X1,X2,X3,X4,X5,X6),arg=7))))
                                 ;  throw(error(type_error('Reify'(X5)),gecode_argument_error(linear(X0,X1,X2,X3,X4,X5,X6),arg=6))))
                             ;  (is_IntVar(X4,Y4)
                                 -> (is_Reify(X5,Y5)
                                     -> (is_IntPropLevel(X6,Y6)
                                         -> gecode_constraint_linear_137(Y0,Y1,Y2,Y3,Y4,Y5,Y6)
                                         ;  throw(error(type_error('IntPropLevel'(X6)),gecode_argument_error(linear(X0,X1,X2,X3,X4,X5,X6),arg=7))))
                                     ;  throw(error(type_error('Reify'(X5)),gecode_argument_error(linear(X0,X1,X2,X3,X4,X5,X6),arg=6))))
                                 ;  throw(error(type_error('IntVar'(X4)),gecode_argument_error(linear(X0,X1,X2,X3,X4,X5,X6),arg=5)))))
                         ;  throw(error(type_error('IntRelType'(X3)),gecode_argument_error(linear(X0,X1,X2,X3,X4,X5,X6),arg=4))))
                 ...
                 -> (is_IntVarArgs(X3,Y3)
                     -> (is_IntArgs(X4,Y4)
                         -> (is_BoolVarArgs(X5,Y5)
                             -> gecode_constraint_nooverlap_146(Y0,Y1,Y2,Y3,Y4,Y5)
                             ;  (is_IntPropLevel(X5,Y5)
                                 -> gecode_constraint_nooverlap_149(Y0,Y1,Y2,Y3,Y4,Y5)
             ...
             -> (is_IntArgs(X2,Y2)
                 -> (is_IntVarArgs(X3,Y3)
                     -> (is_IntArgs(X4,Y4)
                         -> (is_BoolVarArgs(X5,Y5)
                             -> (is_IntPropLevel(X6,Y6)
                                 -> gecode_constraint_nooverlap_147(Y0,Y1,Y2,Y3,Y4,Y5,Y6)
                 ...
                 ;  (is_IntVarArgs(X2,Y2)
                     -> (is_IntVarArgs(X3,Y3)
                         -> (is_IntVarArgs(X4,Y4)
                             -> (is_IntVarArgs(X5,Y5)
                                 -> (is_IntVarArgs(X6,Y6)
                                     -> gecode_constraint_nooverlap_152(Y0,Y1,Y2,Y3,Y4,Y5,Y6)
        ...
        (is_Space_or_Clause(X0,Y0)
         -> (is_IntVarArgs(X1,Y1)
             -> (is_IntArgs(X2,Y2)
                 -> (is_IntVarArgs(X3,Y3)
                     -> (is_IntArgs(X4,Y4)
                         -> gecode_constraint_nooverlap_148(Y0,Y1,Y2,Y3,Y4)
                         ...
                         -> (is_IntVarArgs(X5,Y5)
                             -> (is_IntVarArgs(X6,Y6)
                                 -> (is_BoolVarArgs(X7,Y7)
                                     -> gecode_constraint_nooverlap_150(Y0,Y1,Y2,Y3,Y4,Y5,Y6,Y7)
                                     ;  (is_IntPropLevel(X7,Y7)
                                         -> gecode_constraint_nooverlap_153(Y0,Y1,Y2,Y3,Y4,Y5,Y6,Y7)
                             ...
                             -> (is_IntVarArgs(X6,Y6)
                                 -> (is_BoolVarArgs(X7,Y7)
                                     -> (is_IntPropLevel(X8,Y8)
                                         -> gecode_constraint_nooverlap_151(Y0,Y1,Y2,Y3,Y4,Y5,Y6,Y7,Y8)
...
precede(X0,X1,X2) :-
        (is_Space_or_Clause(X0,Y0)
         -> (is_IntVarArgs(X1,Y1)
             -> (is_IntArgs(X2,Y2)
                 -> gecode_constraint_precede_154(Y0,Y1,Y2)
        ...
        (is_Space_or_Clause(X0,Y0)
         -> (is_IntVarArgs(X1,Y1)
             -> (is_int(X2,Y2)
                 -> (is_int(X3,Y3)
                     -> (is_IntPropLevel(X4,Y4)
                         -> gecode_constraint_precede_157(Y0,Y1,Y2,Y3,Y4)
...
rel(X0,X1,X2,X3) :-
        (is_Space_or_Clause(X0,Y0)
         -> (is_BoolOpType(X1,Y1)
             -> (is_BoolVarArgs(X2,Y2)
                 -> (is_BoolVar(X3,Y3)
                     -> gecode_constraint_rel_158(Y0,Y1,Y2,Y3)
                     ;  (is_int(X3,Y3)
                         -> gecode_constraint_rel_160(Y0,Y1,Y2,Y3)
             ...
             ;  (is_BoolVar(X1,Y1)
                 -> (is_IntRelType(X2,Y2)
                     -> (is_BoolVar(X3,Y3)
                         -> gecode_constraint_rel_166(Y0,Y1,Y2,Y3)
                         ;  (is_int(X3,Y3)
                 ...
                 ;  (is_BoolVarArgs(X1,Y1)
                     -> (is_IntRelType(X2,Y2)
                         -> (is_BoolVar(X3,Y3)
                             -> gecode_constraint_rel_174(Y0,Y1,Y2,Y3)
                             ;  (is_BoolVarArgs(X3,Y3)
                                 -> gecode_constraint_rel_176(Y0,Y1,Y2,Y3)
                                 ;  (is_IntArgs(X3,Y3)
                                     -> gecode_constraint_rel_178(Y0,Y1,Y2,Y3)
                                     ;  (is_int(X3,Y3)
                                         -> gecode_constraint_rel_180(Y0,Y1,Y2,Y3)
                                         ;  (is_IntPropLevel(X3,Y3)
                                             -> gecode_constraint_rel_183(Y0,Y1,Y2,Y3)
                                             ;  throw(error(type_error('IntPropLevel'(X3)),gecode_argument_error(rel(X0,X1,X2,X3),arg=4))))))))
                         ;  throw(error(type_error('IntRelType'(X2)),gecode_argument_error(rel(X0,X1,X2,X3),arg=3))))
                     ;  (is_FloatVarArgs(X1,Y1)
                         -> (is_FloatRelType(X2,Y2)
                             -> (is_FloatVal(X3,Y3)
                                 -> gecode_constraint_rel_184(Y0,Y1,Y2,Y3)
                                 ;  (is_FloatVar(X3,Y3)
                                     -> gecode_constraint_rel_185(Y0,Y1,Y2,Y3)
                         ...
                         ;  (is_IntArgs(X1,Y1)
                             -> (is_IntRelType(X2,Y2)
                                 -> (is_BoolVarArgs(X3,Y3)
                                     -> gecode_constraint_rel_186(Y0,Y1,Y2,Y3)
                                     ;  (is_IntVarArgs(X3,Y3)
                                         -> gecode_constraint_rel_188(Y0,Y1,Y2,Y3)
                                         ;  throw(error(type_error('IntVarArgs'(X3)),gecode_argument_error(rel(X0,X1,X2,X3),arg=4)))))
                                 ;  throw(error(type_error('IntRelType'(X2)),gecode_argument_error(rel(X0,X1,X2,X3),arg=3))))
                             ;  (is_IntVarArgs(X1,Y1)
                                 -> (is_IntRelType(X2,Y2)
                                     -> (is_IntArgs(X3,Y3)
                                         -> gecode_constraint_rel_190(Y0,Y1,Y2,Y3)
                                         ;  (is_IntVarArgs(X3,Y3)
                                             -> gecode_constraint_rel_192(Y0,Y1,Y2,Y3)
                                             ;  (is_int(X3,Y3)
                                                 -> gecode_constraint_rel_194(Y0,Y1,Y2,Y3)
                                                 ;  (is_IntPropLevel(X3,Y3)
                                                     -> gecode_constraint_rel_197(Y0,Y1,Y2,Y3)
                                                     ;  (is_IntVar(X3,Y3)
                                                         -> gecode_constraint_rel_198(Y0,Y1,Y2,Y3)
                                                         ;  throw(error(type_error('IntVar'(X3)),gecode_argument_error(rel(X0,X1,X2,X3),arg=4))))))))
                                     ;  throw(error(type_error('IntRelType'(X2)),gecode_argument_error(rel(X0,X1,X2,X3),arg=3))))
                                 ;  (is_FloatVar(X1,Y1)
                                     -> (is_FloatRelType(X2,Y2)
                                         -> (is_FloatVal(X3,Y3)
                                             -> gecode_constraint_rel_200(Y0,Y1,Y2,Y3)
                                             ;  (is_FloatVar(X3,Y3)
                                                 -> gecode_constraint_rel_202(Y0,Y1,Y2,Y3)
                                                 ;  throw(error(type_error('FloatVar'(X3)),gecode_argument_error(rel(X0,X1,X2,X3),arg=4)))))
                                         ;  throw(error(type_error('FloatRelType'(X2)),gecode_argument_error(rel(X0,X1,X2,X3),arg=3))))
                                     ;  (is_IntVar(X1,Y1)
                                         -> (is_IntRelType(X2,Y2)
                                             -> (is_int(X3,Y3)
                                                 -> gecode_constraint_rel_204(Y0,Y1,Y2,Y3)
                                                 ;  (is_IntVar(X3,Y3)
                                                     -> gecode_constraint_rel_208(Y0,Y1,Y2,Y3)
                                                     ;  throw(error(type_error('IntVar'(X3)),gecode_argument_error(rel(X0,X1,X2,X3),arg=4)))))
                                             ;  throw(error(type_error('IntRelType'(X2)),gecode_argument_error(rel(X0,X1,X2,X3),arg=3))))
             ...
             ;  (is_BoolVar(X1,Y1)
                 -> (is_BoolOpType(X2,Y2)
                     -> (is_BoolVar(X3,Y3)
                         -> (is_BoolVar(X4,Y4)
                             ...
                             ;  (is_int(X4,Y4)
                                 -> gecode_constraint_rel_164(Y0,Y1,Y2,Y3,Y4)
                 ...
                 ;  (is_BoolVarArgs(X1,Y1)
                     -> (is_IntRelType(X2,Y2)
                         -> (is_BoolVar(X3,Y3)
                             -> (is_IntPropLevel(X4,Y4)
                                 -> gecode_constraint_rel_175(Y0,Y1,Y2,Y3,Y4)
                                 ;  throw(error(type_error('IntPropLevel'(X4)),gecode_argument_error(rel(X0,X1,X2,X3,X4),arg=5))))
                             ;  (is_BoolVarArgs(X3,Y3)
                                 -> (is_IntPropLevel(X4,Y4)
                                     -> gecode_constraint_rel_177(Y0,Y1,Y2,Y3,Y4)
                                     ;  throw(error(type_error('IntPropLevel'(X4)),gecode_argument_error(rel(X0,X1,X2,X3,X4),arg=5))))
                                 ;  (is_IntArgs(X3,Y3)
                                     -> (is_IntPropLevel(X4,Y4)
                                         -> gecode_constraint_rel_179(Y0,Y1,Y2,Y3,Y4)
                                         ;  throw(error(type_error('IntPropLevel'(X4)),gecode_argument_error(rel(X0,X1,X2,X3,X4),arg=5))))
                                     ;  (is_int(X3,Y3)
                                         -> (is_IntPropLevel(X4,Y4)
                                             -> gecode_constraint_rel_181(Y0,Y1,Y2,Y3,Y4)
                                             ;  throw(error(type_error('IntPropLevel'(X4)),gecode_argument_error(rel(X0,X1,X2,X3,X4),arg=5))))
                                         ;  throw(error(type_error(int(X3)),gecode_argument_error(rel(X0,X1,X2,X3,X4),arg=4)))))))
                         ;  throw(error(type_error('IntRelType'(X2)),gecode_argument_error(rel(X0,X1,X2,X3,X4),arg=3))))
                     ;  (is_IntArgs(X1,Y1)
                         -> (is_IntRelType(X2,Y2)
                             -> (is_BoolVarArgs(X3,Y3)
                                 -> (is_IntPropLevel(X4,Y4)
                                     -> gecode_constraint_rel_187(Y0,Y1,Y2,Y3,Y4)
                                     ;  throw(error(type_error('IntPropLevel'(X4)),gecode_argument_error(rel(X0,X1,X2,X3,X4),arg=5))))
                                 ;  (is_IntVarArgs(X3,Y3)
                                     -> (is_IntPropLevel(X4,Y4)
                                         -> gecode_constraint_rel_189(Y0,Y1,Y2,Y3,Y4)
                                         ;  throw(error(type_error('IntPropLevel'(X4)),gecode_argument_error(rel(X0,X1,X2,X3,X4),arg=5))))
                         ...
                         ;  (is_IntVarArgs(X1,Y1)
                             -> (is_IntRelType(X2,Y2)
                                 -> (is_IntArgs(X3,Y3)
                                     -> (is_IntPropLevel(X4,Y4)
                                         -> gecode_constraint_rel_191(Y0,Y1,Y2,Y3,Y4)
                                         ;  throw(error(type_error('IntPropLevel'(X4)),gecode_argument_error(rel(X0,X1,X2,X3,X4),arg=5))))
                                     ;  (is_IntVarArgs(X3,Y3)
                                         -> (is_IntPropLevel(X4,Y4)
                                             -> gecode_constraint_rel_193(Y0,Y1,Y2,Y3,Y4)
                                             ;  throw(error(type_error('IntPropLevel'(X4)),gecode_argument_error(rel(X0,X1,X2,X3,X4),arg=5))))
                                         ;  (is_int(X3,Y3)
                                             -> (is_IntPropLevel(X4,Y4)
                                                 -> gecode_constraint_rel_195(Y0,Y1,Y2,Y3,Y4)
                                                 ;  throw(error(type_error('IntPropLevel'(X4)),gecode_argument_error(rel(X0,X1,X2,X3,X4),arg=5))))
                                             ;  (is_IntVar(X3,Y3)
                                                 -> (is_IntPropLevel(X4,Y4)
                                                     -> gecode_constraint_rel_199(Y0,Y1,Y2,Y3,Y4)
                                                     ;  throw(error(type_error('IntPropLevel'(X4)),gecode_argument_error(rel(X0,X1,X2,X3,X4),arg=5))))
                             ...
                             ;  (is_FloatVar(X1,Y1)
                                 -> (is_FloatRelType(X2,Y2)
                                     -> (is_FloatVal(X3,Y3)
                                         -> (is_Reify(X4,Y4)
                                             -> gecode_constraint_rel_201(Y0,Y1,Y2,Y3,Y4)
                                             ;  throw(error(type_error('Reify'(X4)),gecode_argument_error(rel(X0,X1,X2,X3,X4),arg=5))))
                                         ;  (is_FloatVar(X3,Y3)
                                             -> (is_Reify(X4,Y4)
                                                 -> gecode_constraint_rel_203(Y0,Y1,Y2,Y3,Y4)
                                                 ;  throw(error(type_error('Reify'(X4)),gecode_argument_error(rel(X0,X1,X2,X3,X4),arg=5))))
                                 ...
                                 ;  (is_IntVar(X1,Y1)
                                     -> (is_IntRelType(X2,Y2)
                                         -> (is_int(X3,Y3)
                                             -> (is_IntPropLevel(X4,Y4)
                                                 -> gecode_constraint_rel_205(Y0,Y1,Y2,Y3,Y4)
                                                 ;  (is_Reify(X4,Y4)
                                                     -> gecode_constraint_rel_206(Y0,Y1,Y2,Y3,Y4)
                                                     ;  throw(error(type_error('Reify'(X4)),gecode_argument_error(rel(X0,X1,X2,X3,X4),arg=5)))))
                                             ;  (is_IntVar(X3,Y3)
                                                 -> (is_IntPropLevel(X4,Y4)
                                                     -> gecode_constraint_rel_209(Y0,Y1,Y2,Y3,Y4)
                                                     ;  (is_Reify(X4,Y4)
                                                         -> gecode_constraint_rel_210(Y0,Y1,Y2,Y3,Y4)
                                                         ;  throw(error(type_error('Reify'(X4)),gecode_argument_error(rel(X0,X1,X2,X3,X4),arg=5)))))
                                                 ;  throw(error(type_error('IntVar'(X3)),gecode_argument_error(rel(X0,X1,X2,X3,X4),arg=4)))))
                                         ;  throw(error(type_error('IntRelType'(X2)),gecode_argument_error(rel(X0,X1,X2,X3,X4),arg=3))))
             ...
             -> (is_BoolOpType(X2,Y2)
                 ...
                 ;  (is_IntRelType(X2,Y2)
                     -> (is_BoolVar(X3,Y3)
                         -> (is_Reify(X4,Y4)
                             -> (is_IntPropLevel(X5,Y5)
                                 -> gecode_constraint_rel_169(Y0,Y1,Y2,Y3,Y4,Y5)
                                 ;  throw(error(type_error('IntPropLevel'(X5)),gecode_argument_error(rel(X0,X1,X2,X3,X4,X5),arg=6))))
                             ;  throw(error(type_error('Reify'(X4)),gecode_argument_error(rel(X0,X1,X2,X3,X4,X5),arg=5))))
                         ;  (is_int(X3,Y3)
                             -> (is_Reify(X4,Y4)
                                 -> (is_IntPropLevel(X5,Y5)
                                     -> gecode_constraint_rel_173(Y0,Y1,Y2,Y3,Y4,Y5)
                                     ;  throw(error(type_error('IntPropLevel'(X5)),gecode_argument_error(rel(X0,X1,X2,X3,X4,X5),arg=6))))
                                 ;  throw(error(type_error('Reify'(X4)),gecode_argument_error(rel(X0,X1,X2,X3,X4,X5),arg=5))))
             ...
             ;  (is_IntVar(X1,Y1)
                 -> (is_IntRelType(X2,Y2)
                     -> (is_int(X3,Y3)
                         -> (is_Reify(X4,Y4)
                             -> (is_IntPropLevel(X5,Y5)
                                 -> gecode_constraint_rel_207(Y0,Y1,Y2,Y3,Y4,Y5)
                                 ;  throw(error(type_error('IntPropLevel'(X5)),gecode_argument_error(rel(X0,X1,X2,X3,X4,X5),arg=6))))
                             ;  throw(error(type_error('Reify'(X4)),gecode_argument_error(rel(X0,X1,X2,X3,X4,X5),arg=5))))
                         ;  (is_IntVar(X3,Y3)
                             -> (is_Reify(X4,Y4)
                                 -> (is_IntPropLevel(X5,Y5)
                                     -> gecode_constraint_rel_211(Y0,Y1,Y2,Y3,Y4,Y5)
                                     ;  throw(error(type_error('IntPropLevel'(X5)),gecode_argument_error(rel(X0,X1,X2,X3,X4,X5),arg=6))))
                                 ;  throw(error(type_error('Reify'(X4)),gecode_argument_error(rel(X0,X1,X2,X3,X4,X5),arg=5))))
