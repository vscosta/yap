...
from yap_ipython.lib.pretty import pretty
...
from yap_ipython.utils.dir2 import safe_hasattr
from yap_ipython.utils.path import compress_user
from yap_ipython.utils.text import indent
from yap_ipython.utils.wildcard import list_namespace
from yap_ipython.utils.coloransi import TermColors, ColorScheme, ColorSchemeTable
from yap_ipython.utils.py3compat import cast_unicode
from yap_ipython.utils.colorable import Colorable
...
def call_tip(oinfo, format_call=True):
    ...
    """
    warnings.warn('`call_tip` function is deprecated as of yap_ipython 6.0'
    ...
    def info(self, obj, oname='', formatter=None, info=None, detail_level=0):
        ...
        if formatter is not None:
            warnings.warn('The `formatter` keyword argument to `Inspector.info`'
                     'is deprecated as of yap_ipython 5.0 and will have no effects.',
